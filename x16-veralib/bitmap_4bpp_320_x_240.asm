...
.file [name="bitmap_4bpp_320_x_240.prg", type="prg", segments="Program"]
...
main: {
  ...
  __b5:
    ...
    inc.z color
    // if(color>15)
    // [136] if(main::color#1<$f+1) goto main::@45 -- vbuz1_lt_vbuc1_then_la1 
    lda.z color
    cmp #$f+1
    bcc __b7
  ...
  __b2:
    ...
    // bitmap_line(modr16u(rand(),320,0), modr16u(rand(),320,0), modr16u(rand(),200,0), modr16u(rand(),200,0), rand()&15)
    // [170] bitmap_line::c#0 = main::$38 & $f -- vbuz1=vwuz2_band_vbuc1 
    lda #$f
    and.z __38
    sta.z bitmap_line.c
...
vera_layer0_mode_bitmap: {
    ...
    sta VERA_L0_CONFIG
    // *VERA_L0_CONFIG |= bpp
    // [257] *VERA_L0_CONFIG = *VERA_L0_CONFIG | VERA_LAYER_COLOR_DEPTH_4BPP -- _deref_pbuc1=_deref_pbuc1_bor_vbuc2 

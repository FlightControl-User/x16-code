...
conio_x16_init: {
    ...
    // [209] phi textcolor::color#6 = WHITE [phi:conio_x16_init::@4->textcolor#0] -- vbuz1=vbuc1 
    lda #WHITE
    ...
    // [214] phi bgcolor::color#4 = BLUE [phi:conio_x16_init::@5->bgcolor#0] -- vbuz1=vbuc1 
    lda #BLUE
    sta.z bgcolor.color
    jsr bgcolor
...
main: {
    ...
    // [66] phi from main to main::@8 [phi:main->main::@8]
    // main::@8
    // screenlayer1()
    // [67] call screenlayer1
    jsr screenlayer1
    // [68] phi from main::@8 to main::@9 [phi:main::@8->main::@9]
    // main::@9
    // textcolor(WHITE)
    // [69] call textcolor
    // [209] phi from main::@9 to textcolor [phi:main::@9->textcolor]
    // [209] phi textcolor::color#6 = WHITE [phi:main::@9->textcolor#0] -- vbuz1=vbuc1 
    lda #WHITE
    sta.z textcolor.color
    jsr textcolor
    // [70] phi from main::@9 to main::@10 [phi:main::@9->main::@10]
    // main::@10
    // bgcolor(BLACK)
    // [71] call bgcolor
    // [214] phi from main::@10 to bgcolor [phi:main::@10->bgcolor]
    // [214] phi bgcolor::color#4 = BLACK [phi:main::@10->bgcolor#0] -- vbuz1=vbuc1 
    lda #BLACK
    sta.z bgcolor.color
    jsr bgcolor
    // [72] phi from main::@10 to main::@11 [phi:main::@10->main::@11]
    // main::@11
    // clrscr()
    // [73] call clrscr
    jsr clrscr
    // [74] phi from main::@11 to main::@12 [phi:main::@11->main::@12]
    // main::@12
    // gotoxy(0,25)
    // [75] call gotoxy
    // [227] phi from main::@12 to gotoxy [phi:main::@12->gotoxy]
    // [227] phi gotoxy::x#10 = 0 [phi:main::@12->gotoxy#0] -- vbuz1=vbuc1 
    lda #0
    sta.z gotoxy.x
    // [227] phi gotoxy::y#8 = $19 [phi:main::@12->gotoxy#1] -- vbuz1=vbuc1 
    lda #$19
    sta.z gotoxy.y
    jsr gotoxy
    // [76] phi from main::@12 to main::@13 [phi:main::@12->main::@13]
    // main::@13
    // printf("vera in bitmap mode,\n")
    // [77] call printf_str
    // [282] phi from main::@13 to printf_str [phi:main::@13->printf_str]
    // [282] phi printf_str::s#9 = main::s [phi:main::@13->printf_str#0] -- pbuz1=pbuc1 
    lda #<s
    sta.z printf_str.s
    lda #>s
    sta.z printf_str.s+1
    jsr printf_str
    // [78] phi from main::@13 to main::@14 [phi:main::@13->main::@14]
    // main::@14
    // printf("color depth 8 bits per pixel.\n")
    // [79] call printf_str
    // [282] phi from main::@14 to printf_str [phi:main::@14->printf_str]
    // [282] phi printf_str::s#9 = main::s1 [phi:main::@14->printf_str#0] -- pbuz1=pbuc1 
    lda #<s1
    sta.z printf_str.s
    lda #>s1
    sta.z printf_str.s+1
    jsr printf_str
    // [80] phi from main::@14 to main::@15 [phi:main::@14->main::@15]
    // main::@15
    // printf("in this mode, it is possible to display\n")
    // [81] call printf_str
    // [282] phi from main::@15 to printf_str [phi:main::@15->printf_str]
    // [282] phi printf_str::s#9 = main::s2 [phi:main::@15->printf_str#0] -- pbuz1=pbuc1 
    lda #<s2
    sta.z printf_str.s
    lda #>s2
    sta.z printf_str.s+1
    jsr printf_str
    // [82] phi from main::@15 to main::@16 [phi:main::@15->main::@16]
    // main::@16
    // printf("graphics in 256 colors.\n")
    // [83] call printf_str
    // [282] phi from main::@16 to printf_str [phi:main::@16->printf_str]
    // [282] phi printf_str::s#9 = main::s3 [phi:main::@16->printf_str#0] -- pbuz1=pbuc1 
    lda #<s3
    sta.z printf_str.s
    lda #>s3
    sta.z printf_str.s+1
    ...
    ora VERA_DC_VIDEO
    sta VERA_DC_VIDEO
    // [86] phi from main::vera_layer0_show1 to main::@7 [phi:main::vera_layer0_show1->main::@7]
    // main::@7
    // bitmap_init(0, 0, 0x0000)
    // [87] call bitmap_init
    jsr bitmap_init
    // [88] phi from main::@7 to main::@17 [phi:main::@7->main::@17]
    // main::@17
    // bitmap_clear()
    // [89] call bitmap_clear
    jsr bitmap_clear
    // [90] phi from main::@17 to main::@18 [phi:main::@17->main::@18]
    // main::@18
    // gotoxy(0,29)
    // [91] call gotoxy
    // [227] phi from main::@18 to gotoxy [phi:main::@18->gotoxy]
    // [227] phi gotoxy::x#10 = 0 [phi:main::@18->gotoxy#0] -- vbuz1=vbuc1 
    lda #0
    sta.z gotoxy.x
    // [227] phi gotoxy::y#8 = $1d [phi:main::@18->gotoxy#1] -- vbuz1=vbuc1 
    lda #$1d
    sta.z gotoxy.y
    jsr gotoxy
    // [92] phi from main::@18 to main::@19 [phi:main::@18->main::@19]
    // main::@19
    // textcolor(YELLOW)
    // [93] call textcolor
    // [209] phi from main::@19 to textcolor [phi:main::@19->textcolor]
    // [209] phi textcolor::color#6 = YELLOW [phi:main::@19->textcolor#0] -- vbuz1=vbuc1 
    lda #YELLOW
    sta.z textcolor.color
    jsr textcolor
    // [94] phi from main::@19 to main::@20 [phi:main::@19->main::@20]
    // main::@20
    // printf("press a key ...")
    // [95] call printf_str
    // [282] phi from main::@20 to printf_str [phi:main::@20->printf_str]
    // [282] phi printf_str::s#9 = main::s4 [phi:main::@20->printf_str#0] -- pbuz1=pbuc1 
    lda #<s4
    sta.z printf_str.s
    lda #>s4
    sta.z printf_str.s+1
    jsr printf_str
    // [96] phi from main::@20 main::@30 to main::@1 [phi:main::@20/main::@30->main::@1]
    // main::@1
  __b1:
    // kbhit()
    // [97] call kbhit
    ...
    jmp __b2
  !__b2:
    // [101] phi from main::@21 to main::@3 [phi:main::@21->main::@3]
    // main::@3
    // textcolor(WHITE)
    // [102] call textcolor
    // [209] phi from main::@3 to textcolor [phi:main::@3->textcolor]
    // [209] phi textcolor::color#6 = WHITE [phi:main::@3->textcolor#0] -- vbuz1=vbuc1 
    lda #WHITE
    sta.z textcolor.color
    jsr textcolor
    // [103] phi from main::@3 to main::@31 [phi:main::@3->main::@31]
    // main::@31
    // bgcolor(BLACK)
    // [104] call bgcolor
    // [214] phi from main::@31 to bgcolor [phi:main::@31->bgcolor]
    // [214] phi bgcolor::color#4 = BLACK [phi:main::@31->bgcolor#0] -- vbuz1=vbuc1 
    lda #BLACK
    sta.z bgcolor.color
    jsr bgcolor
    // [105] phi from main::@31 to main::@32 [phi:main::@31->main::@32]
    // main::@32
    // clrscr()
    // [106] call clrscr
    jsr clrscr
    // [107] phi from main::@32 to main::@33 [phi:main::@32->main::@33]
    // main::@33
    // gotoxy(0,26)
    // [108] call gotoxy
    // [227] phi from main::@33 to gotoxy [phi:main::@33->gotoxy]
    // [227] phi gotoxy::x#10 = 0 [phi:main::@33->gotoxy#0] -- vbuz1=vbuc1 
    lda #0
    sta.z gotoxy.x
    // [227] phi gotoxy::y#8 = $1a [phi:main::@33->gotoxy#1] -- vbuz1=vbuc1 
    lda #$1a
    sta.z gotoxy.y
    jsr gotoxy
    // [109] phi from main::@33 to main::@34 [phi:main::@33->main::@34]
    // main::@34
    // printf("here you see all the colors possible.\n")
    // [110] call printf_str
    // [282] phi from main::@34 to printf_str [phi:main::@34->printf_str]
    // [282] phi printf_str::s#9 = main::s5 [phi:main::@34->printf_str#0] -- pbuz1=pbuc1 
    lda #<s5
    sta.z printf_str.s
    lda #>s5
    sta.z printf_str.s+1
    jsr printf_str
    // [111] phi from main::@34 to main::@35 [phi:main::@34->main::@35]
    // main::@35
    // gotoxy(0,29)
    // [112] call gotoxy
    // [227] phi from main::@35 to gotoxy [phi:main::@35->gotoxy]
    // [227] phi gotoxy::x#10 = 0 [phi:main::@35->gotoxy#0] -- vbuz1=vbuc1 
    lda #0
    sta.z gotoxy.x
    // [227] phi gotoxy::y#8 = $1d [phi:main::@35->gotoxy#1] -- vbuz1=vbuc1 
    lda #$1d
    sta.z gotoxy.y
    jsr gotoxy
    // [113] phi from main::@35 to main::@36 [phi:main::@35->main::@36]
    // main::@36
    // textcolor(YELLOW)
    // [114] call textcolor
    // [209] phi from main::@36 to textcolor [phi:main::@36->textcolor]
    // [209] phi textcolor::color#6 = YELLOW [phi:main::@36->textcolor#0] -- vbuz1=vbuc1 
    lda #YELLOW
    sta.z textcolor.color
    jsr textcolor
    // [115] phi from main::@36 to main::@37 [phi:main::@36->main::@37]
    // main::@37
    // printf("press a key ...")
    // [116] call printf_str
    // [282] phi from main::@37 to printf_str [phi:main::@37->printf_str]
    // [282] phi printf_str::s#9 = main::s4 [phi:main::@37->printf_str#0] -- pbuz1=pbuc1 
    lda #<s4
    sta.z printf_str.s
    lda #>s4
    sta.z printf_str.s+1
    jsr printf_str
    // [117] phi from main::@37 to main::@4 [phi:main::@37->main::@4]
    // [117] phi main::color#2 = 0 [phi:main::@37->main::@4#0] -- vbuz1=vbuc1 
    lda #0
    sta.z color
    // [117] phi main::x#3 = 0 [phi:main::@37->main::@4#1] -- vwuz1=vwuc1 
    sta.z x
    sta.z x+1
    // main::@4
  __b4:
    ...
    lda.z __41
    beq __b5
    // [122] phi from main::@38 to main::@6 [phi:main::@38->main::@6]
    // main::@6
    // screenlayer1()
    // [123] call screenlayer1
    jsr screenlayer1
    // [124] phi from main::@6 to main::@40 [phi:main::@6->main::@40]
    // main::@40
    // textcolor(WHITE)
    // [125] call textcolor
    // [209] phi from main::@40 to textcolor [phi:main::@40->textcolor]
    // [209] phi textcolor::color#6 = WHITE [phi:main::@40->textcolor#0] -- vbuz1=vbuc1 
    lda #WHITE
    sta.z textcolor.color
    jsr textcolor
    // [126] phi from main::@40 to main::@41 [phi:main::@40->main::@41]
    // main::@41
    // bgcolor(BLUE)
    // [127] call bgcolor
    // [214] phi from main::@41 to bgcolor [phi:main::@41->bgcolor]
    // [214] phi bgcolor::color#4 = BLUE [phi:main::@41->bgcolor#0] -- vbuz1=vbuc1 
    lda #BLUE
    sta.z bgcolor.color
    jsr bgcolor
    // [128] phi from main::@41 to main::@42 [phi:main::@41->main::@42]
    // main::@42
    // clrscr()
    // [129] call clrscr
    jsr clrscr
  ...
  __b5:
    ...
    // [133] bitmap_line::c#1 = main::color#2 -- vbuz1=vbuz2 
    lda.z color
    sta.z bitmap_line.c
    ...
    // [397] phi bitmap_line::y1#10 = $c7 [phi:main::@5->bitmap_line#1] -- vwuz1=vbuc1 
    lda #<$c7
    sta.z bitmap_line.y1
    lda #>$c7
    sta.z bitmap_line.y1+1
    // [397] phi bitmap_line::y0#10 = 0 [phi:main::@5->bitmap_line#2] -- vwuz1=vbuc1 
    lda #<0
    ...
    // main::@39
    // color++;
    // [135] main::color#1 = ++ main::color#2 -- vbuz1=_inc_vbuz1 
    inc.z color
    // x++;
    // [136] main::x#1 = ++ main::x#3 -- vwuz1=_inc_vwuz1 
    inc.z x
    bne !+
    inc.z x+1
  !:
    // if(x>319)
    // [137] if(main::x#1<=$13f) goto main::@43 -- vwuz1_le_vwuc1_then_la1 
    lda.z x+1
    cmp #>$13f
    bne !+
    lda.z x
  ...
  !:
    bcc __b4
    beq __b4
    // [117] phi from main::@39 to main::@4 [phi:main::@39->main::@4]
    // [117] phi main::color#2 = main::color#1 [phi:main::@39->main::@4#0] -- register_copy 
    // [117] phi main::x#3 = 0 [phi:main::@39->main::@4#1] -- vwuz1=vbuc1 
    lda #<0
    sta.z x
    sta.z x+1
    jmp __b4
    // [138] phi from main::@39 to main::@43 [phi:main::@39->main::@43]
    // main::@43
    // [117] phi from main::@43 to main::@4 [phi:main::@43->main::@4]
    // [117] phi main::color#2 = main::color#1 [phi:main::@43->main::@4#0] -- register_copy 
    // [117] phi main::x#3 = main::x#1 [phi:main::@43->main::@4#1] -- register_copy 
  ...
  __b2:
    ...
    // [476] phi modr16u::divisor#4 = $140 [phi:main::@22->modr16u#0] -- vwuz1=vwuc1 
    lda #<$140
    ...
    jsr modr16u
    // modr16u(rand(),320,0)
    // [144] modr16u::return#2 = modr16u::return#0 -- vwuz1=vwuz2 
    ...
    // [476] phi modr16u::divisor#4 = $140 [phi:main::@24->modr16u#0] -- vwuz1=vwuc1 
    lda #<$140
    sta.z modr16u.divisor
    lda #>$140
    sta.z modr16u.divisor+1
    ...
    jsr modr16u
    // modr16u(rand(),320,0)
    // [150] modr16u::return#3 = modr16u::return#0 -- vwuz1=vwuz2 
    lda.z modr16u.return
    ...
    // [476] phi modr16u::divisor#4 = $c8 [phi:main::@26->modr16u#0] -- vwuz1=vbuc1 
    lda #<$c8
    sta.z modr16u.divisor
    lda #>$c8
    sta.z modr16u.divisor+1
    ...
    jsr modr16u
    // modr16u(rand(),200,0)
    // [156] modr16u::return#4 = modr16u::return#0 -- vwuz1=vwuz2 
    lda.z modr16u.return
    ...
    // [476] phi modr16u::divisor#4 = $c8 [phi:main::@28->modr16u#0] -- vwuz1=vbuc1 
    lda #<$c8
    sta.z modr16u.divisor
    lda #>$c8
    sta.z modr16u.divisor+1
    ...
    // main::@30
    // [166] main::$38 = rand::return#12
    // bitmap_line(modr16u(rand(),320,0), modr16u(rand(),320,0), modr16u(rand(),200,0), modr16u(rand(),200,0), rand()&255)
    // [167] bitmap_line::c#0 = main::$38 & $ff -- vbuz1=vwuz2_band_vbuc1 
    lda #$ff
    and.z __38
    sta.z bitmap_line.c
...
screensize: {
    ...
    // [169] screensize::hscale#0 = *VERA_DC_HSCALE >> 7 -- vbuz1=_deref_pbuc1_ror_7 
    ...
    sta.z hscale
    // 40 << hscale
    // [170] screensize::$1 = $28 << screensize::hscale#0 -- vbuz1=vbuc1_rol_vbuz1 
    lda #$28
    ldy.z __1
    cpy #0
    beq !e+
  ...
  !e:
    sta.z __1
    // *x = 40 << hscale
    // [171] *screensize::x#0 = screensize::$1 -- _deref_pbuc1=vbuz1 
    sta x
    // char vscale = (*VERA_DC_VSCALE) >> 7
    // [172] screensize::vscale#0 = *VERA_DC_VSCALE >> 7 -- vbuz1=_deref_pbuc1_ror_7 
    lda VERA_DC_VSCALE
    rol
    rol
    and #1
    sta.z vscale
    // 30 << vscale
    // [173] screensize::$3 = $1e << screensize::vscale#0 -- vbuz1=vbuc1_rol_vbuz1 
    lda #$1e
    ldy.z __3
    cpy #0
    beq !e+
  ...
  !e:
    sta.z __3
    // *y = 30 << vscale
    // [174] *screensize::y#0 = screensize::$3 -- _deref_pbuc1=vbuz1 
    sta y
    // screensize::@return
    // }
    // [175] return 
...
screenlayer1: {
    ...
    sta __conio
    // (*VERA_L1_MAPBASE)>>7
    // [177] screenlayer1::$0 = *VERA_L1_MAPBASE >> 7 -- vbuz1=_deref_pbuc1_ror_7 
    lda VERA_L1_MAPBASE
    rol
    rol
    and #1
    ...
    // [178] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_BANK) = screenlayer1::$0 -- _deref_pbuc1=vbuz1 
    sta __conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_BANK
    // (*VERA_L1_MAPBASE)<<1
    // [179] screenlayer1::$1 = *VERA_L1_MAPBASE << 1 -- vbuz1=_deref_pbuc1_rol_1 
    lda VERA_L1_MAPBASE
    asl
    sta.z __1
    // MAKEWORD((*VERA_L1_MAPBASE)<<1,0)
    // [180] screenlayer1::$2 = screenlayer1::$1 w= 0 -- vwuz1=vbuz2_word_vbuc1 
    lda #0
    ldy.z __1
    sty.z __2+1
    sta.z __2
    // __conio.mapbase_offset = MAKEWORD((*VERA_L1_MAPBASE)<<1,0)
    // [181] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_OFFSET) = screenlayer1::$2 -- _deref_pwuc1=vwuz1 
    ...
    // [182] screenlayer1::$3 = *VERA_L1_CONFIG & VERA_LAYER_WIDTH_MASK -- vbuz1=_deref_pbuc1_band_vbuc2 
    lda #VERA_LAYER_WIDTH_MASK
    and VERA_L1_CONFIG
    sta.z __3
    // (*VERA_L1_CONFIG & VERA_LAYER_WIDTH_MASK) >> 4
    // [183] screenlayer1::$4 = screenlayer1::$3 >> 4 -- vbuz1=vbuz1_ror_4 
    lda.z __4
    lsr
    lsr
    lsr
    ...
    // [184] screenlayer1::$16 = screenlayer1::$4 << 1 -- vbuz1=vbuz1_rol_1 
    asl.z __16
    // [185] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPWIDTH) = VERA_LAYER_WIDTH[screenlayer1::$16] -- _deref_pwuc1=pwuc2_derefidx_vbuz1 
    ldy.z __16
    ...
    // [186] screenlayer1::$5 = *VERA_L1_CONFIG & VERA_LAYER_HEIGHT_MASK -- vbuz1=_deref_pbuc1_band_vbuc2 
    lda #VERA_LAYER_HEIGHT_MASK
    and VERA_L1_CONFIG
    sta.z __5
    // (*VERA_L1_CONFIG & VERA_LAYER_HEIGHT_MASK) >> 6
    // [187] screenlayer1::$6 = screenlayer1::$5 >> 6 -- vbuz1=vbuz1_ror_6 
    lda.z __6
    rol
    rol
    rol
    ...
    // [188] screenlayer1::$17 = screenlayer1::$6 << 1 -- vbuz1=vbuz1_rol_1 
    asl.z __17
    // [189] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPHEIGHT) = VERA_LAYER_HEIGHT[screenlayer1::$17] -- _deref_pwuc1=pwuc2_derefidx_vbuz1 
    ldy.z __17
    ...
    // (*VERA_L1_CONFIG)&VERA_LAYER_WIDTH_MASK
    // [190] screenlayer1::$7 = *VERA_L1_CONFIG & VERA_LAYER_WIDTH_MASK -- vbuz1=_deref_pbuc1_band_vbuc2 
    lda #VERA_LAYER_WIDTH_MASK
    and VERA_L1_CONFIG
    sta.z __7
    // ((*VERA_L1_CONFIG)&VERA_LAYER_WIDTH_MASK)>>4
    // [191] screenlayer1::$8 = screenlayer1::$7 >> 4 -- vbuz1=vbuz1_ror_4 
    lda.z __8
    lsr
    lsr
    lsr
    ...
    // [192] screenlayer1::$9 = screenlayer1::$8 + 6 -- vbuz1=vbuz1_plus_vbuc1 
    lda #6
    clc
    adc.z __9
    sta.z __9
    // __conio.rowshift = (((*VERA_L1_CONFIG)&VERA_LAYER_WIDTH_MASK)>>4)+6
    // [193] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_ROWSHIFT) = screenlayer1::$9 -- _deref_pbuc1=vbuz1 
    sta __conio+OFFSET_STRUCT_CX16_CONIO_ROWSHIFT
    // (*VERA_L1_CONFIG)&VERA_LAYER_WIDTH_MASK
    // [194] screenlayer1::$10 = *VERA_L1_CONFIG & VERA_LAYER_WIDTH_MASK -- vbuz1=_deref_pbuc1_band_vbuc2 
    lda #VERA_LAYER_WIDTH_MASK
    and VERA_L1_CONFIG
    sta.z __10
    // ((*VERA_L1_CONFIG)&VERA_LAYER_WIDTH_MASK)>>4
    // [195] screenlayer1::$11 = screenlayer1::$10 >> 4 -- vbuz1=vbuz1_ror_4 
    lda.z __11
    lsr
    lsr
    lsr
    ...
    // [196] screenlayer1::$18 = screenlayer1::$11 << 1 -- vbuz1=vbuz1_rol_1 
    asl.z __18
    // [197] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_ROWSKIP) = VERA_LAYER_SKIP[screenlayer1::$18] -- _deref_pwuc1=pwuc2_derefidx_vbuz1 
    ldy.z __18
    ...
    // BYTE1(cbm_k_plot_get())
    // [201] screenlayer1::$13 = byte1  screenlayer1::$12 -- vbuz1=_byte1_vwuz2 
    lda.z __12+1
    sta.z __13
    // __conio.cursor_x = BYTE1(cbm_k_plot_get())
    // [202] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_X) = screenlayer1::$13 -- _deref_pbuc1=vbuz1 
    sta __conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_X
    // cbm_k_plot_get()
    ...
    // BYTE0(cbm_k_plot_get())
    // [206] screenlayer1::$15 = byte0  screenlayer1::$14 -- vbuz1=_byte0_vwuz2 
    lda.z __14
    sta.z __15
    // __conio.cursor_y = BYTE0(cbm_k_plot_get())
    // [207] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_Y) = screenlayer1::$15 -- _deref_pbuc1=vbuz1 
    sta __conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_Y
    // screenlayer1::@return
    // }
    // [208] return 
...
textcolor: {
    ...
    .label color = $61
    // __conio.color & 0xF0
    // [210] textcolor::$0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_COLOR) & $f0 -- vbuz1=_deref_pbuc1_band_vbuc2 
    lda #$f0
    and __conio+OFFSET_STRUCT_CX16_CONIO_COLOR
    sta.z __0
    // __conio.color & 0xF0 | color
    // [211] textcolor::$1 = textcolor::$0 | textcolor::color#6 -- vbuz1=vbuz2_bor_vbuz1 
    lda.z __1
    ora.z __0
    sta.z __1
    // __conio.color = __conio.color & 0xF0 | color
    // [212] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_COLOR) = textcolor::$1 -- _deref_pbuc1=vbuz1 
...
bgcolor: {
    ...
    .label color = $61
    // __conio.color & 0x0F
    // [215] bgcolor::$0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_COLOR) & $f -- vbuz1=_deref_pbuc1_band_vbuc2 
    lda #$f
    and __conio+OFFSET_STRUCT_CX16_CONIO_COLOR
    sta.z __0
    // color << 4
    // [216] bgcolor::$1 = bgcolor::color#4 << 4 -- vbuz1=vbuz1_rol_4 
    lda.z __1
    asl
    asl
    asl
    ...
    // [217] bgcolor::$2 = bgcolor::$0 | bgcolor::$1 -- vbuz1=vbuz1_bor_vbuz2 
    lda.z __2
    ora.z __1
    sta.z __2
    // __conio.color = __conio.color & 0x0F | color << 4
    // [218] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_COLOR) = bgcolor::$2 -- _deref_pbuc1=vbuz1 
    sta __conio+OFFSET_STRUCT_CX16_CONIO_COLOR
    // bgcolor::@return
    // }
    // [219] return 
...
cbm_k_plot_get: {
    ...
    .label return = $7c
    // unsigned char x
    // [222] cbm_k_plot_get::x = 0 -- vbuz1=vbuc1 
    lda #0
    sta.z x
    // unsigned char y
    // [223] cbm_k_plot_get::y = 0 -- vbuz1=vbuc1 
    sta.z y
    // kickasm
    ...
    // MAKEWORD(x,y)
    // [225] cbm_k_plot_get::return#0 = cbm_k_plot_get::x w= cbm_k_plot_get::y -- vwuz1=vbuz2_word_vbuz3 
    lda.z x
    sta.z return+1
    lda.z y
    sta.z return
...
gotoxy: {
    ...
    .label y = $68
    // if(y>__conio.height)
    // [228] if(gotoxy::y#8<=*((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_HEIGHT)) goto gotoxy::@3 -- vbuz1_le__deref_pbuc1_then_la1 
    lda __conio+OFFSET_STRUCT_CX16_CONIO_HEIGHT
    cmp.z y
    bcs __b1
    // [230] phi from gotoxy to gotoxy::@1 [phi:gotoxy->gotoxy::@1]
    // [230] phi gotoxy::y#10 = 0 [phi:gotoxy->gotoxy::@1#0] -- vbuz1=vbuc1 
    lda #0
    sta.z y
  ...
  __b1:
    // if(x>=__conio.width)
    // [231] if(gotoxy::x#10<*((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_WIDTH)) goto gotoxy::@4 -- vbuz1_lt__deref_pbuc1_then_la1 
    lda.z x
    cmp __conio+OFFSET_STRUCT_CX16_CONIO_WIDTH
    bcc __b2
    // [233] phi from gotoxy::@1 to gotoxy::@2 [phi:gotoxy::@1->gotoxy::@2]
    // [233] phi gotoxy::x#9 = 0 [phi:gotoxy::@1->gotoxy::@2#0] -- vbuz1=vbuc1 
    lda #0
    sta.z x
  ...
  __b2:
    // __conio.cursor_x = x
    // [234] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_X) = gotoxy::x#9 -- _deref_pbuc1=vbuz1 
    lda.z x
    sta __conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_X
    // __conio.cursor_y = y
    // [235] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_Y) = gotoxy::y#10 -- _deref_pbuc1=vbuz1 
    lda.z y
    sta __conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_Y
    // unsigned int line_offset = (unsigned int)y << __conio.rowshift
    // [236] gotoxy::$5 = (unsigned int)gotoxy::y#10 -- vwuz1=_word_vbuz2 
    lda.z y
    sta.z __5
    lda #0
    sta.z __5+1
    // [237] gotoxy::line_offset#0 = gotoxy::$5 << *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_ROWSHIFT) -- vwuz1=vwuz1_rol__deref_pbuc1 
  ...
  !e:
    ...
    // [238] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_LINE) = gotoxy::line_offset#0 -- _deref_pwuc1=vwuz1 
    lda.z line_offset
...
cputln: {
    ...
    // [240] cputln::temp#0 = *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_LINE) -- vwuz1=_deref_pwuc1 
    ...
    // [241] cputln::temp#1 = cputln::temp#0 + *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_ROWSKIP) -- vwuz1=vwuz1_plus__deref_pwuc1 
    clc
    lda.z temp
    ...
    sta.z temp+1
    // __conio.line = temp
    // [242] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_LINE) = cputln::temp#1 -- _deref_pwuc1=vwuz1 
    lda.z temp
    sta __conio+OFFSET_STRUCT_CX16_CONIO_LINE
    lda.z temp+1
    sta __conio+OFFSET_STRUCT_CX16_CONIO_LINE+1
...
vera_layer0_mode_bitmap: {
    ...
    // [247] vera_layer0_mode_bitmap::$0 = *VERA_L0_CONFIG | VERA_LAYER_CONFIG_MODE_BITMAP -- vbuz1=_deref_pbuc1_bor_vbuc2 
    lda #VERA_LAYER_CONFIG_MODE_BITMAP
    ora VERA_L0_CONFIG
    sta.z __0
    // *VERA_L0_CONFIG = *VERA_L0_CONFIG | VERA_LAYER_CONFIG_MODE_BITMAP
    // [248] *VERA_L0_CONFIG = vera_layer0_mode_bitmap::$0 -- _deref_pbuc1=vbuz1 
    sta VERA_L0_CONFIG
    // vera_layer0_mode_bitmap::vera_layer0_set_tile_width1
    // *VERA_L0_TILEBASE &= ~VERA_TILEBASE_WIDTH_MASK
    // [249] *VERA_L0_TILEBASE = *VERA_L0_TILEBASE & ~VERA_TILEBASE_WIDTH_MASK -- _deref_pbuc1=_deref_pbuc1_band_vbuc2 
    lda #VERA_TILEBASE_WIDTH_MASK^$ff
    and VERA_L0_TILEBASE
    sta VERA_L0_TILEBASE
    // *VERA_L0_TILEBASE |= tilewidth
    // [250] *VERA_L0_TILEBASE = *VERA_L0_TILEBASE -- _deref_pbuc1=_deref_pbuc1 
    sta VERA_L0_TILEBASE
    // vera_layer0_mode_bitmap::vera_layer0_set_tilebase1
    // *VERA_L0_TILEBASE &= ~VERA_LAYER_TILEBASE_MASK
    // [251] *VERA_L0_TILEBASE = *VERA_L0_TILEBASE & ~VERA_LAYER_TILEBASE_MASK -- _deref_pbuc1=_deref_pbuc1_band_vbuc2 
    lda #VERA_LAYER_TILEBASE_MASK^$ff
    and VERA_L0_TILEBASE
    sta VERA_L0_TILEBASE
    // *VERA_L0_TILEBASE |= ((tilebase_bank << 7) | BYTE1(tilebase_offset)>>1)
    // [252] *VERA_L0_TILEBASE = *VERA_L0_TILEBASE -- _deref_pbuc1=_deref_pbuc1 
    sta VERA_L0_TILEBASE
    // vera_layer0_mode_bitmap::vera_layer0_set_color_depth1
    // *VERA_L0_CONFIG &= ~VERA_LAYER_COLOR_DEPTH_MASK
    // [253] *VERA_L0_CONFIG = *VERA_L0_CONFIG & ~VERA_LAYER_COLOR_DEPTH_MASK -- _deref_pbuc1=_deref_pbuc1_band_vbuc2 
    lda #VERA_LAYER_COLOR_DEPTH_MASK^$ff
    and VERA_L0_CONFIG
    sta VERA_L0_CONFIG
    // *VERA_L0_CONFIG |= bpp
    // [254] *VERA_L0_CONFIG = *VERA_L0_CONFIG | VERA_LAYER_COLOR_DEPTH_8BPP -- _deref_pbuc1=_deref_pbuc1_bor_vbuc2 
    lda #VERA_LAYER_COLOR_DEPTH_8BPP
    ora VERA_L0_CONFIG
    sta VERA_L0_CONFIG
    // vera_layer0_mode_bitmap::vera_display_set_scale_double1
    // *VERA_DC_HSCALE = 64
    // [255] *VERA_DC_HSCALE = $40 -- _deref_pbuc1=vbuc2 
    lda #$40
    sta VERA_DC_HSCALE
    // *VERA_DC_VSCALE = 64
    // [256] *VERA_DC_VSCALE = $40 -- _deref_pbuc1=vbuc2 
    sta VERA_DC_VSCALE
...
clrscr: {
    ...
    // [258] clrscr::line_text#0 = *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_OFFSET) -- vwuz1=_deref_pwuc1 
    lda __conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_OFFSET
    sta.z line_text
    lda __conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_OFFSET+1
    sta.z line_text+1
    // char color = __conio.color
    // [259] clrscr::color#0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_COLOR) -- vbuz1=_deref_pbuc1 
    lda __conio+OFFSET_STRUCT_CX16_CONIO_COLOR
    sta.z color
    // unsigned int mapheight = __conio.mapheight
    // [260] clrscr::mapheight#0 = *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPHEIGHT) -- vwuz1=_deref_pwuc1 
    lda __conio+OFFSET_STRUCT_CX16_CONIO_MAPHEIGHT
    sta.z mapheight
    lda __conio+OFFSET_STRUCT_CX16_CONIO_MAPHEIGHT+1
    sta.z mapheight+1
    // unsigned int mapwidth = __conio.mapwidth
    // [261] clrscr::mapwidth#0 = *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPWIDTH) -- vwuz1=_deref_pwuc1 
    lda __conio+OFFSET_STRUCT_CX16_CONIO_MAPWIDTH
    sta.z mapwidth
    lda __conio+OFFSET_STRUCT_CX16_CONIO_MAPWIDTH+1
    sta.z mapwidth+1
    // [262] phi from clrscr to clrscr::@1 [phi:clrscr->clrscr::@1]
    // [262] phi clrscr::line_text#2 = clrscr::line_text#0 [phi:clrscr->clrscr::@1#0] -- register_copy 
    // [262] phi clrscr::l#2 = 0 [phi:clrscr->clrscr::@1#1] -- vbuz1=vbuc1 
    lda #0
    sta.z l
    // clrscr::@1
  __b1:
    // for( char l=0;l<mapheight; l++ )
    // [263] if(clrscr::l#2<clrscr::mapheight#0) goto clrscr::@2 -- vbuz1_lt_vwuz2_then_la1 
    lda.z mapheight+1
    bne __b2
    lda.z l
    cmp.z mapheight
    ...
    // clrscr::@3
    // __conio.cursor_x = 0
    // [264] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_X) = 0 -- _deref_pbuc1=vbuc2 
    lda #0
    sta __conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_X
    // __conio.cursor_y = 0
    // [265] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_Y) = 0 -- _deref_pbuc1=vbuc2 
    sta __conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_Y
    // __conio.line = 0
    // [266] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_LINE) = 0 -- _deref_pwuc1=vbuc2 
    sta __conio+OFFSET_STRUCT_CX16_CONIO_LINE
    sta __conio+OFFSET_STRUCT_CX16_CONIO_LINE+1
    // clrscr::@return
    // }
  ...
  __b2:
    // *VERA_CTRL &= ~VERA_ADDRSEL
    // [268] *VERA_CTRL = *VERA_CTRL & ~VERA_ADDRSEL -- _deref_pbuc1=_deref_pbuc1_band_vbuc2 
    // Select DATA0
    lda #VERA_ADDRSEL^$ff
    and VERA_CTRL
    sta VERA_CTRL
    // BYTE0(ch)
    // [269] clrscr::$1 = byte0  clrscr::line_text#2 -- vbuz1=_byte0_vwuz2 
    lda.z line_text
    sta.z __1
    // *VERA_ADDRX_L = BYTE0(ch)
    // [270] *VERA_ADDRX_L = clrscr::$1 -- _deref_pbuc1=vbuz1 
    // Set address
    sta VERA_ADDRX_L
    // BYTE1(ch)
    // [271] clrscr::$2 = byte1  clrscr::line_text#2 -- vbuz1=_byte1_vwuz2 
    lda.z line_text+1
    sta.z __2
    // *VERA_ADDRX_M = BYTE1(ch)
    // [272] *VERA_ADDRX_M = clrscr::$2 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_M
    // __conio.mapbase_bank | VERA_INC_1
    // [273] clrscr::$3 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_BANK) | VERA_INC_1 -- vbuz1=_deref_pbuc1_bor_vbuc2 
    lda #VERA_INC_1
    ora __conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_BANK
    sta.z __3
    // *VERA_ADDRX_H = __conio.mapbase_bank | VERA_INC_1
    // [274] *VERA_ADDRX_H = clrscr::$3 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_H
    // [275] phi from clrscr::@2 to clrscr::@4 [phi:clrscr::@2->clrscr::@4]
    // [275] phi clrscr::c#2 = 0 [phi:clrscr::@2->clrscr::@4#0] -- vbuz1=vbuc1 
    lda #0
    sta.z c
    // clrscr::@4
  __b4:
    // for( char c=0;c<mapwidth; c++ )
    // [276] if(clrscr::c#2<clrscr::mapwidth#0) goto clrscr::@5 -- vbuz1_lt_vwuz2_then_la1 
    lda.z mapwidth+1
    bne __b5
    lda.z c
    cmp.z mapwidth
    ...
    // [277] clrscr::line_text#1 = clrscr::line_text#2 + *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_ROWSKIP) -- vwuz1=vwuz1_plus__deref_pwuc1 
    clc
    lda.z line_text
    adc __conio+OFFSET_STRUCT_CX16_CONIO_ROWSKIP
    sta.z line_text
    ...
    sta.z line_text+1
    // for( char l=0;l<mapheight; l++ )
    // [278] clrscr::l#1 = ++ clrscr::l#2 -- vbuz1=_inc_vbuz1 
    inc.z l
    // [262] phi from clrscr::@6 to clrscr::@1 [phi:clrscr::@6->clrscr::@1]
    // [262] phi clrscr::line_text#2 = clrscr::line_text#1 [phi:clrscr::@6->clrscr::@1#0] -- register_copy 
    // [262] phi clrscr::l#2 = clrscr::l#1 [phi:clrscr::@6->clrscr::@1#1] -- register_copy 
    jmp __b1
    // clrscr::@5
  __b5:
    // *VERA_DATA0 = ' '
    // [279] *VERA_DATA0 = ' ' -- _deref_pbuc1=vbuc2 
    lda #' '
    sta VERA_DATA0
    // *VERA_DATA0 = color
    // [280] *VERA_DATA0 = clrscr::color#0 -- _deref_pbuc1=vbuz1 
    lda.z color
    sta VERA_DATA0
    // for( char c=0;c<mapwidth; c++ )
    // [281] clrscr::c#1 = ++ clrscr::c#2 -- vbuz1=_inc_vbuz1 
    inc.z c
    // [275] phi from clrscr::@5 to clrscr::@4 [phi:clrscr::@5->clrscr::@4]
    // [275] phi clrscr::c#2 = clrscr::c#1 [phi:clrscr::@5->clrscr::@4#0] -- register_copy 
    jmp __b4
}
  // printf_str
...
printf_str: {
    ...
    // [283] phi printf_str::s#8 = printf_str::s#9 [phi:printf_str/printf_str::@2->printf_str::@1#0] -- register_copy 
    // printf_str::@1
  __b1:
    // while(c=*s++)
    // [284] printf_str::c#1 = *printf_str::s#8 -- vbuz1=_deref_pbuz2 
    ldy #0
    lda (s),y
    sta.z c
    // [285] printf_str::s#0 = ++ printf_str::s#8 -- pbuz1=_inc_pbuz1 
    inc.z s
    bne !+
    inc.z s+1
  !:
    // [286] if(0!=printf_str::c#1) goto printf_str::@2 -- 0_neq_vbuz1_then_la1 
    lda.z c
    bne __b2
    // printf_str::@return
    // }
  ...
  __b2:
    // putc(c)
    // [288] stackpush(char) = printf_str::c#1 -- _stackpushbyte_=vbuz1 
    lda.z c
    pha
    // [289] callexecute cputc  -- call_vprc1 
    jsr cputc
...
bitmap_init: {
    ...
    // bitmap_init::@2
    // *VERA_L0_CONFIG & VERA_LAYER_COLOR_DEPTH_MASK
    // [293] bitmap_init::$5 = *VERA_L0_CONFIG & VERA_LAYER_COLOR_DEPTH_MASK -- vbuz1=_deref_pbuc1_band_vbuc2 
    lda #VERA_LAYER_COLOR_DEPTH_MASK
    and VERA_L0_CONFIG
    sta.z __5
    // __bitmap.color_depth = (*VERA_L0_CONFIG & VERA_LAYER_COLOR_DEPTH_MASK)
    // [294] *((char *)&__bitmap+$1187) = bitmap_init::$5 -- _deref_pbuc1=vbuz1 
    sta __bitmap+$1187
    ...
    // [299] *((char *)&__bitmap+$1185) = bitmap_init::$1 -- _deref_pbuc1=vbuz1 
    lda.z __1
    sta __bitmap+$1185
    // bitmap_vscale()
    ...
    // [303] *((char *)&__bitmap+$1186) = bitmap_init::$2 -- _deref_pbuc1=vbuz1 
    // Returns 1 when 640 and 2 when 320, 3 when 160.
    lda.z __2
    sta __bitmap+$1186
    // unsigned char bitmask = bitmasks[__bitmap.color_depth]
    // [304] bitmap_init::bitmask#0 = bitmasks[*((char *)&__bitmap+$1187)] -- vbuz1=pbuc1_derefidx_(_deref_pbuc2) 
    // Returns 1 when 480 and 2 when 240, 3 when 160.
    ldy __bitmap+$1187
    lda bitmasks,y
    sta.z bitmask
    // signed char bitshift = bitshifts[__bitmap.color_depth]
    // [305] bitmap_init::bitshift#0 = bitshifts[*((char *)&__bitmap+$1187)] -- vbsz1=pbsc1_derefidx_(_deref_pbuc2) 
    lda bitshifts,y
    sta.z bitshift
    ...
    // [306] phi bitmap_init::x#10 = 0 [phi:bitmap_init::@21->bitmap_init::@3#2] -- vwuz1=vwuc1 
    lda #<0
    sta.z x
    sta.z x+1
    // bitmap_init::@3
  __b3:
    ...
    // [307] if(bitmap_init::x#10<$276) goto bitmap_init::@4 -- vwuz1_lt_vwuc1_then_la1 
    lda.z x+1
    cmp #>$276
    bcs !__b4+
    jmp __b4
  ...
  !:
    ...
    // [308] bitmap_init::$3 = *((char *)&__bitmap+$1187) << 2 -- vbuz1=_deref_pbuc1_rol_2 
    lda __bitmap+$1187
    asl
    asl
    sta.z __3
    // (__bitmap.color_depth<<2)+__bitmap.hscale
    // [309] bitmap_init::$4 = bitmap_init::$3 + *((char *)&__bitmap+$1185) -- vbuz1=vbuz1_plus__deref_pbuc1 
    lda __bitmap+$1185
    clc
    adc.z __4
    sta.z __4
    // unsigned int hdelta = hdeltas[(__bitmap.color_depth<<2)+__bitmap.hscale]
    // [310] bitmap_init::$25 = bitmap_init::$4 << 1 -- vbuz1=vbuz1_rol_1 
    asl.z __25
    // [311] bitmap_init::hdelta#0 = hdeltas[bitmap_init::$25] -- vwuz1=pwuc1_derefidx_vbuz2 
    ...
    // [312] bitmap_init::yoffs#0 = *((unsigned long *)&__bitmap+$1180) -- vduz1=_deref_pduc1 
    ...
    // [313] phi bitmap_init::y#2 = 0 [phi:bitmap_init::@5->bitmap_init::@18#1] -- vwuz1=vwuc1 
    lda #<0
    sta.z y
    sta.z y+1
    // bitmap_init::@18
  __b18:
    ...
    // [314] if(bitmap_init::y#2<$1df) goto bitmap_init::@19 -- vwuz1_lt_vwuc1_then_la1 
    lda.z y+1
    cmp #>$1df
    bcc __b19
    bne !+
  ...
  __b19:
    ...
    // [316] bitmap_init::$30 = bitmap_init::y#2 << 2 -- vwuz1=vwuz2_rol_2 
    lda.z y
    asl
    sta.z __30
    lda.z y+1
    ...
    asl.z __30
    rol.z __30+1
    // [317] bitmap_init::$44 = (unsigned long *)&__bitmap+$500 + bitmap_init::$30 -- pduz1=pduc1_plus_vwuz1 
    lda.z __44
    clc
    adc #<__bitmap+$500
    sta.z __44
    ...
    adc #>__bitmap+$500
    sta.z __44+1
    // [318] *bitmap_init::$44 = bitmap_init::yoffs#2 -- _deref_pduz1=vduz2 
    ldy #0
    lda.z yoffs
    sta (__44),y
    iny
    ...
    sta (__44),y
    // yoffs = yoffs + hdelta
    // [319] bitmap_init::yoffs#1 = bitmap_init::yoffs#2 + bitmap_init::hdelta#0 -- vduz1=vduz1_plus_vwuz2 
    lda.z yoffs
    clc
    adc.z hdelta
    sta.z yoffs
    ...
    sta.z yoffs+3
    // for(unsigned int y=0; y<479; y++)
    // [320] bitmap_init::y#1 = ++ bitmap_init::y#2 -- vwuz1=_inc_vwuz1 
    inc.z y
    bne !+
    inc.z y+1
  !:
  ...
  __b4:
    ...
    // bitmap_init::@12
    // x >> 3
    // [322] bitmap_init::$10 = bitmap_init::x#10 >> 3 -- vwuz1=vwuz2_ror_3 
    lda.z x+1
    lsr
    sta.z __10+1
    lda.z x
    ...
    // [323] bitmap_init::$26 = bitmap_init::x#10 << 1 -- vwuz1=vwuz2_rol_1 
    lda.z x
    asl
    sta.z __26
    lda.z x+1
    rol
    sta.z __26+1
    // [324] bitmap_init::$32 = (unsigned int *)&__bitmap + bitmap_init::$26 -- pwuz1=pwuc1_plus_vwuz1 
    lda.z __32
    clc
    adc #<__bitmap
    sta.z __32
    ...
    adc #>__bitmap
    sta.z __32+1
    // [325] *bitmap_init::$32 = bitmap_init::$10 -- _deref_pwuz1=vwuz2 
    ldy #0
    lda.z __10
    sta (__32),y
    iny
    ...
    // [326] bitmap_init::$33 = (char *)&__bitmap+$c80 + bitmap_init::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$c80
    sta.z __33
    ...
    adc #>__bitmap+$c80
    sta.z __33+1
    // [327] *bitmap_init::$33 = bitmap_init::bitmask#10 -- _deref_pbuz1=vbuz2 
    lda.z bitmask
    ldy #0
    sta (__33),y
    // __bitmap.plot_bitshift[x] = (unsigned char)bitshift
    // [328] bitmap_init::$34 = (char *)&__bitmap+$f00 + bitmap_init::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$f00
    sta.z __34
    ...
    adc #>__bitmap+$f00
    sta.z __34+1
    // [329] *bitmap_init::$34 = (char)bitmap_init::bitshift#10 -- _deref_pbuz1=vbuz2 
    lda.z bitshift
    sta (__34),y
    // bitshift -= 1
    // [330] bitmap_init::bitshift#1 = bitmap_init::bitshift#10 - 1 -- vbsz1=vbsz1_minus_1 
    dec.z bitshift
    // bitmask >>= 1
    // [331] bitmap_init::bitmask#1 = bitmap_init::bitmask#10 >> 1 -- vbuz1=vbuz1_ror_1 
    lsr.z bitmask
  ...
  __b6:
    ...
    // bitmap_init::@13
    // x >> 2
    // [334] bitmap_init::$13 = bitmap_init::x#10 >> 2 -- vwuz1=vwuz2_ror_2 
    lda.z x+1
    lsr
    sta.z __13+1
    lda.z x
    ...
    // [335] bitmap_init::$27 = bitmap_init::x#10 << 1 -- vwuz1=vwuz2_rol_1 
    lda.z x
    asl
    sta.z __27
    lda.z x+1
    rol
    sta.z __27+1
    // [336] bitmap_init::$35 = (unsigned int *)&__bitmap + bitmap_init::$27 -- pwuz1=pwuc1_plus_vwuz1 
    lda.z __35
    clc
    adc #<__bitmap
    sta.z __35
    ...
    adc #>__bitmap
    sta.z __35+1
    // [337] *bitmap_init::$35 = bitmap_init::$13 -- _deref_pwuz1=vwuz2 
    ldy #0
    lda.z __13
    sta (__35),y
    iny
    ...
    sta (__35),y
    // __bitmap.plot_bitmask[x] = bitmask
    // [338] bitmap_init::$36 = (char *)&__bitmap+$c80 + bitmap_init::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$c80
    sta.z __36
    ...
    adc #>__bitmap+$c80
    sta.z __36+1
    // [339] *bitmap_init::$36 = bitmap_init::bitmask#11 -- _deref_pbuz1=vbuz2 
    lda.z bitmask
    ldy #0
    sta (__36),y
    // __bitmap.plot_bitshift[x] = (unsigned char)bitshift
    // [340] bitmap_init::$37 = (char *)&__bitmap+$f00 + bitmap_init::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$f00
    sta.z __37
    ...
    adc #>__bitmap+$f00
    sta.z __37+1
    // [341] *bitmap_init::$37 = (char)bitmap_init::bitshift#11 -- _deref_pbuz1=vbuz2 
    lda.z bitshift
    sta (__37),y
    // bitshift -= 2
    // [342] bitmap_init::bitshift#2 = bitmap_init::bitshift#11 - 2 -- vbsz1=vbsz1_minus_2 
    dec.z bitshift
    dec.z bitshift
    // bitmask >>= 2
    // [343] bitmap_init::bitmask#2 = bitmap_init::bitmask#11 >> 2 -- vbuz1=vbuz1_ror_2 
    lda.z bitmask
    lsr
    lsr
    sta.z bitmask
  ...
  __b7:
    ...
    // bitmap_init::@14
    // x >> 1
    // [346] bitmap_init::$16 = bitmap_init::x#10 >> 1 -- vwuz1=vwuz2_ror_1 
    lda.z x+1
    lsr
    sta.z __16+1
    lda.z x
    ...
    // [347] bitmap_init::$28 = bitmap_init::x#10 << 1 -- vwuz1=vwuz2_rol_1 
    lda.z x
    asl
    sta.z __28
    lda.z x+1
    rol
    sta.z __28+1
    // [348] bitmap_init::$38 = (unsigned int *)&__bitmap + bitmap_init::$28 -- pwuz1=pwuc1_plus_vwuz1 
    lda.z __38
    clc
    adc #<__bitmap
    sta.z __38
    ...
    adc #>__bitmap
    sta.z __38+1
    // [349] *bitmap_init::$38 = bitmap_init::$16 -- _deref_pwuz1=vwuz2 
    ldy #0
    lda.z __16
    sta (__38),y
    iny
    ...
    sta (__38),y
    // __bitmap.plot_bitmask[x] = bitmask
    // [350] bitmap_init::$39 = (char *)&__bitmap+$c80 + bitmap_init::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$c80
    sta.z __39
    ...
    adc #>__bitmap+$c80
    sta.z __39+1
    // [351] *bitmap_init::$39 = bitmap_init::bitmask#12 -- _deref_pbuz1=vbuz2 
    lda.z bitmask
    ldy #0
    sta (__39),y
    // __bitmap.plot_bitshift[x] = (unsigned char)bitshift
    // [352] bitmap_init::$40 = (char *)&__bitmap+$f00 + bitmap_init::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$f00
    sta.z __40
    ...
    adc #>__bitmap+$f00
    sta.z __40+1
    // [353] *bitmap_init::$40 = (char)bitmap_init::bitshift#12 -- _deref_pbuz1=vbuz2 
    lda.z bitshift
    sta (__40),y
    // bitshift -= 4
    // [354] bitmap_init::bitshift#3 = bitmap_init::bitshift#12 - 4 -- vbsz1=vbsz1_minus_vbsc1 
    sec
    sbc #4
    sta.z bitshift
    // bitmask >>= 4
    // [355] bitmap_init::bitmask#3 = bitmap_init::bitmask#12 >> 4 -- vbuz1=vbuz1_ror_4 
    lda.z bitmask
    lsr
    lsr
    lsr
  ...
  __b8:
    ...
    // bitmap_init::@15
    // __bitmap.plot_x[x] = x
    // [358] bitmap_init::$29 = bitmap_init::x#10 << 1 -- vwuz1=vwuz2_rol_1 
    lda.z x
    asl
    sta.z __29
    lda.z x+1
    rol
    sta.z __29+1
    // [359] bitmap_init::$41 = (unsigned int *)&__bitmap + bitmap_init::$29 -- pwuz1=pwuc1_plus_vwuz1 
    lda.z __41
    clc
    adc #<__bitmap
    sta.z __41
    ...
    adc #>__bitmap
    sta.z __41+1
    // [360] *bitmap_init::$41 = bitmap_init::x#10 -- _deref_pwuz1=vwuz2 
    ldy #0
    lda.z x
    sta (__41),y
    iny
    ...
    sta (__41),y
    // __bitmap.plot_bitmask[x] = bitmask
    // [361] bitmap_init::$42 = (char *)&__bitmap+$c80 + bitmap_init::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$c80
    sta.z __42
    ...
    adc #>__bitmap+$c80
    sta.z __42+1
    // [362] *bitmap_init::$42 = bitmap_init::bitmask#13 -- _deref_pbuz1=vbuz2 
    lda.z bitmask
    ldy #0
    sta (__42),y
    // __bitmap.plot_bitshift[x] = (unsigned char)bitshift
    // [363] bitmap_init::$43 = (char *)&__bitmap+$f00 + bitmap_init::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$f00
    sta.z __43
    ...
    adc #>__bitmap+$f00
    sta.z __43+1
    // [364] *bitmap_init::$43 = (char)bitmap_init::bitshift#13 -- _deref_pbuz1=vbuz2 
    lda.z bitshift
    sta (__43),y
    // bitmap_init::@9
  __b9:
    // if(bitshift<0)
    // [365] if(bitmap_init::bitshift#13>=0) goto bitmap_init::@10 -- vbsz1_ge_0_then_la1 
    lda.z bitshift
    cmp #0
    bpl __b10
    // bitmap_init::@16
    // bitshift = bitshifts[__bitmap.color_depth]
    // [366] bitmap_init::bitshift#4 = bitshifts[*((char *)&__bitmap+$1187)] -- vbsz1=pbsc1_derefidx_(_deref_pbuc2) 
    ldy __bitmap+$1187
    lda bitshifts,y
    sta.z bitshift
  ...
  __b10:
    // if(bitmask==0)
    // [368] if(bitmap_init::bitmask#13!=0) goto bitmap_init::@11 -- vbuz1_neq_0_then_la1 
    lda.z bitmask
    bne __b11
    // bitmap_init::@17
    // bitmask = bitmasks[__bitmap.color_depth]
    // [369] bitmap_init::bitmask#4 = bitmasks[*((char *)&__bitmap+$1187)] -- vbuz1=pbuc1_derefidx_(_deref_pbuc2) 
    ldy __bitmap+$1187
    lda bitmasks,y
    sta.z bitmask
  ...
  __b11:
    // for(unsigned int x=0; x<630; x++)
    // [371] bitmap_init::x#1 = ++ bitmap_init::x#10 -- vwuz1=_inc_vwuz1 
    inc.z x
    bne !+
    inc.z x+1
  !:
...
bitmap_clear: {
    ...
    // [372] bitmap_clear::$7 = *((char *)&__bitmap+$1186) << 1 -- vbuz1=_deref_pbuc1_rol_1 
    lda __bitmap+$1186
    asl
    sta.z __7
    // [373] bitmap_clear::vdelta#0 = vdeltas[bitmap_clear::$7] -- vwuz1=pwuc1_derefidx_vbuz2 
    tay
    lda vdeltas,y
    sta.z vdelta
    lda vdeltas+1,y
    sta.z vdelta+1
    // __bitmap.color_depth<<2
    // [374] bitmap_clear::$0 = *((char *)&__bitmap+$1187) << 2 -- vbuz1=_deref_pbuc1_rol_2 
    lda __bitmap+$1187
    asl
    asl
    sta.z __0
    // (__bitmap.color_depth<<2)+__bitmap.hscale
    // [375] bitmap_clear::$1 = bitmap_clear::$0 + *((char *)&__bitmap+$1185) -- vbuz1=vbuz1_plus__deref_pbuc1 
    lda __bitmap+$1185
    clc
    adc.z __1
    sta.z __1
    // unsigned int hdelta = hdeltas[(__bitmap.color_depth<<2)+__bitmap.hscale]
    // [376] bitmap_clear::$8 = bitmap_clear::$1 << 1 -- vbuz1=vbuz1_rol_1 
    asl.z __8
    // [377] bitmap_clear::hdelta#0 = hdeltas[bitmap_clear::$8] -- vwuz1=pwuc1_derefidx_vbuz2 
    ldy.z __8
    lda hdeltas,y
    sta.z hdelta
    lda hdeltas+1,y
    sta.z hdelta+1
    // hdelta = hdelta >> 1
    // [378] bitmap_clear::hdelta#1 = bitmap_clear::hdelta#0 >> 1 -- vwuz1=vwuz1_ror_1 
    lsr.z hdelta+1
    ror.z hdelta
    ...
    // [384] bitmap_clear::count#0 = (unsigned int)bitmap_clear::$3 -- vwuz1=_word_vduz2 
    lda.z __3
    sta.z count
    lda.z __3+1
    sta.z count+1
    // vram_bank_t vbank = BYTE3(__bitmap.address)
    // [385] bitmap_clear::vbank#0 = byte3  *((unsigned long *)&__bitmap+$1180) -- vbuz1=_byte3__deref_pduc1 
    lda __bitmap+$1180+3
    sta.z vbank
    // vram_offset_t vdest = WORD0(__bitmap.address)
    // [386] bitmap_clear::vdest#0 = word0  *((unsigned long *)&__bitmap+$1180) -- vwuz1=_word0__deref_pduc1 
    lda __bitmap+$1180
    sta.z vdest
    lda __bitmap+$1180+1
    sta.z vdest+1
...
bitmap_line: {
    ...
    .label c = $69
    // if(x0<x1)
    // [398] if(bitmap_line::x0#10<bitmap_line::x1#10) goto bitmap_line::@1 -- vwuz1_lt_vwuz2_then_la1 
    lda.z x0+1
    cmp.z x1+1
    bcs !__b1+
    jmp __b1
  ...
  !:
    // bitmap_line::@2
    // xd = x0-x1
    // [399] bitmap_line::xd#2 = bitmap_line::x0#10 - bitmap_line::x1#10 -- vwuz1=vwuz2_minus_vwuz3 
    lda.z x0
    sec
    sbc.z x1
    sta.z xd
    ...
    sta.z xd+1
    // if(y0<y1)
    // [400] if(bitmap_line::y0#10<bitmap_line::y1#10) goto bitmap_line::@7 -- vwuz1_lt_vwuz2_then_la1 
    lda.z y0+1
    cmp.z y1+1
    bcc __b7
    bne !+
  ...
  !:
    // bitmap_line::@3
    // yd = y0-y1
    // [401] bitmap_line::yd#2 = bitmap_line::y0#10 - bitmap_line::y1#10 -- vwuz1=vwuz2_minus_vwuz3 
    lda.z y0
    sec
    sbc.z y1
    sta.z yd_1
    ...
    sta.z yd_1+1
    // if(yd<xd)
    // [402] if(bitmap_line::yd#2<bitmap_line::xd#2) goto bitmap_line::@8 -- vwuz1_lt_vwuz2_then_la1 
    cmp.z xd+1
    bcc __b8
    bne !+
    lda.z yd_1
  ...
  !:
    ...
    // [403] bitmap_line_ydxi::y#0 = bitmap_line::y1#10 -- vwuz1=vwuz2 
    lda.z y1
    sta.z bitmap_line_ydxi.y
    lda.z y1+1
    sta.z bitmap_line_ydxi.y+1
    // [404] bitmap_line_ydxi::x#0 = bitmap_line::x1#10 -- vwuz1=vwuz2 
    lda.z x1
  ...
  __b8:
    ...
    // [411] bitmap_line_xdyi::x#0 = bitmap_line::x1#10 -- vwuz1=vwuz2 
    lda.z x1
    sta.z bitmap_line_xdyi.x
    lda.z x1+1
    sta.z bitmap_line_xdyi.x+1
    // [412] bitmap_line_xdyi::y#0 = bitmap_line::y1#10
    // [413] bitmap_line_xdyi::x1#0 = bitmap_line::x0#10 -- vwuz1=vwuz2 
    lda.z x0
    sta.z bitmap_line_xdyi.x1
    lda.z x0+1
    sta.z bitmap_line_xdyi.x1+1
    // [414] bitmap_line_xdyi::xd#0 = bitmap_line::xd#2 -- vwuz1=vwuz2 
    lda.z xd
    sta.z bitmap_line_xdyi.xd
    lda.z xd+1
    sta.z bitmap_line_xdyi.xd+1
    // [415] bitmap_line_xdyi::yd#0 = bitmap_line::yd#2 -- vwuz1=vwuz2 
    lda.z yd_1
    sta.z bitmap_line_xdyi.yd
    lda.z yd_1+1
    sta.z bitmap_line_xdyi.yd+1
    // [416] bitmap_line_xdyi::c#0 = bitmap_line::c#10 -- vbuz1=vbuz2 
    lda.z c
  ...
  __b7:
    // yd = y1-y0
    // [418] bitmap_line::yd#1 = bitmap_line::y1#10 - bitmap_line::y0#10 -- vwuz1=vwuz2_minus_vwuz3 
    lda.z y1
    sec
    sbc.z y0
    sta.z yd
    ...
    sta.z yd+1
    // if(yd<xd)
    // [419] if(bitmap_line::yd#1<bitmap_line::xd#2) goto bitmap_line::@9 -- vwuz1_lt_vwuz2_then_la1 
    cmp.z xd+1
    bcc __b9
    bne !+
    lda.z yd
  ...
  !:
    ...
    // [420] bitmap_line_ydxd::y#0 = bitmap_line::y0#10 -- vwuz1=vwuz2 
    lda.z y0
    sta.z bitmap_line_ydxd.y
    lda.z y0+1
    sta.z bitmap_line_ydxd.y+1
    // [421] bitmap_line_ydxd::x#0 = bitmap_line::x0#10 -- vwuz1=vwuz2 
    lda.z x0
    sta.z bitmap_line_ydxd.x
    lda.z x0+1
    sta.z bitmap_line_ydxd.x+1
    // [422] bitmap_line_ydxd::y1#0 = bitmap_line::y1#10 -- vwuz1=vwuz2 
    lda.z y1
    sta.z bitmap_line_ydxd.y1
    lda.z y1+1
    sta.z bitmap_line_ydxd.y1+1
    // [423] bitmap_line_ydxd::yd#0 = bitmap_line::yd#1
    // [424] bitmap_line_ydxd::xd#0 = bitmap_line::xd#2 -- vwuz1=vwuz2 
    lda.z xd
    sta.z bitmap_line_ydxd.xd
    lda.z xd+1
    sta.z bitmap_line_ydxd.xd+1
    // [425] bitmap_line_ydxd::c#0 = bitmap_line::c#10 -- vbuz1=vbuz2 
    lda.z c
  ...
  __b9:
    ...
    // [427] bitmap_line_xdyd::x#0 = bitmap_line::x1#10 -- vwuz1=vwuz2 
    lda.z x1
    sta.z bitmap_line_xdyd.x
    lda.z x1+1
    sta.z bitmap_line_xdyd.x+1
    // [428] bitmap_line_xdyd::y#0 = bitmap_line::y1#10 -- vwuz1=vwuz2 
    lda.z y1
    sta.z bitmap_line_xdyd.y
    lda.z y1+1
    sta.z bitmap_line_xdyd.y+1
    // [429] bitmap_line_xdyd::x1#0 = bitmap_line::x0#10 -- vwuz1=vwuz2 
    lda.z x0
    sta.z bitmap_line_xdyd.x1
    lda.z x0+1
    sta.z bitmap_line_xdyd.x1+1
    // [430] bitmap_line_xdyd::xd#0 = bitmap_line::xd#2 -- vwuz1=vwuz2 
    lda.z xd
    sta.z bitmap_line_xdyd.xd
    lda.z xd+1
    sta.z bitmap_line_xdyd.xd+1
    // [431] bitmap_line_xdyd::yd#0 = bitmap_line::yd#1 -- vwuz1=vwuz2 
    lda.z yd
    sta.z bitmap_line_xdyd.yd
    lda.z yd+1
    sta.z bitmap_line_xdyd.yd+1
    // [432] bitmap_line_xdyd::c#0 = bitmap_line::c#10 -- vbuz1=vbuz2 
    lda.z c
  ...
  __b1:
    // xd = x1-x0
    // [434] bitmap_line::xd#1 = bitmap_line::x1#10 - bitmap_line::x0#10 -- vwuz1=vwuz2_minus_vwuz3 
    lda.z x1
    sec
    sbc.z x0
    sta.z xd
    ...
    sta.z xd+1
    // if(y0<y1)
    // [435] if(bitmap_line::y0#10<bitmap_line::y1#10) goto bitmap_line::@11 -- vwuz1_lt_vwuz2_then_la1 
    lda.z y0+1
    cmp.z y1+1
    bcc __b11
    bne !+
  ...
  !:
    // bitmap_line::@5
    // yd = y0-y1
    // [436] bitmap_line::yd#10 = bitmap_line::y0#10 - bitmap_line::y1#10 -- vwuz1=vwuz2_minus_vwuz3 
    lda.z y0
    sec
    sbc.z y1
    sta.z yd
    ...
    sta.z yd+1
    // if(yd<xd)
    // [437] if(bitmap_line::yd#10<bitmap_line::xd#1) goto bitmap_line::@12 -- vwuz1_lt_vwuz2_then_la1 
    cmp.z xd+1
    bcc __b12
    bne !+
    lda.z yd
  ...
  !:
    ...
    // [438] bitmap_line_ydxd::y#1 = bitmap_line::y1#10 -- vwuz1=vwuz2 
    lda.z y1
    sta.z bitmap_line_ydxd.y
    lda.z y1+1
    sta.z bitmap_line_ydxd.y+1
    // [439] bitmap_line_ydxd::x#1 = bitmap_line::x1#10 -- vwuz1=vwuz2 
    lda.z x1
    sta.z bitmap_line_ydxd.x
    lda.z x1+1
    sta.z bitmap_line_ydxd.x+1
    // [440] bitmap_line_ydxd::y1#1 = bitmap_line::y0#10 -- vwuz1=vwuz2 
    lda.z y0
    sta.z bitmap_line_ydxd.y1
    lda.z y0+1
    sta.z bitmap_line_ydxd.y1+1
    // [441] bitmap_line_ydxd::yd#1 = bitmap_line::yd#10
    // [442] bitmap_line_ydxd::xd#1 = bitmap_line::xd#1 -- vwuz1=vwuz2 
    lda.z xd
    sta.z bitmap_line_ydxd.xd
    lda.z xd+1
    sta.z bitmap_line_ydxd.xd+1
    // [443] bitmap_line_ydxd::c#1 = bitmap_line::c#10 -- vbuz1=vbuz2 
    lda.z c
    sta.z bitmap_line_ydxd.c
  ...
  __b12:
    ...
    // [445] bitmap_line_xdyd::x#1 = bitmap_line::x0#10 -- vwuz1=vwuz2 
    lda.z x0
    sta.z bitmap_line_xdyd.x
    lda.z x0+1
    sta.z bitmap_line_xdyd.x+1
    // [446] bitmap_line_xdyd::y#1 = bitmap_line::y0#10 -- vwuz1=vwuz2 
    lda.z y0
    sta.z bitmap_line_xdyd.y
    lda.z y0+1
    sta.z bitmap_line_xdyd.y+1
    // [447] bitmap_line_xdyd::x1#1 = bitmap_line::x1#10 -- vwuz1=vwuz2 
    lda.z x1
    sta.z bitmap_line_xdyd.x1
    lda.z x1+1
    sta.z bitmap_line_xdyd.x1+1
    // [448] bitmap_line_xdyd::xd#1 = bitmap_line::xd#1 -- vwuz1=vwuz2 
    lda.z xd
    sta.z bitmap_line_xdyd.xd
    lda.z xd+1
    sta.z bitmap_line_xdyd.xd+1
    // [449] bitmap_line_xdyd::yd#1 = bitmap_line::yd#10 -- vwuz1=vwuz2 
    lda.z yd
    sta.z bitmap_line_xdyd.yd
    lda.z yd+1
    sta.z bitmap_line_xdyd.yd+1
    // [450] bitmap_line_xdyd::c#1 = bitmap_line::c#10 -- vbuz1=vbuz2 
    lda.z c
    sta.z bitmap_line_xdyd.c
  ...
  __b11:
    // yd = y1-y0
    // [452] bitmap_line::yd#11 = bitmap_line::y1#10 - bitmap_line::y0#10 -- vwuz1=vwuz2_minus_vwuz3 
    lda.z y1
    sec
    sbc.z y0
    sta.z yd_1
    ...
    sta.z yd_1+1
    // if(yd<xd)
    // [453] if(bitmap_line::yd#11<bitmap_line::xd#1) goto bitmap_line::@13 -- vwuz1_lt_vwuz2_then_la1 
    cmp.z xd+1
    bcc __b13
    bne !+
    lda.z yd_1
  ...
  !:
    ...
    // [454] bitmap_line_ydxi::y#1 = bitmap_line::y0#10 -- vwuz1=vwuz2 
    lda.z y0
    sta.z bitmap_line_ydxi.y
    lda.z y0+1
    sta.z bitmap_line_ydxi.y+1
    // [455] bitmap_line_ydxi::x#1 = bitmap_line::x0#10
    // [456] bitmap_line_ydxi::y1#1 = bitmap_line::y1#10 -- vwuz1=vwuz2 
    lda.z y1
  ...
  __b13:
    ...
    // [461] bitmap_line_xdyi::x#1 = bitmap_line::x0#10 -- vwuz1=vwuz2 
    lda.z x0
    sta.z bitmap_line_xdyi.x
    lda.z x0+1
    sta.z bitmap_line_xdyi.x+1
    // [462] bitmap_line_xdyi::y#1 = bitmap_line::y0#10 -- vwuz1=vwuz2 
    lda.z y0
    sta.z bitmap_line_xdyi.y
    lda.z y0+1
    sta.z bitmap_line_xdyi.y+1
    // [463] bitmap_line_xdyi::x1#1 = bitmap_line::x1#10
    // [464] bitmap_line_xdyi::xd#1 = bitmap_line::xd#1 -- vwuz1=vwuz2 
    lda.z xd
    sta.z bitmap_line_xdyi.xd
    lda.z xd+1
    sta.z bitmap_line_xdyi.xd+1
    // [465] bitmap_line_xdyi::yd#1 = bitmap_line::yd#11 -- vwuz1=vwuz2 
    lda.z yd_1
    sta.z bitmap_line_xdyi.yd
    lda.z yd_1+1
    sta.z bitmap_line_xdyi.yd+1
    // [466] bitmap_line_xdyi::c#1 = bitmap_line::c#10 -- vbuz1=vbuz2 
    lda.z c
    sta.z bitmap_line_xdyi.c
...
rand: {
    ...
    .label return = $74
    // rand_state << 7
    // [468] rand::$0 = rand_state << 7 -- vwuz1=vwuz2_rol_7 
    lda.z rand_state+1
    lsr
    lda.z rand_state
    ror
    ...
    // [469] rand_state = rand_state ^ rand::$0 -- vwuz1=vwuz1_bxor_vwuz2 
    lda.z rand_state
    eor.z __0
    sta.z rand_state
    lda.z rand_state+1
    ...
    sta.z rand_state+1
    // rand_state >> 9
    // [470] rand::$1 = rand_state >> 9 -- vwuz1=vwuz2_ror_9 
    lsr
    sta.z __1
    lda #0
    sta.z __1+1
    // rand_state ^= rand_state >> 9
    // [471] rand_state = rand_state ^ rand::$1 -- vwuz1=vwuz1_bxor_vwuz2 
    lda.z rand_state
    eor.z __1
    sta.z rand_state
    lda.z rand_state+1
    ...
    sta.z rand_state+1
    // rand_state << 8
    // [472] rand::$2 = rand_state << 8 -- vwuz1=vwuz2_rol_8 
    lda.z rand_state
    sta.z __2+1
    lda #0
    sta.z __2
    // rand_state ^= rand_state << 8
    // [473] rand_state = rand_state ^ rand::$2 -- vwuz1=vwuz1_bxor_vwuz2 
    lda.z rand_state
    eor.z __2
    sta.z rand_state
    lda.z rand_state+1
    ...
    sta.z rand_state+1
    // return rand_state;
    // [474] rand::return#0 = rand_state -- vwuz1=vwuz2 
    lda.z rand_state
    sta.z return
    lda.z rand_state+1
    sta.z return+1
...
modr16u: {
    ...
    // modr16u::@1
    // return rem16u;
    // [480] modr16u::return#0 = rem16u#0 -- vwuz1=vwuz2 
    lda.z rem16u
    sta.z return
    lda.z rem16u+1
    sta.z return+1
...
cscroll: {
    ...
    // [227] phi gotoxy::x#10 = 0 [phi:cscroll::@3->gotoxy#0] -- vbuz1=vbuc1 
    lda #0
    sta.z gotoxy.x
    // [227] phi gotoxy::y#8 = 0 [phi:cscroll::@3->gotoxy#1] -- vbuz1=vbuc1 
    sta.z gotoxy.y
    jsr gotoxy
    // cscroll::@return
  __breturn:
  ...
  __b4:
    ...
    // [490] gotoxy::y#2 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_HEIGHT) - 1 -- vbuz1=_deref_pbuc1_minus_1 
    ldx __conio+OFFSET_STRUCT_CX16_CONIO_HEIGHT
    dex
    stx.z gotoxy.y
    // [491] call gotoxy
    // [227] phi from cscroll::@5 to gotoxy [phi:cscroll::@5->gotoxy]
    // [227] phi gotoxy::x#10 = 0 [phi:cscroll::@5->gotoxy#0] -- vbuz1=vbuc1 
    lda #0
    sta.z gotoxy.x
...
bitmap_hscale: {
    ...
    // [495] phi bitmap_hscale::s#2 = 1 [phi:bitmap_hscale->bitmap_hscale::@1#0] -- vbuz1=vbuc1 
    lda #1
    sta.z s
    // bitmap_hscale::@1
  __b1:
    // for(char s=1;s<=3;s++)
    // [496] if(bitmap_hscale::s#2<3+1) goto bitmap_hscale::@2 -- vbuz1_lt_vbuc1_then_la1 
    lda.z s
    cmp #3+1
    bcc __b2
    // [498] phi from bitmap_hscale::@1 to bitmap_hscale::@4 [phi:bitmap_hscale::@1->bitmap_hscale::@4]
    // [498] phi bitmap_hscale::return#1 = bitmap_hscale::scale#0 [phi:bitmap_hscale::@1->bitmap_hscale::@4#0] -- vbuz1=vbuc1 
    lda #scale
    sta.z return
    rts
    // bitmap_hscale::@2
  __b2:
    ...
    // [497] if(*VERA_DC_HSCALE!=bitmap_hscale::hscale[bitmap_hscale::s#2]) goto bitmap_hscale::@3 -- _deref_pbuc1_neq_pbuc2_derefidx_vbuz1_then_la1 
    lda VERA_DC_HSCALE
    ldy.z s
    cmp hscale,y
    bne __b3
  ...
  __b3:
    // for(char s=1;s<=3;s++)
    // [500] bitmap_hscale::s#1 = ++ bitmap_hscale::s#2 -- vbuz1=_inc_vbuz1 
    inc.z s
...
bitmap_vscale: {
    ...
    // [502] phi bitmap_vscale::s#2 = 1 [phi:bitmap_vscale->bitmap_vscale::@1#0] -- vbuz1=vbuc1 
    lda #1
    sta.z s
    // bitmap_vscale::@1
  __b1:
    // for(char s=1;s<=3;s++)
    // [503] if(bitmap_vscale::s#2<3+1) goto bitmap_vscale::@2 -- vbuz1_lt_vbuc1_then_la1 
    lda.z s
    cmp #3+1
    bcc __b2
    // [505] phi from bitmap_vscale::@1 to bitmap_vscale::@4 [phi:bitmap_vscale::@1->bitmap_vscale::@4]
    // [505] phi bitmap_vscale::return#1 = bitmap_vscale::scale#0 [phi:bitmap_vscale::@1->bitmap_vscale::@4#0] -- vbuz1=vbuc1 
    lda #scale
    sta.z return
    rts
    // bitmap_vscale::@2
  __b2:
    ...
    // [504] if(*VERA_DC_VSCALE!=bitmap_vscale::vscale[bitmap_vscale::s#2]) goto bitmap_vscale::@3 -- _deref_pbuc1_neq_pbuc2_derefidx_vbuz1_then_la1 
    lda VERA_DC_VSCALE
    ldy.z s
    cmp vscale,y
    bne __b3
  ...
  __b3:
    // for(char s=1;s<=3;s++)
    // [507] bitmap_vscale::s#1 = ++ bitmap_vscale::s#2 -- vbuz1=_inc_vbuz1 
    inc.z s
...
mul16u: {
    ...
    .label res = $37
    // unsigned long mb = b
    // [508] mul16u::mb#0 = (unsigned long)mul16u::b#0 -- vduz1=_dword_vwuz2 
    lda.z b
    sta.z mb
    lda.z b+1
    sta.z mb+1
    ...
    // [509] phi mul16u::res#2 = 0 [phi:mul16u->mul16u::@1#1] -- vduz1=vduc1 
    sta.z res
    sta.z res+1
    lda #<0>>$10
    sta.z res+2
  ...
  __b1:
    // while(a!=0)
    // [510] if(mul16u::a#2!=0) goto mul16u::@2 -- vwuz1_neq_0_then_la1 
    lda.z a
    ora.z a+1
    bne __b2
    // mul16u::@return
  ...
  __b2:
    // a&1
    // [512] mul16u::$1 = mul16u::a#2 & 1 -- vbuz1=vwuz2_band_vbuc1 
    lda #1
    and.z a
    sta.z __1
    // if( (a&1) != 0)
    // [513] if(mul16u::$1==0) goto mul16u::@3 -- vbuz1_eq_0_then_la1 
    beq __b3
    // mul16u::@4
    // res = res + mb
    // [514] mul16u::res#1 = mul16u::res#2 + mul16u::mb#2 -- vduz1=vduz1_plus_vduz2 
    clc
    lda.z res
    adc.z mb
    sta.z res
  ...
  __b3:
    // a = a>>1
    // [516] mul16u::a#1 = mul16u::a#2 >> 1 -- vwuz1=vwuz1_ror_1 
    lsr.z a+1
    ror.z a
    // mb = mb<<1
    // [517] mul16u::mb#1 = mul16u::mb#2 << 1 -- vduz1=vduz1_rol_1 
    asl.z mb
    rol.z mb+1
    rol.z mb+2
    rol.z mb+3
...
memset_vram: {
    ...
    sta VERA_CTRL
    // BYTE0(offset)
    // [520] memset_vram::vera_vram_data0_bank_offset1_$0 = byte0  memset_vram::doffset_vram#0 -- vbuz1=_byte0_vwuz2 
    lda.z doffset_vram
    sta.z vera_vram_data0_bank_offset1___0
    // *VERA_ADDRX_L = BYTE0(offset)
    // [521] *VERA_ADDRX_L = memset_vram::vera_vram_data0_bank_offset1_$0 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_L
    // BYTE1(offset)
    // [522] memset_vram::vera_vram_data0_bank_offset1_$1 = byte1  memset_vram::doffset_vram#0 -- vbuz1=_byte1_vwuz2 
    lda.z doffset_vram+1
    sta.z vera_vram_data0_bank_offset1___1
    // *VERA_ADDRX_M = BYTE1(offset)
    // [523] *VERA_ADDRX_M = memset_vram::vera_vram_data0_bank_offset1_$1 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_M
    // bank | inc_dec
    // [524] memset_vram::vera_vram_data0_bank_offset1_$2 = memset_vram::dbank_vram#0 | vera_inc_1 -- vbuz1=vbuz1_bor_vbuc1 
    lda #vera_inc_1
    ora.z vera_vram_data0_bank_offset1___2
    sta.z vera_vram_data0_bank_offset1___2
    // *VERA_ADDRX_H = bank | inc_dec
    // [525] *VERA_ADDRX_H = memset_vram::vera_vram_data0_bank_offset1_$2 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_H
    ...
    // [526] phi memset_vram::i#2 = 0 [phi:memset_vram::vera_vram_data0_bank_offset1->memset_vram::@1#0] -- vwuz1=vwuc1 
    lda #<0
    sta.z i
    sta.z i+1
  // Transfer the data
  ...
  __b1:
    ...
    // [527] if(memset_vram::i#2<memset_vram::num#0) goto memset_vram::@2 -- vwuz1_lt_vwuz2_then_la1 
    lda.z i+1
    cmp.z num+1
    bcc __b2
    bne !+
  ...
  __b2:
    ...
    sta VERA_DATA0
    // for(word i = 0; i<num; i++)
    // [531] memset_vram::i#1 = ++ memset_vram::i#2 -- vwuz1=_inc_vwuz1 
    inc.z i
    bne !+
    inc.z i+1
  !:
...
getin: {
    ...
    .label return = $69
    // char ch
    // [532] getin::ch = 0 -- vbuz1=vbuc1 
    lda #0
    sta.z ch
    // getin::bank_get_bram1
    // return BRAM;
    // [533] getin::bank_get_bram1_return#0 = BRAM -- vbuz1=vbuz2 
    lda.z BRAM
    ...
    // BRAM = bank
    // [536] BRAM = getin::bank_get_bram1_return#0 -- vbuz1=vbuz2 
    lda.z bank_get_bram1_return
    sta.z BRAM
    // getin::@2
    // return ch;
    // [537] getin::return#0 = getin::ch -- vbuz1=vbuz2 
    lda.z ch
    sta.z return
    // getin::@return
    // }
...
bitmap_line_ydxi: {
    ...
    .label e = $26
    // unsigned int e = xd>>1
    // [541] bitmap_line_ydxi::e#0 = bitmap_line_ydxi::xd#2 >> 1 -- vwuz1=vwuz2_ror_1 
    lda.z xd+1
    lsr
    sta.z e+1
    lda.z xd
  ...
  __b1:
    // bitmap_plot(x,y,c)
    // [543] bitmap_plot::x#2 = bitmap_line_ydxi::x#3 -- vwuz1=vwuz2 
    lda.z x
    sta.z bitmap_plot.x
    lda.z x+1
    sta.z bitmap_plot.x+1
    // [544] bitmap_plot::y#2 = bitmap_line_ydxi::y#3 -- vwuz1=vwuz2 
    lda.z y
    sta.z bitmap_plot.y
    lda.z y+1
    sta.z bitmap_plot.y+1
    // [545] bitmap_plot::c#3 = bitmap_line_ydxi::c#3 -- vbuz1=vbuz2 
    lda.z c
    sta.z bitmap_plot.c
    ...
    // bitmap_line_ydxi::@4
    // y++;
    // [547] bitmap_line_ydxi::y#2 = ++ bitmap_line_ydxi::y#3 -- vwuz1=_inc_vwuz1 
    inc.z y
    bne !+
    inc.z y+1
  !:
    // e = e+xd
    // [548] bitmap_line_ydxi::e#1 = bitmap_line_ydxi::e#3 + bitmap_line_ydxi::xd#2 -- vwuz1=vwuz1_plus_vwuz2 
    clc
    lda.z e
    adc.z xd
    sta.z e
    ...
    sta.z e+1
    // if(yd<e)
    // [549] if(bitmap_line_ydxi::yd#5>=bitmap_line_ydxi::e#1) goto bitmap_line_ydxi::@2 -- vwuz1_ge_vwuz2_then_la1 
    cmp.z yd+1
    bne !+
    lda.z e
    cmp.z yd
  ...
  !:
    ...
    // bitmap_line_ydxi::@3
    // x++;
    // [550] bitmap_line_ydxi::x#2 = ++ bitmap_line_ydxi::x#3 -- vwuz1=_inc_vwuz1 
    inc.z x
    bne !+
    inc.z x+1
  !:
    // e = e - yd
    // [551] bitmap_line_ydxi::e#2 = bitmap_line_ydxi::e#1 - bitmap_line_ydxi::yd#5 -- vwuz1=vwuz1_minus_vwuz2 
    lda.z e
    sec
    sbc.z yd
    sta.z e
  ...
  __b2:
    // y1+1
    // [553] bitmap_line_ydxi::$6 = bitmap_line_ydxi::y1#6 + 1 -- vwuz1=vwuz2_plus_1 
    clc
    lda.z y1
    adc #1
    sta.z __6
    ...
    sta.z __6+1
    // while (y!=(y1+1))
    // [554] if(bitmap_line_ydxi::y#2!=bitmap_line_ydxi::$6) goto bitmap_line_ydxi::@1 -- vwuz1_neq_vwuz2_then_la1 
    lda.z y+1
    cmp.z __6+1
    bne __b1
    lda.z y
...
bitmap_line_xdyi: {
    ...
    .label e = $44
    // unsigned int e = yd>>1
    // [557] bitmap_line_xdyi::e#0 = bitmap_line_xdyi::yd#2 >> 1 -- vwuz1=vwuz2_ror_1 
    lda.z yd+1
    lsr
    sta.z e+1
    lda.z yd
  ...
  __b1:
    // bitmap_plot(x,y,c)
    // [559] bitmap_plot::x#0 = bitmap_line_xdyi::x#3 -- vwuz1=vwuz2 
    lda.z x
    sta.z bitmap_plot.x
    lda.z x+1
    sta.z bitmap_plot.x+1
    // [560] bitmap_plot::y#0 = bitmap_line_xdyi::y#3 -- vwuz1=vwuz2 
    lda.z y
    sta.z bitmap_plot.y
    lda.z y+1
    sta.z bitmap_plot.y+1
    // [561] bitmap_plot::c#1 = bitmap_line_xdyi::c#3 -- vbuz1=vbuz2 
    lda.z c
    sta.z bitmap_plot.c
    ...
    // bitmap_line_xdyi::@4
    // x++;
    // [563] bitmap_line_xdyi::x#2 = ++ bitmap_line_xdyi::x#3 -- vwuz1=_inc_vwuz1 
    inc.z x
    bne !+
    inc.z x+1
  !:
    // e = e+yd
    // [564] bitmap_line_xdyi::e#1 = bitmap_line_xdyi::e#3 + bitmap_line_xdyi::yd#2 -- vwuz1=vwuz1_plus_vwuz2 
    clc
    lda.z e
    adc.z yd
    sta.z e
    ...
    sta.z e+1
    // if(xd<e)
    // [565] if(bitmap_line_xdyi::xd#5>=bitmap_line_xdyi::e#1) goto bitmap_line_xdyi::@2 -- vwuz1_ge_vwuz2_then_la1 
    cmp.z xd+1
    bne !+
    lda.z e
    cmp.z xd
  ...
  !:
    ...
    // bitmap_line_xdyi::@3
    // y++;
    // [566] bitmap_line_xdyi::y#2 = ++ bitmap_line_xdyi::y#3 -- vwuz1=_inc_vwuz1 
    inc.z y
    bne !+
    inc.z y+1
  !:
    // e = e - xd
    // [567] bitmap_line_xdyi::e#2 = bitmap_line_xdyi::e#1 - bitmap_line_xdyi::xd#5 -- vwuz1=vwuz1_minus_vwuz2 
    lda.z e
    sec
    sbc.z xd
    sta.z e
  ...
  __b2:
    // x1+1
    // [569] bitmap_line_xdyi::$6 = bitmap_line_xdyi::x1#6 + 1 -- vwuz1=vwuz2_plus_1 
    clc
    lda.z x1
    adc #1
    sta.z __6
    ...
    sta.z __6+1
    // while (x!=(x1+1))
    // [570] if(bitmap_line_xdyi::x#2!=bitmap_line_xdyi::$6) goto bitmap_line_xdyi::@1 -- vwuz1_neq_vwuz2_then_la1 
    lda.z x+1
    cmp.z __6+1
    bne __b1
    lda.z x
...
bitmap_line_ydxd: {
    ...
    .label e = $48
    // unsigned int e = xd>>1
    // [573] bitmap_line_ydxd::e#0 = bitmap_line_ydxd::xd#2 >> 1 -- vwuz1=vwuz2_ror_1 
    lda.z xd+1
    lsr
    sta.z e+1
    lda.z xd
  ...
  __b1:
    // bitmap_plot(x,y,c)
    // [575] bitmap_plot::x#3 = bitmap_line_ydxd::x#3 -- vwuz1=vwuz2 
    lda.z x
    sta.z bitmap_plot.x
    lda.z x+1
    sta.z bitmap_plot.x+1
    // [576] bitmap_plot::y#3 = bitmap_line_ydxd::y#2 -- vwuz1=vwuz2 
    lda.z y
    sta.z bitmap_plot.y
    lda.z y+1
    sta.z bitmap_plot.y+1
    // [577] bitmap_plot::c#4 = bitmap_line_ydxd::c#3 -- vbuz1=vbuz2 
    lda.z c
    sta.z bitmap_plot.c
    ...
    // bitmap_line_ydxd::@4
    // y = y++;
    // [579] bitmap_line_ydxd::y#3 = ++ bitmap_line_ydxd::y#2 -- vwuz1=_inc_vwuz1 
    inc.z y
    bne !+
    inc.z y+1
  !:
    // e = e+xd
    // [580] bitmap_line_ydxd::e#1 = bitmap_line_ydxd::e#3 + bitmap_line_ydxd::xd#2 -- vwuz1=vwuz1_plus_vwuz2 
    clc
    lda.z e
    adc.z xd
    sta.z e
    ...
    sta.z e+1
    // if(yd<e)
    // [581] if(bitmap_line_ydxd::yd#5>=bitmap_line_ydxd::e#1) goto bitmap_line_ydxd::@2 -- vwuz1_ge_vwuz2_then_la1 
    cmp.z yd+1
    bne !+
    lda.z e
    cmp.z yd
  ...
  !:
    ...
    // bitmap_line_ydxd::@3
    // x--;
    // [582] bitmap_line_ydxd::x#2 = -- bitmap_line_ydxd::x#3 -- vwuz1=_dec_vwuz1 
    lda.z x
    bne !+
    dec.z x+1
  !:
    dec.z x
    // e = e - yd
    // [583] bitmap_line_ydxd::e#2 = bitmap_line_ydxd::e#1 - bitmap_line_ydxd::yd#5 -- vwuz1=vwuz1_minus_vwuz2 
    lda.z e
    sec
    sbc.z yd
    sta.z e
  ...
  __b2:
    // y1+1
    // [585] bitmap_line_ydxd::$6 = bitmap_line_ydxd::y1#6 + 1 -- vwuz1=vwuz2_plus_1 
    clc
    lda.z y1
    adc #1
    sta.z __6
    ...
    sta.z __6+1
    // while (y!=(y1+1))
    // [586] if(bitmap_line_ydxd::y#3!=bitmap_line_ydxd::$6) goto bitmap_line_ydxd::@1 -- vwuz1_neq_vwuz2_then_la1 
    lda.z y+1
    cmp.z __6+1
    bne __b1
    lda.z y
...
bitmap_line_xdyd: {
    ...
    .label e = $46
    // unsigned int e = yd>>1
    // [589] bitmap_line_xdyd::e#0 = bitmap_line_xdyd::yd#2 >> 1 -- vwuz1=vwuz2_ror_1 
    lda.z yd+1
    lsr
    sta.z e+1
    lda.z yd
  ...
  __b1:
    // bitmap_plot(x,y,c)
    // [591] bitmap_plot::x#1 = bitmap_line_xdyd::x#3 -- vwuz1=vwuz2 
    lda.z x
    sta.z bitmap_plot.x
    lda.z x+1
    sta.z bitmap_plot.x+1
    // [592] bitmap_plot::y#1 = bitmap_line_xdyd::y#3 -- vwuz1=vwuz2 
    lda.z y
    sta.z bitmap_plot.y
    lda.z y+1
    sta.z bitmap_plot.y+1
    // [593] bitmap_plot::c#2 = bitmap_line_xdyd::c#3 -- vbuz1=vbuz2 
    lda.z c
    sta.z bitmap_plot.c
    ...
    // bitmap_line_xdyd::@4
    // x++;
    // [595] bitmap_line_xdyd::x#2 = ++ bitmap_line_xdyd::x#3 -- vwuz1=_inc_vwuz1 
    inc.z x
    bne !+
    inc.z x+1
  !:
    // e = e+yd
    // [596] bitmap_line_xdyd::e#1 = bitmap_line_xdyd::e#3 + bitmap_line_xdyd::yd#2 -- vwuz1=vwuz1_plus_vwuz2 
    clc
    lda.z e
    adc.z yd
    sta.z e
    ...
    sta.z e+1
    // if(xd<e)
    // [597] if(bitmap_line_xdyd::xd#5>=bitmap_line_xdyd::e#1) goto bitmap_line_xdyd::@2 -- vwuz1_ge_vwuz2_then_la1 
    cmp.z xd+1
    bne !+
    lda.z e
    cmp.z xd
  ...
  !:
    ...
    // bitmap_line_xdyd::@3
    // y--;
    // [598] bitmap_line_xdyd::y#2 = -- bitmap_line_xdyd::y#3 -- vwuz1=_dec_vwuz1 
    lda.z y
    bne !+
    dec.z y+1
  !:
    dec.z y
    // e = e - xd
    // [599] bitmap_line_xdyd::e#2 = bitmap_line_xdyd::e#1 - bitmap_line_xdyd::xd#5 -- vwuz1=vwuz1_minus_vwuz2 
    lda.z e
    sec
    sbc.z xd
    sta.z e
  ...
  __b2:
    // x1+1
    // [601] bitmap_line_xdyd::$6 = bitmap_line_xdyd::x1#6 + 1 -- vwuz1=vwuz2_plus_1 
    clc
    lda.z x1
    adc #1
    sta.z __6
    ...
    sta.z __6+1
    // while (x!=(x1+1))
    // [602] if(bitmap_line_xdyd::x#2!=bitmap_line_xdyd::$6) goto bitmap_line_xdyd::@1 -- vwuz1_neq_vwuz2_then_la1 
    lda.z x+1
    cmp.z __6+1
    bne __b1
    lda.z x
...
divr16u: {
    ...
    // [605] phi divr16u::i#2 = 0 [phi:divr16u->divr16u::@1#0] -- vbuz1=vbuc1 
    lda #0
    sta.z i
    // [605] phi divr16u::quotient#3 = 0 [phi:divr16u->divr16u::@1#1] -- vwuz1=vwuc1 
    sta.z quotient
    sta.z quotient+1
    // [605] phi divr16u::dividend#2 = divr16u::dividend#1 [phi:divr16u->divr16u::@1#2] -- register_copy 
    // [605] phi divr16u::rem#4 = 0 [phi:divr16u->divr16u::@1#3] -- vwuz1=vbuc1 
    sta.z rem
    sta.z rem+1
  ...
  __b1:
    // rem = rem << 1
    // [606] divr16u::rem#0 = divr16u::rem#4 << 1 -- vwuz1=vwuz1_rol_1 
    asl.z rem
    rol.z rem+1
    // BYTE1(dividend)
    // [607] divr16u::$1 = byte1  divr16u::dividend#2 -- vbuz1=_byte1_vwuz2 
    lda.z dividend+1
    sta.z __1
    // BYTE1(dividend) & $80
    // [608] divr16u::$2 = divr16u::$1 & $80 -- vbuz1=vbuz1_band_vbuc1 
    lda #$80
    and.z __2
    sta.z __2
    // if( (BYTE1(dividend) & $80) != 0 )
    // [609] if(divr16u::$2==0) goto divr16u::@2 -- vbuz1_eq_0_then_la1 
    beq __b2
    // divr16u::@4
    // rem = rem | 1
    // [610] divr16u::rem#1 = divr16u::rem#0 | 1 -- vwuz1=vwuz1_bor_vbuc1 
    lda #1
    ora.z rem
    sta.z rem
  ...
  __b2:
    // dividend = dividend << 1
    // [612] divr16u::dividend#0 = divr16u::dividend#2 << 1 -- vwuz1=vwuz1_rol_1 
    asl.z dividend
    rol.z dividend+1
    // quotient = quotient << 1
    // [613] divr16u::quotient#1 = divr16u::quotient#3 << 1 -- vwuz1=vwuz1_rol_1 
    asl.z quotient
    rol.z quotient+1
    // if(rem>=divisor)
    // [614] if(divr16u::rem#5<divr16u::divisor#0) goto divr16u::@3 -- vwuz1_lt_vwuz2_then_la1 
    lda.z rem+1
    cmp.z divisor+1
    bcc __b3
    bne !+
  ...
  !:
    // divr16u::@5
    // quotient++;
    // [615] divr16u::quotient#2 = ++ divr16u::quotient#1 -- vwuz1=_inc_vwuz1 
    inc.z quotient
    bne !+
    inc.z quotient+1
  !:
    // rem = rem - divisor
    // [616] divr16u::rem#2 = divr16u::rem#5 - divr16u::divisor#0 -- vwuz1=vwuz1_minus_vwuz2 
    lda.z rem
    sec
    sbc.z divisor
    sta.z rem
  ...
  __b3:
    // for( char i : 0..15)
    // [618] divr16u::i#1 = ++ divr16u::i#2 -- vbuz1=_inc_vbuz1 
    inc.z i
    // [619] if(divr16u::i#1!=$10) goto divr16u::@1 -- vbuz1_neq_vbuc1_then_la1 
    lda #$10
    cmp.z i
    bne __b1
    // divr16u::@6
    // rem16u = rem
    // [620] rem16u#0 = divr16u::rem#10 -- vwuz1=vwuz2 
    lda.z rem
    sta.z rem16u
    lda.z rem+1
    sta.z rem16u+1
...
insertup: {
    ...
    // [622] insertup::cy#0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_Y) -- vbuz1=_deref_pbuc1 
    lda __conio+OFFSET_STRUCT_CX16_CONIO_CURSOR_Y
    sta.z cy
    // unsigned char width = __conio.width * 2
    // [623] insertup::width#0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_WIDTH) << 1 -- vbuz1=_deref_pbuc1_rol_1 
    lda __conio+OFFSET_STRUCT_CX16_CONIO_WIDTH
    asl
    sta.z width
    // [624] phi from insertup to insertup::@1 [phi:insertup->insertup::@1]
    // [624] phi insertup::i#2 = 1 [phi:insertup->insertup::@1#0] -- vbuz1=vbuc1 
    lda #1
    sta.z i
    // insertup::@1
  __b1:
    // for(unsigned char i=1; i<=cy; i++)
    // [625] if(insertup::i#2<=insertup::cy#0) goto insertup::@2 -- vbuz1_le_vbuz2_then_la1 
    lda.z cy
    cmp.z i
    bcs __b2
  ...
  __b2:
    // i-1
    // [629] insertup::$3 = insertup::i#2 - 1 -- vbuz1=vbuz2_minus_1 
    ldx.z i
    dex
    stx.z __3
    // unsigned int line = (i-1) << __conio.rowshift
    // [630] insertup::line#0 = insertup::$3 << *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_ROWSHIFT) -- vwuz1=vbuz2_rol__deref_pbuc1 
    txa
    ldy __conio+OFFSET_STRUCT_CX16_CONIO_ROWSHIFT
    sta.z line
    lda #0
  ...
  !e:
    ...
    // [631] insertup::start#0 = *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_OFFSET) + insertup::line#0 -- vwuz1=_deref_pwuc1_plus_vwuz1 
    clc
    lda.z start
    ...
    // [632] memcpy_vram_vram_inc::soffset_vram#0 = insertup::start#0 + *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_ROWSKIP) -- vwuz1=vwuz2_plus__deref_pwuc1 
    lda.z start
    clc
    adc __conio+OFFSET_STRUCT_CX16_CONIO_ROWSKIP
    ...
    // [634] memcpy_vram_vram_inc::num#0 = insertup::width#0 -- vwuz1=vbuz2 
    lda.z width
    ...
    // insertup::@4
    // for(unsigned char i=1; i<=cy; i++)
    // [636] insertup::i#1 = ++ insertup::i#2 -- vbuz1=_inc_vbuz1 
    inc.z i
...
clearline: {
    ...
    // [638] clearline::mapbase_offset#0 = *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_OFFSET) -- vwuz1=_deref_pwuc1 
    // Set address
    lda __conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_OFFSET
    sta.z mapbase_offset
    lda __conio+OFFSET_STRUCT_CX16_CONIO_MAPBASE_OFFSET+1
    ...
    // [639] clearline::conio_line#0 = *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_LINE) -- vwuz1=_deref_pwuc1 
    lda __conio+OFFSET_STRUCT_CX16_CONIO_LINE
    sta.z conio_line
    lda __conio+OFFSET_STRUCT_CX16_CONIO_LINE+1
    sta.z conio_line+1
    // mapbase_offset + conio_line
    // [640] clearline::addr#0 = clearline::mapbase_offset#0 + clearline::conio_line#0 -- vwuz1=vwuz1_plus_vwuz2 
    clc
    lda.z addr
    adc.z conio_line
    sta.z addr
    ...
    sta.z addr+1
    // BYTE0(addr)
    // [641] clearline::$1 = byte0  (char *)clearline::addr#0 -- vbuz1=_byte0_pbuz2 
    lda.z addr
    sta.z __1
    // *VERA_ADDRX_L = BYTE0(addr)
    // [642] *VERA_ADDRX_L = clearline::$1 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_L
    // BYTE1(addr)
    // [643] clearline::$2 = byte1  (char *)clearline::addr#0 -- vbuz1=_byte1_pbuz2 
    lda.z addr+1
    sta.z __2
    // *VERA_ADDRX_M = BYTE1(addr)
    // [644] *VERA_ADDRX_M = clearline::$2 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_M
    ...
    sta VERA_ADDRX_H
    // char color = __conio.color
    // [646] clearline::color#0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_COLOR) -- vbuz1=_deref_pbuc1 
    // TODO need to check this!
    lda __conio+OFFSET_STRUCT_CX16_CONIO_COLOR
    sta.z color
    // [647] phi from clearline to clearline::@1 [phi:clearline->clearline::@1]
    // [647] phi clearline::c#2 = 0 [phi:clearline->clearline::@1#0] -- vwuz1=vwuc1 
    lda #<0
    sta.z c
    sta.z c+1
    // clearline::@1
  __b1:
    ...
    // [648] if(clearline::c#2<*((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_WIDTH)) goto clearline::@2 -- vwuz1_lt__deref_pbuc1_then_la1 
    lda.z c+1
    bne !+
    lda.z c
    cmp __conio+OFFSET_STRUCT_CX16_CONIO_WIDTH
  ...
  __b2:
    ...
    sta VERA_DATA0
    // *VERA_DATA0 = color
    // [652] *VERA_DATA0 = clearline::color#0 -- _deref_pbuc1=vbuz1 
    lda.z color
    sta VERA_DATA0
    // for( unsigned int c=0;c<__conio.width; c++ )
    // [653] clearline::c#1 = ++ clearline::c#2 -- vwuz1=_inc_vwuz1 
    inc.z c
    bne !+
    inc.z c+1
  !:
...
bitmap_plot: {
    ...
    // [655] bitmap_plot::$9 = bitmap_plot::x#10 << 1 -- vwuz1=vwuz2_rol_1 
    lda.z x
    asl
    sta.z __9
    lda.z x+1
    rol
    sta.z __9+1
    // [656] bitmap_plot::$12 = (unsigned int *)&__bitmap + bitmap_plot::$9 -- pwuz1=pwuc1_plus_vwuz1 
    lda.z __12
    clc
    adc #<__bitmap
    sta.z __12
    ...
    adc #>__bitmap
    sta.z __12+1
    // [657] bitmap_plot::plot_x#0 = (unsigned long)*bitmap_plot::$12 -- vduz1=_dword__deref_pwuz2 
    ...
    // [658] bitmap_plot::$10 = bitmap_plot::y#4 << 2 -- vwuz1=vwuz1_rol_2 
    asl.z __10
    rol.z __10+1
    asl.z __10
    rol.z __10+1
    // [659] bitmap_plot::$13 = (unsigned long *)&__bitmap+$500 + bitmap_plot::$10 -- pduz1=pduc1_plus_vwuz1 
    lda.z __13
    clc
    adc #<__bitmap+$500
    sta.z __13
    ...
    adc #>__bitmap+$500
    sta.z __13+1
    // [660] bitmap_plot::plot_y#0 = *bitmap_plot::$13 -- vduz1=_deref_pduz2 
    ldy #0
    lda (__13),y
    sta.z plot_y
    iny
    ...
    // [661] bitmap_plot::vera_vram_data0_address1_bankaddr#0 = bitmap_plot::plot_x#0 + bitmap_plot::plot_y#0 -- vduz1=vduz1_plus_vduz2 
    clc
    ...
    // [662] bitmap_plot::$14 = (char *)&__bitmap+$f00 + bitmap_plot::x#10 -- pbuz1=pbuc1_plus_vwuz2 
    lda.z x
    clc
    adc #<__bitmap+$f00
    sta.z __14
    ...
    adc #>__bitmap+$f00
    sta.z __14+1
    // [663] bitmap_plot::bitshift#0 = *bitmap_plot::$14 -- vbuz1=_deref_pbuz2 
    ldy #0
    lda (__14),y
    sta.z bitshift
    // bitshift?c<<(bitshift):c
    // [664] if(0!=bitmap_plot::bitshift#0) goto bitmap_plot::@1 -- 0_neq_vbuz1_then_la1 
    bne __b1
    ...
    // bitmap_plot::@1
  __b1:
    // [665] bitmap_plot::$3 = bitmap_plot::c#5 << bitmap_plot::bitshift#0 -- vbuz1=vbuz1_rol_vbuz2 
    lda.z __3
    ldy.z bitshift
    cpy #0
    beq !e+
  ...
  __b2:
    ...
    // [667] bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_bank#0 = byte2  bitmap_plot::vera_vram_data0_address1_bankaddr#0 -- vbuz1=_byte2_vduz2 
    lda.z vera_vram_data0_address1_bankaddr+2
    sta.z vera_vram_data0_address1_vera_vram_data0_bank_offset1_bank
    // [668] bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_offset#0 = word0  bitmap_plot::vera_vram_data0_address1_bankaddr#0 -- vwuz1=_word0_vduz2 
    lda.z vera_vram_data0_address1_bankaddr
    ...
    sta VERA_CTRL
    // BYTE0(offset)
    // [670] bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_$0 = byte0  bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_offset#0 -- vbuz1=_byte0_vwuz2 
    ...
    // *VERA_ADDRX_L = BYTE0(offset)
    // [671] *VERA_ADDRX_L = bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_$0 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_L
    // BYTE1(offset)
    // [672] bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_$1 = byte1  bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_offset#0 -- vbuz1=_byte1_vwuz2 
    ...
    // *VERA_ADDRX_M = BYTE1(offset)
    // [673] *VERA_ADDRX_M = bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_$1 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_M
    // *VERA_ADDRX_H = bank | inc_dec
    // [674] *VERA_ADDRX_H = bitmap_plot::vera_vram_data0_address1_vera_vram_data0_bank_offset1_bank#0 -- _deref_pbuc1=vbuz1 
    lda.z vera_vram_data0_address1_vera_vram_data0_bank_offset1_bank
    sta VERA_ADDRX_H
    // bitmap_plot::@3
    // ~__bitmap.plot_bitmask[x]
    // [675] bitmap_plot::$15 = (char *)&__bitmap+$c80 + bitmap_plot::x#10 -- pbuz1=pbuc1_plus_vwuz1 
    lda.z __15
    clc
    adc #<__bitmap+$c80
    sta.z __15
    ...
    adc #>__bitmap+$c80
    sta.z __15+1
    // [676] bitmap_plot::$6 = ~ *bitmap_plot::$15 -- vbuz1=_bnot__deref_pbuz2 
    ldy #0
    lda (__15),y
    eor #$ff
    sta.z __6
    // *VERA_DATA0 & ~__bitmap.plot_bitmask[x]
    // [677] bitmap_plot::$7 = *VERA_DATA0 & bitmap_plot::$6 -- vbuz1=_deref_pbuc1_band_vbuz1 
    lda VERA_DATA0
    and.z __7
    sta.z __7
    // (*VERA_DATA0 & ~__bitmap.plot_bitmask[x]) | c
    // [678] bitmap_plot::$8 = bitmap_plot::$7 | bitmap_plot::c#0 -- vbuz1=vbuz2_bor_vbuz1 
    lda.z __8
    ora.z __7
    sta.z __8
    // *VERA_DATA0 = (*VERA_DATA0 & ~__bitmap.plot_bitmask[x]) | c
    // [679] *VERA_DATA0 = bitmap_plot::$8 -- _deref_pbuc1=vbuz1 
    sta VERA_DATA0
    // bitmap_plot::@return
    // }
    // [680] return 
...
memcpy_vram_vram_inc: {
    ...
    sta VERA_CTRL
    // BYTE0(offset)
    // [683] memcpy_vram_vram_inc::vera_vram_data0_bank_offset1_$0 = byte0  memcpy_vram_vram_inc::soffset_vram#0 -- vbuz1=_byte0_vwuz2 
    lda.z soffset_vram
    sta.z vera_vram_data0_bank_offset1___0
    // *VERA_ADDRX_L = BYTE0(offset)
    // [684] *VERA_ADDRX_L = memcpy_vram_vram_inc::vera_vram_data0_bank_offset1_$0 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_L
    // BYTE1(offset)
    // [685] memcpy_vram_vram_inc::vera_vram_data0_bank_offset1_$1 = byte1  memcpy_vram_vram_inc::soffset_vram#0 -- vbuz1=_byte1_vwuz2 
    lda.z soffset_vram+1
    sta.z vera_vram_data0_bank_offset1___1
    // *VERA_ADDRX_M = BYTE1(offset)
    // [686] *VERA_ADDRX_M = memcpy_vram_vram_inc::vera_vram_data0_bank_offset1_$1 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_M
    // *VERA_ADDRX_H = bank | inc_dec
    ...
    sta VERA_CTRL
    // BYTE0(offset)
    // [689] memcpy_vram_vram_inc::vera_vram_data1_bank_offset1_$0 = byte0  memcpy_vram_vram_inc::doffset_vram#0 -- vbuz1=_byte0_vwuz2 
    lda.z doffset_vram
    sta.z vera_vram_data1_bank_offset1___0
    // *VERA_ADDRX_L = BYTE0(offset)
    // [690] *VERA_ADDRX_L = memcpy_vram_vram_inc::vera_vram_data1_bank_offset1_$0 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_L
    // BYTE1(offset)
    // [691] memcpy_vram_vram_inc::vera_vram_data1_bank_offset1_$1 = byte1  memcpy_vram_vram_inc::doffset_vram#0 -- vbuz1=_byte1_vwuz2 
    lda.z doffset_vram+1
    sta.z vera_vram_data1_bank_offset1___1
    // *VERA_ADDRX_M = BYTE1(offset)
    // [692] *VERA_ADDRX_M = memcpy_vram_vram_inc::vera_vram_data1_bank_offset1_$1 -- _deref_pbuc1=vbuz1 
    sta VERA_ADDRX_M
    // *VERA_ADDRX_H = bank | inc_dec
    ...
    // [694] phi memcpy_vram_vram_inc::i#2 = 0 [phi:memcpy_vram_vram_inc::vera_vram_data1_bank_offset1->memcpy_vram_vram_inc::@1#0] -- vwuz1=vwuc1 
    lda #<0
    sta.z i
    sta.z i+1
  // Transfer the data
  ...
  __b1:
    ...
    // [695] if(memcpy_vram_vram_inc::i#2<memcpy_vram_vram_inc::num#0) goto memcpy_vram_vram_inc::@2 -- vwuz1_lt_vwuz2_then_la1 
    lda.z i+1
    cmp.z num+1
    bcc __b2
    bne !+
  ...
  __b2:
    ...
    sta VERA_DATA1
    // for(unsigned int i=0; i<num; i++)
    // [698] memcpy_vram_vram_inc::i#1 = ++ memcpy_vram_vram_inc::i#2 -- vwuz1=_inc_vwuz1 
    inc.z i
    bne !+
    inc.z i+1
  !:

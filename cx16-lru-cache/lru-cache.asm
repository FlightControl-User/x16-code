...
lru_cache_delete: {
    ...
    jsr lru_cache_hash
    // lru_cache_index_t index = lru_cache_hash(key)
    // [9] lru_cache_hash::return#4 = lru_cache_hash::return#0
    // lru_cache_delete::@14
    // [10] lru_cache_delete::index#0 = lru_cache_hash::return#4 -- vbuxx=vbuaa 
    tax
  ...
  __b1:
    ...
    // [12] lru_cache_delete::$16 = lru_cache_delete::index#2 << 1 -- vbum1=vbuxx_rol_1 
    txa
    asl
  ...
  !__b3:
    ...
    // [21] lru_cache_delete::next#0 = ((char *)&lru_cache+$280)[lru_cache_delete::index#2] -- vbum1=pbuc1_derefidx_vbuxx 
    lda lru_cache+$280,x
    sta next
    // lru_cache_index_t prev = lru_cache.prev[index]
    // [22] lru_cache_delete::prev#0 = ((char *)&lru_cache+$200)[lru_cache_delete::index#2] -- vbum1=pbuc1_derefidx_vbuxx 
    lda lru_cache+$200,x
    sta prev
    // lru_cache.next[index] = LRU_CACHE_INDEX_NULL
    // [23] ((char *)&lru_cache+$280)[lru_cache_delete::index#2] = $ff -- pbuc1_derefidx_vbuxx=vbuc2 
    lda #$ff
    sta lru_cache+$280,x
    // lru_cache.prev[index] = LRU_CACHE_INDEX_NULL
    // [24] ((char *)&lru_cache+$200)[lru_cache_delete::index#2] = $ff -- pbuc1_derefidx_vbuxx=vbuc2 
    sta lru_cache+$200,x
    // if (lru_cache.next[index] == index)
    // [25] if(((char *)&lru_cache+$280)[lru_cache_delete::index#2]==lru_cache_delete::index#2) goto lru_cache_delete::@4 -- pbuc1_derefidx_vbuxx_eq_vbuxx_then_la1 
    lda lru_cache+$280,x
    tay
    sty.z $ff
    cpx.z $ff
  ...
  !__b4:
    ...
    // [28] if(lru_cache_delete::index#2!=*((char *)&lru_cache+$381)) goto lru_cache_delete::@5 -- vbuxx_neq__deref_pbuc1_then_la1 
    cpx lru_cache+$381
    bne __b5
    // lru_cache_delete::@13
  ...
  __b5:
    ...
    // [30] if(lru_cache_delete::index#2!=*((char *)&lru_cache+$382)) goto lru_cache_delete::@7 -- vbuxx_neq__deref_pbuc1_then_la1 
    cpx lru_cache+$382
    bne __b7
    // lru_cache_delete::@6
    // lru_cache.last = prev
  ...
  __b7:
    ...
    // [32] lru_cache_delete::lru_cache_move_link1_index#0 = ((char *)&lru_cache+$300)[lru_cache_delete::index#2] -- vbum1=pbuc1_derefidx_vbuxx 
    lda lru_cache+$300,x
  ...
  !__b9:
    ...
    // [36] lru_cache_delete::lru_cache_move_link1_l#0 = ((char *)&lru_cache+$300)[lru_cache_delete::lru_cache_move_link1_index#0] -- vbuaa=pbuc1_derefidx_vbum1 
    ldy lru_cache_move_link1_index
    lda lru_cache+$300,y
    // lru_cache.link[link] = l
    // [37] ((char *)&lru_cache+$300)[lru_cache_delete::index#2] = lru_cache_delete::lru_cache_move_link1_l#0 -- pbuc1_derefidx_vbuxx=vbuaa 
    sta lru_cache+$300,x
    ...
    // [45] ((char *)&lru_cache+$280)[lru_cache_delete::index#2] = lru_cache_delete::lru_cache_move_link1_next#0 -- pbuc1_derefidx_vbuxx=vbum1 
    lda lru_cache_move_link1_next
    sta lru_cache+$280,x
    // lru_cache.prev[link] = prev
    // [46] ((char *)&lru_cache+$200)[lru_cache_delete::index#2] = lru_cache_delete::lru_cache_move_link1_prev#0 -- pbuc1_derefidx_vbuxx=vbum1 
    lda lru_cache_move_link1_prev
    sta lru_cache+$200,x
    // lru_cache.next[prev] = link
    // [47] ((char *)&lru_cache+$280)[lru_cache_delete::lru_cache_move_link1_prev#0] = lru_cache_delete::index#2 -- pbuc1_derefidx_vbum1=vbuxx 
    tay
    txa
    sta lru_cache+$280,y
    // lru_cache.prev[next] = link
    // [48] ((char *)&lru_cache+$200)[lru_cache_delete::lru_cache_move_link1_next#0] = lru_cache_delete::index#2 -- pbuc1_derefidx_vbum1=vbuxx 
    ...
    // lru_cache.last = link
    // [50] *((char *)&lru_cache+$382) = lru_cache_delete::index#2 -- _deref_pbuc1=vbuxx 
    stx lru_cache+$382
  ...
  lru_cache_move_link1___b1:
    ...
    // [52] *((char *)&lru_cache+$381) = lru_cache_delete::index#2 -- _deref_pbuc1=vbuxx 
    stx lru_cache+$381
  ...
  __b3:
    // index_prev = index
    // [61] lru_cache_delete::index_prev#1 = lru_cache_delete::index#2 -- vbum1=vbuxx 
    stx index_prev
    // index = lru_cache.link[index]
    // [62] lru_cache_delete::index#1 = ((char *)&lru_cache+$300)[lru_cache_delete::index#2] -- vbuxx=pbuc1_derefidx_vbuxx 
    lda lru_cache+$300,x
    tax
...
lru_cache_insert: {
    ...
    jsr lru_cache_hash
    // lru_cache_index_t index = lru_cache_hash(key)
    // [67] lru_cache_hash::return#3 = lru_cache_hash::return#0
    // lru_cache_insert::@10
    // [68] lru_cache_insert::index#0 = lru_cache_hash::return#3 -- vbum1=vbuaa 
    sta index
    // lru_cache_index_t link_head = lru_cache_find_head(index)
    // [69] lru_cache_find_head::index#0 = lru_cache_insert::index#0 -- vbuxx=vbum1 
    tax
    ...
    // [71] lru_cache_find_head::return#0 = lru_cache_find_head::return#3
    // lru_cache_insert::@11
    // [72] lru_cache_insert::link_head#0 = lru_cache_find_head::return#0 -- vbum1=vbuaa 
    sta link_head
    // lru_cache_index_t link_prev = lru_cache_find_duplicate(link_head, index)
    // [73] lru_cache_find_duplicate::index#0 = lru_cache_insert::link_head#0 -- vbuxx=vbum1 
    tax
    ...
    // lru_cache_index_t link_prev = lru_cache_find_duplicate(link_head, index)
    // [76] lru_cache_find_duplicate::return#0 = lru_cache_find_duplicate::index#3
    // lru_cache_insert::@12
    // [77] lru_cache_insert::link_prev#0 = lru_cache_find_duplicate::return#0 -- vbum1=vbuxx 
    stx link_prev
    // lru_cache.key[index] != LRU_CACHE_NOTHING
  ...
  __b1:
    ...
    // [81] lru_cache_find_duplicate::index#1 = lru_cache_insert::index#0 -- vbuxx=vbum1 
    ldx index
  ...
  // We just follow the duplicate chain and find the last duplicate.
    ...
    jsr lru_cache_find_duplicate
    // lru_cache_index_t index_prev = lru_cache_find_duplicate(index, LRU_CACHE_INDEX_NULL)
    // [83] lru_cache_find_duplicate::return#1 = lru_cache_find_duplicate::index#3
    // lru_cache_insert::@13
    // [84] lru_cache_insert::index_prev#0 = lru_cache_find_duplicate::return#1 -- vbum1=vbuxx 
    stx index_prev
    // lru_cache_find_empty(index_prev)
    // [85] lru_cache_find_empty::index#0 = lru_cache_insert::index_prev#0 -- vbuxx=vbum1 
    ...
    // lru_cache_find_empty(index_prev)
    // [87] lru_cache_find_empty::return#0 = lru_cache_find_empty::index#4
    // lru_cache_insert::@14
    // index = lru_cache_find_empty(index_prev)
    // [88] lru_cache_insert::index#1 = lru_cache_find_empty::return#0
    // lru_cache.link[index] = LRU_CACHE_INDEX_NULL
    // [89] ((char *)&lru_cache+$300)[lru_cache_insert::index#1] = $ff -- pbuc1_derefidx_vbuxx=vbuc2 
    ...
    sta lru_cache+$300,x
    // if (index_prev != index)
    // [90] if(lru_cache_insert::index_prev#0==lru_cache_insert::index#1) goto lru_cache_insert::@2 -- vbum1_eq_vbuxx_then_la1 
    cpx index_prev
    beq __b2
    // lru_cache_insert::@6
    // lru_cache.link[index_prev] = index
    // [91] ((char *)&lru_cache+$300)[lru_cache_insert::index_prev#0] = lru_cache_insert::index#1 -- pbuc1_derefidx_vbum1=vbuxx 
    ldy index_prev
    txa
    sta lru_cache+$300,y
    // lru_cache_insert::@2
  __b2:
    ...
    // [92] lru_cache_insert::$20 = lru_cache_insert::index#1 << 1 -- vbuyy=vbuxx_rol_1 
    txa
    asl
    tay
    // [93] ((unsigned int *)&lru_cache)[lru_cache_insert::$20] = lru_cache_insert::key#0 -- pwuc1_derefidx_vbuyy=vwum1 
    ...
    // [94] ((unsigned int *)&lru_cache+$100)[lru_cache_insert::$20] = lru_cache_insert::data#0 -- pwuc1_derefidx_vbuyy=vwum1 
    lda data
    sta lru_cache+$100,y
    lda data+1
    sta lru_cache+$100+1,y
    ...
    // [96] *((char *)&lru_cache+$381) = lru_cache_insert::index#1 -- _deref_pbuc1=vbuxx 
    stx lru_cache+$381
    // lru_cache_insert::@3
  __b3:
    ...
    // [98] *((char *)&lru_cache+$382) = lru_cache_insert::index#1 -- _deref_pbuc1=vbuxx 
    stx lru_cache+$382
    // lru_cache_insert::@4
  __b4:
    // lru_cache.next[index] = lru_cache.first
    // [99] ((char *)&lru_cache+$280)[lru_cache_insert::index#1] = *((char *)&lru_cache+$381) -- pbuc1_derefidx_vbuxx=_deref_pbuc2 
    // Now insert the node as the first node in the list.
    lda lru_cache+$381
    sta lru_cache+$280,x
    // lru_cache.prev[lru_cache.first] = index
    // [100] ((char *)&lru_cache+$200)[*((char *)&lru_cache+$381)] = lru_cache_insert::index#1 -- pbuc1_derefidx_(_deref_pbuc2)=vbuxx 
    tay
    txa
    sta lru_cache+$200,y
    // lru_cache.next[lru_cache.last] = index
    // [101] ((char *)&lru_cache+$280)[*((char *)&lru_cache+$382)] = lru_cache_insert::index#1 -- pbuc1_derefidx_(_deref_pbuc2)=vbuxx 
    ldy lru_cache+$382
    txa
    sta lru_cache+$280,y
    // lru_cache.prev[index] = lru_cache.last
    // [102] ((char *)&lru_cache+$200)[lru_cache_insert::index#1] = *((char *)&lru_cache+$382) -- pbuc1_derefidx_vbuxx=_deref_pbuc2 
    tya
    sta lru_cache+$200,x
    // lru_cache.first = index
    // [103] *((char *)&lru_cache+$381) = lru_cache_insert::index#1 -- _deref_pbuc1=vbuxx 
    stx lru_cache+$381
    // lru_cache.count++;
    ...
    // }
    // [105] stackidx(char,lru_cache_insert::OFFSET_STACK_RETURN_3) = lru_cache_insert::index#1 -- _stackidxbyte_vbuc1=vbuxx 
    txa
    tsx
  ...
  __b5:
    ...
    // [107] lru_cache_find_empty::index#1 = lru_cache_insert::index#0 -- vbuxx=vbum1 
    ldx index
  ...
  // The link of the head_link must be changed once the new place of the link node has been found.
    ...
    jsr lru_cache_find_empty
    // lru_cache_index_t link = lru_cache_find_empty(index)
    // [109] lru_cache_find_empty::return#1 = lru_cache_find_empty::index#4
    // lru_cache_insert::@15
    // [110] lru_cache_insert::lru_cache_move_link1_link#0 = lru_cache_find_empty::return#1
    // lru_cache_insert::lru_cache_move_link1
    // lru_cache_index_t l = lru_cache.link[index]
    // [111] lru_cache_insert::lru_cache_move_link1_l#0 = ((char *)&lru_cache+$300)[lru_cache_insert::index#0] -- vbuaa=pbuc1_derefidx_vbum1 
    ldy index
    lda lru_cache+$300,y
    // lru_cache.link[link] = l
    // [112] ((char *)&lru_cache+$300)[lru_cache_insert::lru_cache_move_link1_link#0] = lru_cache_insert::lru_cache_move_link1_l#0 -- pbuc1_derefidx_vbuxx=vbuaa 
    sta lru_cache+$300,x
    // lru_cache_key_t key = lru_cache.key[index]
    ...
    sta lru_cache_move_link1_key+1
    // lru_cache.key[link] = key
    // [114] lru_cache_insert::lru_cache_move_link1_$7 = lru_cache_insert::lru_cache_move_link1_link#0 << 1 -- vbum1=vbuxx_rol_1 
    txa
    asl
    ...
    sta lru_cache_move_link1_prev
    // lru_cache.next[link] = next
    // [120] ((char *)&lru_cache+$280)[lru_cache_insert::lru_cache_move_link1_link#0] = lru_cache_insert::lru_cache_move_link1_next#0 -- pbuc1_derefidx_vbuxx=vbum1 
    lda lru_cache_move_link1_next
    sta lru_cache+$280,x
    // lru_cache.prev[link] = prev
    // [121] ((char *)&lru_cache+$200)[lru_cache_insert::lru_cache_move_link1_link#0] = lru_cache_insert::lru_cache_move_link1_prev#0 -- pbuc1_derefidx_vbuxx=vbum1 
    lda lru_cache_move_link1_prev
    sta lru_cache+$200,x
    // lru_cache.next[prev] = link
    // [122] ((char *)&lru_cache+$280)[lru_cache_insert::lru_cache_move_link1_prev#0] = lru_cache_insert::lru_cache_move_link1_link#0 -- pbuc1_derefidx_vbum1=vbuxx 
    tay
    txa
    sta lru_cache+$280,y
    // lru_cache.prev[next] = link
    // [123] ((char *)&lru_cache+$200)[lru_cache_insert::lru_cache_move_link1_next#0] = lru_cache_insert::lru_cache_move_link1_link#0 -- pbuc1_derefidx_vbum1=vbuxx 
    ldy lru_cache_move_link1_next
    txa
    sta lru_cache+$200,y
    // if (lru_cache.last == index)
    ...
    // lru_cache.last = link
    // [125] *((char *)&lru_cache+$382) = lru_cache_insert::lru_cache_move_link1_link#0 -- _deref_pbuc1=vbuxx 
    stx lru_cache+$382
  ...
  lru_cache_move_link1___b1:
    ...
    // lru_cache.first = link
    // [127] *((char *)&lru_cache+$381) = lru_cache_insert::lru_cache_move_link1_link#0 -- _deref_pbuc1=vbuxx 
    stx lru_cache+$381
  ...
  lru_cache_move_link1___b2:
    ...
    // [133] ((char *)&lru_cache+$300)[lru_cache_insert::link_prev#0] = lru_cache_insert::lru_cache_move_link1_link#0 -- pbuc1_derefidx_vbum1=vbuxx 
    ldy link_prev
    txa
    sta lru_cache+$300,y
    jmp __b1
...
lru_cache_data: {
    ...
    .const OFFSET_STACK_RETURN_0 = 0
    // [134] lru_cache_data::index#0 = stackidx(char,lru_cache_data::OFFSET_STACK_INDEX) -- vbuaa=_stackidxbyte_vbuc1 
    tsx
    lda STACK_BASE+OFFSET_STACK_INDEX,x
    // return lru_cache.data[index];
    // [135] lru_cache_data::$0 = lru_cache_data::index#0 << 1 -- vbuaa=vbuaa_rol_1 
    asl
    // [136] lru_cache_data::return#0 = ((unsigned int *)&lru_cache+$100)[lru_cache_data::$0] -- vwum1=pwuc1_derefidx_vbuaa 
    tay
    lda lru_cache+$100,y
    sta return
    lda lru_cache+$100+1,y
...
lru_cache_set: {
    ...
    // [139] lru_cache_set::index#0 = stackidx(char,lru_cache_set::OFFSET_STACK_INDEX) -- vbuyy=_stackidxbyte_vbuc1 
    tsx
    lda STACK_BASE+OFFSET_STACK_INDEX,x
    tay
    ...
    // [141] if(lru_cache_set::index#0==$ff) goto lru_cache_set::@return -- vbuyy_eq_vbuc1_then_la1 
    cpy #$ff
    beq __b1
    // lru_cache_set::@1
    // lru_cache.data[index] = data
    // [142] lru_cache_set::$3 = lru_cache_set::index#0 << 1 -- vbuxx=vbuyy_rol_1 
    tya
    asl
    tax
    // [143] ((unsigned int *)&lru_cache+$100)[lru_cache_set::$3] = lru_cache_set::data#0 -- pwuc1_derefidx_vbuxx=vwum1 
    lda data
    sta lru_cache+$100,x
    lda data+1
    sta lru_cache+$100+1,x
    // lru_cache_get(index)
    // [144] stackpush(char) = lru_cache_set::index#0 -- _stackpushbyte_=vbuyy 
    tya
    pha
...
lru_cache_get: {
    .const OFFSET_STACK_INDEX = 0
    .const OFFSET_STACK_RETURN_0 = 0
    // [151] lru_cache_get::index#0 = stackidx(char,lru_cache_get::OFFSET_STACK_INDEX) -- vbuxx=_stackidxbyte_vbuc1 
    tsx
    lda STACK_BASE+OFFSET_STACK_INDEX,x
    tax
    // if (index != LRU_CACHE_INDEX_NULL)
    // [152] if(lru_cache_get::index#0==$ff) goto lru_cache_get::@return -- vbuxx_eq_vbuc1_then_la1 
    cpx #$ff
    beq __b1
    // lru_cache_get::@1
    // lru_cache_data_t data = lru_cache.data[index]
    // [153] lru_cache_get::$6 = lru_cache_get::index#0 << 1 -- vbuaa=vbuxx_rol_1 
    txa
    asl
    // [154] lru_cache_get::data#0 = ((unsigned int *)&lru_cache+$100)[lru_cache_get::$6] -- vwum1=pwuc1_derefidx_vbuaa 
    tay
    lda lru_cache+$100,y
    sta data
    lda lru_cache+$100+1,y
    sta data+1
    // lru_cache_index_t next = lru_cache.next[index]
    // [155] lru_cache_get::next#0 = ((char *)&lru_cache+$280)[lru_cache_get::index#0] -- vbum1=pbuc1_derefidx_vbuxx 
    lda lru_cache+$280,x
    sta next
    // lru_cache_index_t prev = lru_cache.prev[index]
    // [156] lru_cache_get::prev#0 = ((char *)&lru_cache+$200)[lru_cache_get::index#0] -- vbum1=pbuc1_derefidx_vbuxx 
    lda lru_cache+$200,x
    sta prev
    // lru_cache.next[prev] = next
    ...
    sta lru_cache+$200,y
    // if (index == lru_cache.first)
    // [159] if(lru_cache_get::index#0!=*((char *)&lru_cache+$381)) goto lru_cache_get::@3 -- vbuxx_neq__deref_pbuc1_then_la1 
    cpx lru_cache+$381
    bne __b3
    // lru_cache_get::@2
    // lru_cache.first = next
  ...
  __b3:
    // if (index == lru_cache.last)
    // [161] if(lru_cache_get::index#0!=*((char *)&lru_cache+$382)) goto lru_cache_get::@4 -- vbuxx_neq__deref_pbuc1_then_la1 
    cpx lru_cache+$382
    bne __b4
    // lru_cache_get::@5
    // lru_cache.last = prev
  ...
  __b4:
    // lru_cache.next[index] = lru_cache.first
    // [163] ((char *)&lru_cache+$280)[lru_cache_get::index#0] = *((char *)&lru_cache+$381) -- pbuc1_derefidx_vbuxx=_deref_pbuc2 
    // Now insert the node as the first node in the list.
    lda lru_cache+$381
    sta lru_cache+$280,x
    // lru_cache.prev[lru_cache.first] = index
    // [164] ((char *)&lru_cache+$200)[*((char *)&lru_cache+$381)] = lru_cache_get::index#0 -- pbuc1_derefidx_(_deref_pbuc2)=vbuxx 
    tay
    txa
    sta lru_cache+$200,y
    // lru_cache.next[lru_cache.last] = index
    // [165] ((char *)&lru_cache+$280)[*((char *)&lru_cache+$382)] = lru_cache_get::index#0 -- pbuc1_derefidx_(_deref_pbuc2)=vbuxx 
    ldy lru_cache+$382
    txa
    sta lru_cache+$280,y
    // lru_cache.prev[index] = lru_cache.last
    // [166] ((char *)&lru_cache+$200)[lru_cache_get::index#0] = *((char *)&lru_cache+$382) -- pbuc1_derefidx_vbuxx=_deref_pbuc2 
    tya
    sta lru_cache+$200,x
    // lru_cache.first = index
    // [167] *((char *)&lru_cache+$381) = lru_cache_get::index#0 -- _deref_pbuc1=vbuxx 
    ...
    // [168] *((char *)&lru_cache+$382) = ((char *)&lru_cache+$200)[lru_cache_get::index#0] -- _deref_pbuc1=pbuc2_derefidx_vbuxx 
    lda lru_cache+$200,x
    sta lru_cache+$382
...
lru_cache_index: {
    ...
    jsr lru_cache_hash
    // lru_cache_index_t index = lru_cache_hash(key)
    // [175] lru_cache_hash::return#2 = lru_cache_hash::return#0
    // lru_cache_index::@4
    // [176] lru_cache_index::index#0 = lru_cache_hash::return#2 -- vbuxx=vbuaa 
    tax
  ...
  // Search till index == 0xFF, following the links.
    ...
    // [178] if(lru_cache_index::index#2!=$ff) goto lru_cache_index::@2 -- vbuxx_neq_vbuc1_then_la1 
    cpx #$ff
    bne __b2
    // [181] phi from lru_cache_index::@1 to lru_cache_index::@return [phi:lru_cache_index::@1->lru_cache_index::@return]
    // [181] phi lru_cache_index::return#2 = $ff [phi:lru_cache_index::@1->lru_cache_index::@return#0] -- vbuxx=vbuc1 
    ldx #$ff
    jmp __breturn
    // lru_cache_index::@2
  __b2:
    // lru_cache.key[index] == key
    // [179] lru_cache_index::$4 = lru_cache_index::index#2 << 1 -- vbuaa=vbuxx_rol_1 
    txa
    asl
    // if (lru_cache.key[index] == key)
    // [180] if(((unsigned int *)&lru_cache)[lru_cache_index::$4]!=lru_cache_index::key#0) goto lru_cache_index::@3 -- pwuc1_derefidx_vbuaa_neq_vwum1_then_la1 
    tay
    lda key+1
    cmp lru_cache+1,y
    bne __b3
  ...
  __breturn:
    // }
    // [182] stackidx(char,lru_cache_index::OFFSET_STACK_RETURN_1) = lru_cache_index::return#2 -- _stackidxbyte_vbuc1=vbuxx 
    txa
    tsx
    sta STACK_BASE+OFFSET_STACK_RETURN_1,x
    // [183] return 
  ...
  __b3:
    // index = lru_cache.link[index]
    // [184] lru_cache_index::index#1 = ((char *)&lru_cache+$300)[lru_cache_index::index#2] -- vbuxx=pbuc1_derefidx_vbuxx 
    lda lru_cache+$300,x
    tax
    jmp __b1
  .segment Data
...
lru_cache_is_max: {
    ...
    // [185] lru_cache_is_max::return#0 = *((char *)&lru_cache+$380) >= $7c -- vboaa=_deref_pbuc1_ge_vbuc2 
    lda lru_cache+$380
    cmp #$7c
    bcs !+
    lda #0
  ...
  !e:
    ...
    // }
    // [186] stackidx(bool,lru_cache_is_max::OFFSET_STACK_RETURN_0) = lru_cache_is_max::return#0 -- _stackidxbool_vbuc1=vboaa 
    tsx
    sta STACK_BASE+OFFSET_STACK_RETURN_0,x
    // [187] return 
    rts
...
lru_cache_find_last: {
    ...
    // [188] lru_cache_find_last::$0 = *((char *)&lru_cache+$382) << 1 -- vbuaa=_deref_pbuc1_rol_1 
    lda lru_cache+$382
    asl
    // [189] lru_cache_find_last::return#0 = ((unsigned int *)&lru_cache)[lru_cache_find_last::$0] -- vwum1=pwuc1_derefidx_vbuaa 
    tay
    lda lru_cache,y
    sta return
    lda lru_cache+1,y
...
lru_cache_init: {
    ...
    // [194] phi lru_cache_init::memset_fast1_num#2 = SIZEOF_UNSIGNED_INT*$80 [phi:lru_cache_init::memset_fast1->lru_cache_init::memset_fast1_@1#0] -- vbuxx=vbuc1 
  ...
  memset_fast1___b1:
    // *(destination+num) = c
    // [195] lru_cache_init::memset_fast1_destination#0[lru_cache_init::memset_fast1_num#2] = lru_cache_init::memset_fast1_c#0 -- pbuc1_derefidx_vbuxx=vbuc2 
    lda #memset_fast1_c
    sta memset_fast1_destination,x
    // num--;
    // [196] lru_cache_init::memset_fast1_num#1 = -- lru_cache_init::memset_fast1_num#2 -- vbuxx=_dec_vbuxx 
    dex
    // while(num)
    // [197] if(0!=lru_cache_init::memset_fast1_num#1) goto lru_cache_init::memset_fast1_@1 -- 0_neq_vbuxx_then_la1 
    cpx #0
    ...
    // [199] phi lru_cache_init::memset_fast2_num#2 = SIZEOF_UNSIGNED_INT*$80 [phi:lru_cache_init::memset_fast2->lru_cache_init::memset_fast2_@1#0] -- vbuxx=vbuc1 
    ldx #SIZEOF_UNSIGNED_INT*$80
  ...
  memset_fast2___b1:
    // *(destination+num) = c
    // [200] lru_cache_init::memset_fast2_destination#0[lru_cache_init::memset_fast2_num#2] = lru_cache_init::memset_fast2_c#0 -- pbuc1_derefidx_vbuxx=vbuc2 
    lda #memset_fast2_c
    sta memset_fast2_destination,x
    // num--;
    // [201] lru_cache_init::memset_fast2_num#1 = -- lru_cache_init::memset_fast2_num#2 -- vbuxx=_dec_vbuxx 
    dex
    // while(num)
    // [202] if(0!=lru_cache_init::memset_fast2_num#1) goto lru_cache_init::memset_fast2_@1 -- 0_neq_vbuxx_then_la1 
    cpx #0
    ...
    // [204] phi lru_cache_init::memset_fast3_num#2 = SIZEOF_CHAR*$80 [phi:lru_cache_init::memset_fast3->lru_cache_init::memset_fast3_@1#0] -- vbuxx=vbuc1 
    ldx #SIZEOF_CHAR*$80
  ...
  memset_fast3___b1:
    // *(destination+num) = c
    // [205] lru_cache_init::memset_fast3_destination#0[lru_cache_init::memset_fast3_num#2] = lru_cache_init::memset_fast3_c#0 -- pbuc1_derefidx_vbuxx=vbuc2 
    lda #memset_fast3_c
    sta memset_fast3_destination,x
    // num--;
    // [206] lru_cache_init::memset_fast3_num#1 = -- lru_cache_init::memset_fast3_num#2 -- vbuxx=_dec_vbuxx 
    dex
    // while(num)
    // [207] if(0!=lru_cache_init::memset_fast3_num#1) goto lru_cache_init::memset_fast3_@1 -- 0_neq_vbuxx_then_la1 
    cpx #0
    ...
    // [209] phi lru_cache_init::memset_fast4_num#2 = SIZEOF_CHAR*$80 [phi:lru_cache_init::memset_fast4->lru_cache_init::memset_fast4_@1#0] -- vbuxx=vbuc1 
    ldx #SIZEOF_CHAR*$80
  ...
  memset_fast4___b1:
    // *(destination+num) = c
    // [210] lru_cache_init::memset_fast4_destination#0[lru_cache_init::memset_fast4_num#2] = lru_cache_init::memset_fast4_c#0 -- pbuc1_derefidx_vbuxx=vbuc2 
    lda #memset_fast4_c
    sta memset_fast4_destination,x
    // num--;
    // [211] lru_cache_init::memset_fast4_num#1 = -- lru_cache_init::memset_fast4_num#2 -- vbuxx=_dec_vbuxx 
    dex
    // while(num)
    // [212] if(0!=lru_cache_init::memset_fast4_num#1) goto lru_cache_init::memset_fast4_@1 -- 0_neq_vbuxx_then_la1 
    cpx #0
    ...
    // [214] phi lru_cache_init::memset_fast5_num#2 = SIZEOF_CHAR*$80 [phi:lru_cache_init::memset_fast5->lru_cache_init::memset_fast5_@1#0] -- vbuxx=vbuc1 
    ldx #SIZEOF_CHAR*$80
  ...
  memset_fast5___b1:
    // *(destination+num) = c
    // [215] lru_cache_init::memset_fast5_destination#0[lru_cache_init::memset_fast5_num#2] = lru_cache_init::memset_fast5_c#0 -- pbuc1_derefidx_vbuxx=vbuc2 
    lda #memset_fast5_c
    sta memset_fast5_destination,x
    // num--;
    // [216] lru_cache_init::memset_fast5_num#1 = -- lru_cache_init::memset_fast5_num#2 -- vbuxx=_dec_vbuxx 
    dex
    // while(num)
    // [217] if(0!=lru_cache_init::memset_fast5_num#1) goto lru_cache_init::memset_fast5_@1 -- 0_neq_vbuxx_then_la1 
    cpx #0
...
lru_cache_hash: {
    ...
    // [227] lru_cache_hash::return#0 = (char)lru_cache_hash::$0 -- vbuaa=_byte_vwum1 
...
lru_cache_find_head: {
    ...
    // [229] lru_cache_find_head::$2 = lru_cache_find_head::index#0 << 1 -- vbuaa=vbuxx_rol_1 
    txa
    asl
    // [230] lru_cache_find_head::key_link#0 = ((unsigned int *)&lru_cache)[lru_cache_find_head::$2] -- vwum1=pwuc1_derefidx_vbuaa 
    tay
    lda lru_cache,y
    sta key_link
    lda lru_cache+1,y
    ...
    jsr lru_cache_hash
    // lru_cache_index_t head_link = lru_cache_hash(key_link)
    // [233] lru_cache_hash::return#10 = lru_cache_hash::return#0
    // lru_cache_find_head::@2
    // [234] lru_cache_find_head::head_link#0 = lru_cache_hash::return#10
    // if (head_link != index)
    // [235] if(lru_cache_find_head::head_link#0!=lru_cache_find_head::index#0) goto lru_cache_find_head::@1 -- vbuaa_neq_vbuxx_then_la1 
    tay
    stx.z $ff
    cpy.z $ff
    bne __b1
    // [237] phi from lru_cache_find_head::@2 to lru_cache_find_head::@return [phi:lru_cache_find_head::@2->lru_cache_find_head::@return]
    // [237] phi lru_cache_find_head::return#3 = $ff [phi:lru_cache_find_head::@2->lru_cache_find_head::@return#0] -- vbuaa=vbuc1 
    lda #$ff
    rts
...
lru_cache_find_duplicate: {
  ...
  // First find the last duplicate node.
    ...
    // [241] if(((char *)&lru_cache+$300)[lru_cache_find_duplicate::index#3]==lru_cache_find_duplicate::link#3) goto lru_cache_find_duplicate::@return -- pbuc1_derefidx_vbuxx_eq_vbum1_then_la1 
    lda lru_cache+$300,x
    cmp link
    beq __breturn
    // lru_cache_find_duplicate::@3
    // [242] if(((char *)&lru_cache+$300)[lru_cache_find_duplicate::index#3]!=$ff) goto lru_cache_find_duplicate::@2 -- pbuc1_derefidx_vbuxx_neq_vbuc2_then_la1 
    lda lru_cache+$300,x
    cmp #$ff
    bne __b2
  ...
  __b2:
    // index = lru_cache.link[index]
    // [244] lru_cache_find_duplicate::index#2 = ((char *)&lru_cache+$300)[lru_cache_find_duplicate::index#3] -- vbuxx=pbuc1_derefidx_vbuxx 
    lda lru_cache+$300,x
    tax
    jmp __b1
  .segment Data
...
lru_cache_find_empty: {
  ...
  __b1:
    // lru_cache.key[index] != LRU_CACHE_NOTHING
    // [247] lru_cache_find_empty::$1 = lru_cache_find_empty::index#4 << 1 -- vbuaa=vbuxx_rol_1 
    txa
    asl
    // while (lru_cache.key[index] != LRU_CACHE_NOTHING)
    // [248] if(((unsigned int *)&lru_cache)[lru_cache_find_empty::$1]!=$ffff) goto lru_cache_find_empty::@2 -- pwuc1_derefidx_vbuaa_neq_vwuc2_then_la1 
    tay
    lda lru_cache+1,y
    cmp #>$ffff
    bne __b2
  ...
  __b2:
    // index++;
    // [250] lru_cache_find_empty::index#2 = ++ lru_cache_find_empty::index#4 -- vbuaa=_inc_vbuxx 
    txa
    inc
    // index %= LRU_CACHE_SIZE
    // [251] lru_cache_find_empty::index#3 = lru_cache_find_empty::index#2 & $80-1 -- vbuxx=vbuaa_band_vbuc1 
    and #$80-1
    tax
    jmp __b1
}

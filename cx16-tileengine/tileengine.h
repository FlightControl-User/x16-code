...
byte const TILE_BORDER_OFFSET = 0;
struct Tile TileBorder =       { "BORDER", TILE_BORDER_OFFSET, TILE_BORDER_COUNT, 32*32*TILE_BORDER_COUNT/2, 512, 32, 16, 2, 2, 2, 0x0, {0} };

byte const TILE_SQUAREMETAL_COUNT = 16;
byte const TILE_SQUAREMETAL_OFFSET = TILE_BORDER_OFFSET + TILE_BORDER_COUNT * 4;
struct Tile TileSquareMetal =  { "SQUAREMETAL", TILE_SQUAREMETAL_OFFSET, TILE_SQUAREMETAL_COUNT, 32*32*TILE_SQUAREMETAL_COUNT/2, 512, 64, 16, 4, 4, 4, 0x0, {0} };

byte const TILE_SQUARERASTER_COUNT = 16;
byte const TILE_SQUARERASTER_OFFSET = TILE_SQUAREMETAL_OFFSET + TILE_SQUAREMETAL_COUNT * 4;
struct Tile TileSquareRaster = { "SQUARERASTER", TILE_SQUARERASTER_OFFSET, TILE_SQUARERASTER_COUNT, 32*32*TILE_SQUARERASTER_COUNT/2, 512, 64, 16, 4, 4, 6, 0x0, {0} };

byte const TILE_INSIDEMETAL_COUNT = 4;
byte const TILE_INSIDEMETAL_OFFSET = TILE_SQUARERASTER_OFFSET + TILE_SQUARERASTER_COUNT * 4;
struct Tile TileInsideMetal =    { "INSIDEMETAL", TILE_INSIDEMETAL_OFFSET,  TILE_INSIDEMETAL_COUNT, 32*32*TILE_INSIDEMETAL_COUNT/2, 512, 64, 16, 4, 4, 5, 0x0, {0} };

byte const TILE_INSIDEDARK_COUNT = 4;
byte const TILE_INSIDEDARK_OFFSET = TILE_INSIDEMETAL_OFFSET + TILE_INSIDEMETAL_COUNT * 4;
struct Tile TileInsideDark =    { "INSIDEDARK", TILE_INSIDEDARK_OFFSET,  TILE_INSIDEDARK_COUNT, 32*32*TILE_INSIDEDARK_COUNT/2, 512, 64, 16, 4, 4, 5, 0x0, {0} };
...
struct TileSegment TileSegmentDB[26] = {
    ...
    { &TileInsideMetal,   { 00, 01, 02, 03 }, { &GSN00, &GSE00, &GSS00, &GSW00 } }, // 24
    { &TileInsideDark,    { 00, 01, 02, 03 }, { &GSN01, &GSE01, &GSS01, &GSW01 } }  // 25
};
...
byte const TILES = 16*2; 

byte TileFloor[TILES];

...
.file [name="cx16__deref_pwsc1_le__deref_pwsc2_then_la1.prg", type="prg", segments="Program"]
...
main: {
    ...
    // [447] phi gotoxy::y#4 = 0 [phi:main::@57->gotoxy#0] -- vbuz1=vbuc1 
    lda #0
    sta.z gotoxy.y
    jsr gotoxy
    // main::@58
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [34] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@1 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b2:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [45] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@3 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b4:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [56] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@5 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b6:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [67] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@7 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b8:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [78] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@9 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b10:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [89] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@11 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b12:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [100] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@13 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b14:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [111] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@15 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b16:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [122] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@17 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b18:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [133] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@19 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b20:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [144] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@21 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b22:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [155] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@23 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b24:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [166] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@25 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b26:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [177] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@27 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b28:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [188] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@29 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b30:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [199] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@31 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b32:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [210] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@33 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b34:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [221] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@35 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1
  ...
  __b36:
    ...
    sta sb+1
    // if(sa.a <= sb.b)
    // [232] if(*((signed word*)&sa)<=*((signed word*)&sb)) goto main::@37 -- _deref_pwsc1_le__deref_pwsc2_then_la1 
    lda sb
    cmp sa
    lda sb+1
    sbc sa+1

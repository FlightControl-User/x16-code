 ...
 */
// __mem() unsigned int fgets(__zp($2b) char *ptr, __mem() unsigned int size, __zp($22) FILE *stream)
fgets: {
    .label ptr = $2b
    .label stream = $22
  ...
  !__b3:
    // fgets::@8
    // if (remaining >= 512)
    // [21] if(fgets::remaining#11>=$200) goto fgets::@4 -- vwum1_ge_vwuc1_then_la1 
    lda remaining+1
    cmp #>$200
    bcc !+
    beq !__b4+
  ...
  __b4:
    ...
    // [50] cx16_k_macptr::bytes = $200 -- vbum1=vwuc1 
    lda #<$200
    sta cx16_k_macptr.bytes
 ...
 */
// __mem() int fclose(__zp($29) FILE *stream)
fclose: {
    .label stream = $29
    // unsigned char sp = (unsigned char)stream
 ...
 *  - other: OK! The last pointer between 0xA000 and 0xBFFF is returned. Note that the last pointer is indicating the first free byte.
 */
// __zp($29) FILE * fopen(__zp($24) const char *path, __zp($22) const char *mode)
fopen: {
    .label path = $24
    .label mode = $22
    .label return = $29
    ...
    .label fopen__27 = $24
    .label fopen__28 = $22
    .label cbm_k_setnam1_filename = $2f
    .label stream = $29
    .label pathtoken = $2b
...
conio_x16_init: {
    ...
    // [190] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_CURSOR_Y) = conio_x16_init::$7 -- _deref_pbuc1=vbuaa 
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_CURSOR_Y
    // gotoxy(__conio.cursor_x, __conio.cursor_y)
    // [191] gotoxy::x#0 = *((char *)&__conio) -- vbuxx=_deref_pbuc1 
    ldx lib_file.__conio
    // [192] gotoxy::y#0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_CURSOR_Y) -- vbuyy=_deref_pbuc1 
    tay
    // [193] call gotoxy
    jsr gotoxy
    // conio_x16_init::@7
    // __conio.scroll[0] = 1
    // [194] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_SCROLL) = 1 -- _deref_pbuc1=vbuc2 
    lda #1
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_SCROLL
    // __conio.scroll[1] = 1
    // [195] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_SCROLL+1) = 1 -- _deref_pbuc1=vbuc2 
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_SCROLL+1
 ...
 */
// __mem() unsigned int cx16_k_macptr(__mem() volatile char bytes, __zp($26) void * volatile buffer)
cx16_k_macptr: {
    .label buffer = $26
    // unsigned int bytes_read
    // [197] cx16_k_macptr::bytes_read = 0 -- vwum1=vwuc1 
    lda #<0
    sta bytes_read
    sta bytes_read+1
    // asm
...
strlen: {
    ...
    // [203] phi strlen::len#2 = 0 [phi:strlen->strlen::@1#0] -- vwum1=vwuc1 
    lda #<0
    sta len
    sta len+1
 ...
 */
// __mem() int ferror(__zp($29) FILE *stream)
ferror: {
    .label cbm_k_setnam1_filename = $2d
    .label stream = $29
    .label errno_len = $28
    // unsigned char sp = (unsigned char)stream
    ...
    // ferror::cbm_k_chkin1
    // char status
    // [224] ferror::cbm_k_chkin1_status = 0 -- vbum1=vbuc1 
    lda #0
    sta cbm_k_chkin1_status
    // asm
    // asm { ldxchannel jsrCBM_CHKIN stastatus  }
    ...
    // ferror::cbm_k_chrin1
    // char ch
    // [226] ferror::cbm_k_chrin1_ch = 0 -- vbum1=vbuc1 
    lda #0
    sta cbm_k_chrin1_ch
    // asm
    ...
    // [231] phi ferror::errno_len#10 = 0 [phi:ferror::@7->ferror::cbm_k_readst1#0] -- vbuz1=vbuc1 
    lda #0
    sta.z errno_len
    // [231] phi ferror::ch#10 = ferror::ch#0 [phi:ferror::@7->ferror::cbm_k_readst1#1] -- register_copy 
    // [231] phi ferror::errno_parsed#2 = 0 [phi:ferror::@7->ferror::cbm_k_readst1#2] -- vbum1=vbuc1 
    sta errno_parsed
    // ferror::cbm_k_readst1
  cbm_k_readst1:
    // char status
    // [232] ferror::cbm_k_readst1_status = 0 -- vbum1=vbuc1 
    lda #0
    sta cbm_k_readst1_status
    // asm
    // asm { jsrCBM_READST stastatus  }
  ...
  __b3:
    ...
    // ferror::cbm_k_chrin2
    // char ch
    // [257] ferror::cbm_k_chrin2_ch = 0 -- vbum1=vbuc1 
    lda #0
    sta cbm_k_chrin2_ch
    // asm
    // asm { jsrCBM_CHRIN stach  }
...
// __mem() int atoi(__zp($24) const char *str)
atoi: {
    .label str = $24
    // if (str[i] == '-')
    ...
    ldx #1
    // [266] phi atoi::res#2 = 0 [phi:atoi::@2->atoi::@3#1] -- vwsm1=vwsc1 
    tya
    sta res
    sta res+1
  ...
  __b2:
    // [266] phi atoi::negative#2 = 0 [phi:atoi->atoi::@3#0] -- vbuxx=vbuc1 
    ldx #0
    // [266] phi atoi::res#2 = 0 [phi:atoi->atoi::@3#1] -- vwsm1=vwsc1 
    txa
    sta res
    sta res+1
    // [266] phi atoi::i#4 = 0 [phi:atoi->atoi::@3#2] -- vbuyy=vbuc1 
    tay
    // atoi::@3
  __b3:
...
screenlayer1: {
    ...
    // [279] screenlayer::mapbase#0 = *VERA_L1_MAPBASE -- vbuxx=_deref_pbuc1 
    ldx VERA_L1_MAPBASE
    // [280] screenlayer::config#0 = *VERA_L1_CONFIG -- vbum1=_deref_pbuc1 
    lda VERA_L1_CONFIG
    sta screenlayer.config
    // [281] call screenlayer
    jsr screenlayer
    // screenlayer1::@return
    // }
    // [282] return 
...
textcolor: {
    // __conio.color & 0xF0
    // [283] textcolor::$0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_COLOR) & $f0 -- vbuaa=_deref_pbuc1_band_vbuc2 
    lda #$f0
    and lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_COLOR
    // __conio.color & 0xF0 | color
    // [284] textcolor::$1 = textcolor::$0 | WHITE -- vbuaa=vbuaa_bor_vbuc1 
    ora #WHITE
    // __conio.color = __conio.color & 0xF0 | color
    // [285] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_COLOR) = textcolor::$1 -- _deref_pbuc1=vbuaa 
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_COLOR
    // textcolor::@return
    // }
    // [286] return 
    rts
...
bgcolor: {
    // __conio.color & 0x0F
    // [287] bgcolor::$0 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_COLOR) & $f -- vbuaa=_deref_pbuc1_band_vbuc2 
    lda #$f
    and lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_COLOR
    // __conio.color & 0x0F | color << 4
    // [288] bgcolor::$2 = bgcolor::$0 | BLUE<<4 -- vbuaa=vbuaa_bor_vbuc1 
    ora #BLUE<<4
    // __conio.color = __conio.color & 0x0F | color << 4
    // [289] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_COLOR) = bgcolor::$2 -- _deref_pbuc1=vbuaa 
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_COLOR
    // bgcolor::@return
    // }
    // [290] return 
...
cursor: {
    ...
    // [291] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_CURSOR) = cursor::onoff#0 -- _deref_pbuc1=vbuc2 
    lda #onoff
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_CURSOR
    // cursor::@return
    // }
    // [292] return 
    rts
...
cbm_k_plot_get: {
    ...
    // [293] cbm_k_plot_get::x = 0 -- vbum1=vbuc1 
    lda #0
    sta x
    // __mem unsigned char y
    // [294] cbm_k_plot_get::y = 0 -- vbum1=vbuc1 
    sta y
    // kickasm
    ...
    // MAKEWORD(x,y)
    // [296] cbm_k_plot_get::return#0 = cbm_k_plot_get::x w= cbm_k_plot_get::y -- vwum1=vbum2_word_vbum3 
    lda x
    sta return+1
    lda y
    sta return
...
gotoxy: {
    ...
    // [298] if(gotoxy::x#0>=*((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_WIDTH)) goto gotoxy::@1 -- vbuxx_ge__deref_pbuc1_then_la1 
    cpx lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_WIDTH
    bcs __b1
    // [300] phi from gotoxy gotoxy::@1 to gotoxy::@2 [phi:gotoxy/gotoxy::@1->gotoxy::@2]
    // [300] phi gotoxy::$3 = gotoxy::x#0 [phi:gotoxy/gotoxy::@1->gotoxy::@2#0] -- register_copy 
    jmp __b2
    // gotoxy::@1
  __b1:
    // [299] gotoxy::$2 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_WIDTH) -- vbuxx=_deref_pbuc1 
    ldx lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_WIDTH
    // gotoxy::@2
  __b2:
    // __conio.cursor_x = (x>=__conio.width)?__conio.width:x
    // [301] *((char *)&__conio) = gotoxy::$3 -- _deref_pbuc1=vbuxx 
    stx lib_file.__conio
    // (y>=__conio.height)?__conio.height:y
    // [302] if(gotoxy::y#0>=*((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_HEIGHT)) goto gotoxy::@3 -- vbuyy_ge__deref_pbuc1_then_la1 
    cpy lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_HEIGHT
    bcs __b3
    // gotoxy::@4
    // [303] gotoxy::$14 = gotoxy::y#0 -- vbuaa=vbuyy 
    tya
    // [304] phi from gotoxy::@3 gotoxy::@4 to gotoxy::@5 [phi:gotoxy::@3/gotoxy::@4->gotoxy::@5]
    // [304] phi gotoxy::$7 = gotoxy::$6 [phi:gotoxy::@3/gotoxy::@4->gotoxy::@5#0] -- register_copy 
    // gotoxy::@5
  __b5:
    // __conio.cursor_y = (y>=__conio.height)?__conio.height:y
    // [305] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_CURSOR_Y) = gotoxy::$7 -- _deref_pbuc1=vbuaa 
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_CURSOR_Y
    // __conio.cursor_x << 1
    // [306] gotoxy::$8 = *((char *)&__conio) << 1 -- vbuxx=_deref_pbuc1_rol_1 
    lda lib_file.__conio
    asl
    tax
    // __conio.offsets[y] + __conio.cursor_x << 1
    // [307] gotoxy::$10 = gotoxy::y#0 << 1 -- vbuaa=vbuyy_rol_1 
    tya
    asl
    // [308] gotoxy::$9 = ((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSETS)[gotoxy::$10] + gotoxy::$8 -- vwum1=pwuc1_derefidx_vbuaa_plus_vbuxx 
    tay
    txa
    clc
    adc lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSETS,y
    sta gotoxy__9
    lda lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSETS+1,y
    adc #0
    sta gotoxy__9+1
    // __conio.offset = __conio.offsets[y] + __conio.cursor_x << 1
    // [309] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSET) = gotoxy::$9 -- _deref_pwuc1=vwum1 
    lda gotoxy__9
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSET
    lda gotoxy__9+1
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSET+1
    // gotoxy::@return
    // }
    // [310] return 
    rts
  ...
  __b3:
    // (y>=__conio.height)?__conio.height:y
    // [311] gotoxy::$6 = *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_HEIGHT) -- vbuaa=_deref_pbuc1 
    lda lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_HEIGHT
    jmp __b5
  .segment Data
...
strncpy: {
    ...
    lda #>__errno_error
    sta.z src+1
    // [313] phi strncpy::i#2 = 0 [phi:strncpy->strncpy::@1#2] -- vwum1=vwuc1 
    lda #<0
    sta i
    sta i+1
    // strncpy::@1
...
screenlayer: {
    ...
    // [323] screenlayer::vera_dc_hscale_temp#0 = *VERA_DC_HSCALE -- vbum1=_deref_pbuc1 
    lda VERA_DC_HSCALE
    sta vera_dc_hscale_temp
    // __mem char vera_dc_vscale_temp = *VERA_DC_VSCALE
    // [324] screenlayer::vera_dc_vscale_temp#0 = *VERA_DC_VSCALE -- vbum1=_deref_pbuc1 
    lda VERA_DC_VSCALE
    sta vera_dc_vscale_temp
    // __conio.layer = 0
    // [325] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_LAYER) = 0 -- _deref_pbuc1=vbuc2 
    lda #0
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_LAYER
    // mapbase >> 7
    // [326] screenlayer::$0 = screenlayer::mapbase#0 >> 7 -- vbuaa=vbuxx_ror_7 
    txa
    rol
    rol
    and #1
    // __conio.mapbase_bank = mapbase >> 7
    // [327] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPBASE_BANK) = screenlayer::$0 -- _deref_pbuc1=vbuaa 
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPBASE_BANK
    // (mapbase)<<1
    // [328] screenlayer::$1 = screenlayer::mapbase#0 << 1 -- vbuaa=vbuxx_rol_1 
    txa
    asl
    // MAKEWORD((mapbase)<<1,0)
    // [329] screenlayer::$2 = screenlayer::$1 w= 0 -- vwum1=vbuaa_word_vbuc1 
    ldy #0
    sta screenlayer__2+1
    sty screenlayer__2
    // __conio.mapbase_offset = MAKEWORD((mapbase)<<1,0)
    // [330] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPBASE_OFFSET) = screenlayer::$2 -- _deref_pwuc1=vwum1 
    tya
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPBASE_OFFSET
    lda screenlayer__2+1
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPBASE_OFFSET+1
    // config & VERA_LAYER_WIDTH_MASK
    // [331] screenlayer::$7 = screenlayer::config#0 & VERA_LAYER_WIDTH_MASK -- vbuaa=vbum1_band_vbuc1 
    lda #VERA_LAYER_WIDTH_MASK
    and config
    // (config & VERA_LAYER_WIDTH_MASK) >> 4
    // [332] screenlayer::$8 = screenlayer::$7 >> 4 -- vbuxx=vbuaa_ror_4 
    lsr
    lsr
    lsr
    lsr
    ...
    // [333] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPWIDTH) = screenlayer::VERA_LAYER_DIM[screenlayer::$8] -- _deref_pbuc1=pbuc2_derefidx_vbuxx 
    lda VERA_LAYER_DIM,x
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPWIDTH
    // config & VERA_LAYER_HEIGHT_MASK
    // [334] screenlayer::$5 = screenlayer::config#0 & VERA_LAYER_HEIGHT_MASK -- vbuaa=vbum1_band_vbuc1 
    lda #VERA_LAYER_HEIGHT_MASK
    and config
    // (config & VERA_LAYER_HEIGHT_MASK) >> 6
    // [335] screenlayer::$6 = screenlayer::$5 >> 6 -- vbuaa=vbuaa_ror_6 
    rol
    rol
    rol
    and #3
    // __conio.mapheight = VERA_LAYER_DIM[ (config & VERA_LAYER_HEIGHT_MASK) >> 6]
    // [336] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPHEIGHT) = screenlayer::VERA_LAYER_DIM[screenlayer::$6] -- _deref_pbuc1=pbuc2_derefidx_vbuaa 
    tay
    lda VERA_LAYER_DIM,y
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPHEIGHT
    // __conio.rowskip = VERA_LAYER_SKIP[(config & VERA_LAYER_WIDTH_MASK)>>4]
    // [337] screenlayer::$16 = screenlayer::$8 << 1 -- vbuaa=vbuxx_rol_1 
    txa
    asl
    // [338] *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_ROWSKIP) = screenlayer::VERA_LAYER_SKIP[screenlayer::$16] -- _deref_pwuc1=pwuc2_derefidx_vbuaa 
    // __conio.rowshift = ((config & VERA_LAYER_WIDTH_MASK)>>4)+6;
    tay
    lda VERA_LAYER_SKIP,y
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_ROWSKIP
    lda VERA_LAYER_SKIP+1,y
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_ROWSKIP+1
    // vera_dc_hscale_temp == 0x80
    // [339] screenlayer::$9 = screenlayer::vera_dc_hscale_temp#0 == $80 -- vboaa=vbum1_eq_vbuc1 
  ...
  !:
    ...
    // [340] screenlayer::$18 = (char)screenlayer::$9 -- vbuxx=vbuaa 
    tax
    // [341] screenlayer::$10 = $28 << screenlayer::$18 -- vbuaa=vbuc1_rol_vbuxx 
    lda #$28
    cpx #0
    beq !e+
  !:
  ...
  !e:
    ...
    // [342] screenlayer::$11 = screenlayer::$10 - 1 -- vbuaa=vbuaa_minus_1 
    sec
    sbc #1
    // __conio.width = (40 << (char)(vera_dc_hscale_temp == 0x80))-1
    // [343] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_WIDTH) = screenlayer::$11 -- _deref_pbuc1=vbuaa 
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_WIDTH
    // vera_dc_vscale_temp == 0x80
    // [344] screenlayer::$12 = screenlayer::vera_dc_vscale_temp#0 == $80 -- vboaa=vbum1_eq_vbuc1 
  ...
  !:
    ...
    // [345] screenlayer::$19 = (char)screenlayer::$12 -- vbuxx=vbuaa 
    tax
    // [346] screenlayer::$13 = $1e << screenlayer::$19 -- vbuaa=vbuc1_rol_vbuxx 
    lda #$1e
    cpx #0
    beq !e+
  !:
  ...
  !e:
    ...
    // [347] screenlayer::$14 = screenlayer::$13 - 1 -- vbuaa=vbuaa_minus_1 
    sec
    sbc #1
    // __conio.height = (30 << (char)(vera_dc_vscale_temp == 0x80))-1
    // [348] *((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_HEIGHT) = screenlayer::$14 -- _deref_pbuc1=vbuaa 
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_HEIGHT
    // unsigned int mapbase_offset = __conio.mapbase_offset
    // [349] screenlayer::mapbase_offset#0 = *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPBASE_OFFSET) -- vwum1=_deref_pwuc1 
    lda lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPBASE_OFFSET
    sta mapbase_offset
    lda lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_MAPBASE_OFFSET+1
    sta mapbase_offset+1
    // [350] phi from screenlayer to screenlayer::@1 [phi:screenlayer->screenlayer::@1]
    // [350] phi screenlayer::mapbase_offset#2 = screenlayer::mapbase_offset#0 [phi:screenlayer->screenlayer::@1#0] -- register_copy 
    // [350] phi screenlayer::y#2 = 0 [phi:screenlayer->screenlayer::@1#1] -- vbuxx=vbuc1 
    ldx #0
    // screenlayer::@1
  __b1:
    // for(register char y=0; y<=__conio.height; y++)
    // [351] if(screenlayer::y#2<=*((char *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_HEIGHT)) goto screenlayer::@2 -- vbuxx_le__deref_pbuc1_then_la1 
    lda lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_HEIGHT
    stx.z $ff
    cmp.z $ff
    bcs __b2
  ...
  __b2:
    ...
    // [353] screenlayer::$17 = screenlayer::y#2 << 1 -- vbuaa=vbuxx_rol_1 
    txa
    asl
    // [354] ((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSETS)[screenlayer::$17] = screenlayer::mapbase_offset#2 -- pwuc1_derefidx_vbuaa=vwum1 
    tay
    lda mapbase_offset
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSETS,y
    lda mapbase_offset+1
    sta lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_OFFSETS+1,y
    // mapbase_offset += __conio.rowskip
    // [355] screenlayer::mapbase_offset#1 = screenlayer::mapbase_offset#2 + *((unsigned int *)&__conio+OFFSET_STRUCT_CX16_CONIO_S_ROWSKIP) -- vwum1=vwum1_plus__deref_pwuc1 
    clc
    lda mapbase_offset
    adc lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_ROWSKIP
    sta mapbase_offset
    lda mapbase_offset+1
    adc lib_file.__conio+OFFSET_STRUCT_CX16_CONIO_S_ROWSKIP+1
    sta mapbase_offset+1
    // for(register char y=0; y<=__conio.height; y++)
    // [356] screenlayer::y#1 = ++ screenlayer::y#2 -- vbuxx=_inc_vbuxx 
    inx
    // [350] phi from screenlayer::@2 to screenlayer::@1 [phi:screenlayer::@2->screenlayer::@1]
    // [350] phi screenlayer::mapbase_offset#2 = screenlayer::mapbase_offset#1 [phi:screenlayer::@2->screenlayer::@1#0] -- register_copy 
    // [350] phi screenlayer::y#2 = screenlayer::y#1 [phi:screenlayer::@2->screenlayer::@1#1] -- register_copy 
    jmp __b1
  .segment Data
 ...
 */
  ...
  __errno: .word 0
  __conio: .fill lib_file.SIZEOF_STRUCT_CX16_CONIO_S, 0
  // Buffer used for stringified number being printed
  printf_buffer: .fill lib_file.SIZEOF_STRUCT_PRINTF_BUFFER_NUMBER, 0
  __stdio_file: .fill lib_file.SIZEOF_STRUCT_FILE, 0

...
.namespace lib_bramheap {
  // Upstart
.cpu _65c02
#if !__asm_import__lib_bramheap__
.segmentdef Code                    
.segmentdef CodeBramHeap            
.segmentdef Data                    
.segmentdef DataBramHeap            
.segmentdef BramBramHeap          
#endif

  // Global Constants & labels
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK = $35
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_INDEX_POSITION = 1
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK_FLOOR = 3
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_PTR_FLOOR = 5
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK_CEIL = $d
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_PTR_CEIL = $f
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR = 9
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_CEIL = $13
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAP_OFFSET = $1d
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT = $21
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT = $25
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT = $29
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAP_LIST = $17
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST = $1b
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST = $19
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE = $31
  .label OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE = $2d
  .label OFFSET_STRUCT_BRAM_HEAP_MAP_T_DATA1 = $100
  .label OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1 = $300
  .label OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE0 = $200
  .label OFFSET_STRUCT_BRAM_HEAP_MAP_T_NEXT = $400
  .label OFFSET_STRUCT_BRAM_HEAP_MAP_T_PREV = $500
  .label OFFSET_STRUCT_BRAM_HEAP_MAP_T_LEFT = $700
  .label OFFSET_STRUCT_BRAM_HEAP_MAP_T_RIGHT = $600
  .label SIZEOF_STRUCT_BRAM_HEAP_SEGMENT_T = $36
  .label BRAM = 0
  .label BROM = 1
.segment Code
...
bram_heap_get_size: {
    ...
    // [6] bram_heap_get_size::bank_set_bram1_bank#0 = *((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK) -- vbuaa=_deref_pbuc1 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK
    ...
    // [8] bram_heap_get_size_packed::s#1 = bram_heap_get_size::s -- vbuaa=vbum1 
    lda s
    // [9] bram_heap_get_size_packed::index#1 = bram_heap_get_size::index -- vbuxx=vbum1 
    ldx index
    ...
    // [13] bram_heap_get_size::size_packed#0 = (unsigned long)bram_heap_get_size::$2 -- vdum1=_dword_vwum2 
    ...
    // [15] bram_heap_get_size::size#0 = bram_heap_get_size::size_packed#0 << 5 -- vdum1=vdum1_rol_5 
    asl size
    rol size+1
    rol size+2
    rol size+3
  ...
  .segment DataBramHeap
    .label s = bram_heap_can_coalesce_left.return
    .label index = bram_heap_coalesce.s
    .label return = size_packed
    .label bram_heap_get_size__2 = bram_heap_find_best_fit.best_size_1
    size_packed: .dword 0
    .label size = size_packed
}
.segment CodeBramHeap
  // bram_heap_data_get_bank
// __mem() char bram_heap_data_get_bank(__mem() char s, __mem() char index)
bram_heap_data_get_bank: {
    .label bram_heap_data_get_bank__5 = $22
    ...
    // bank_set_bram(bram_heap_segment.bram_bank)
    // [20] bram_heap_data_get_bank::bank_set_bram1_bank#0 = *((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK) -- vbuaa=_deref_pbuc1 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK
    ...
    // [22] bram_heap_data_get_bank::$6 = (unsigned int)bram_heap_data_get_bank::s -- vwum1=_word_vbum2 
    lda s
    sta bram_heap_data_get_bank__6
    lda #0
    sta bram_heap_data_get_bank__6+1
    // [23] bram_heap_data_get_bank::$4 = bram_heap_data_get_bank::$6 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [24] bram_heap_data_get_bank::bram_heap_map#0 = bram_heap_index + bram_heap_data_get_bank::$4 -- pssz1=pssc1_plus_vwum2 
    ...
    // [25] bram_heap_data_get_bank::$5 = (char *)bram_heap_data_get_bank::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_DATA1 -- pbuz1=pbuz1_plus_vwuc1 
    lda.z bram_heap_data_get_bank__5
    clc
    adc #<OFFSET_STRUCT_BRAM_HEAP_MAP_T_DATA1
    sta.z bram_heap_data_get_bank__5
    lda.z bram_heap_data_get_bank__5+1
    adc #>OFFSET_STRUCT_BRAM_HEAP_MAP_T_DATA1
    sta.z bram_heap_data_get_bank__5+1
    // [26] bram_heap_data_get_bank::bram_bank#0 = bram_heap_data_get_bank::$5[bram_heap_data_get_bank::index] -- vbuaa=pbuz1_derefidx_vbum2 
    ldy index
    ...
    // return bram_bank;
    // [28] bram_heap_data_get_bank::return = bram_heap_data_get_bank::bram_bank#0 -- vbum1=vbuaa 
    sta return
  ...
  .segment DataBramHeap
    .label s = bram_heap_can_coalesce_left.return
    .label index = bram_heap_coalesce.s
    .label return = bram_heap_can_coalesce_left.return
...
// __zp($24) char * bram_heap_data_get_offset(__mem() char s, __mem() char index)
bram_heap_data_get_offset: {
    .label return = $24
    .label bram_heap_map = $22
    .label bram_ptr = $24
    ...
    // bank_set_bram(bram_heap_segment.bram_bank)
    // [32] bram_heap_data_get_offset::bank_set_bram1_bank#0 = *((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK) -- vbuaa=_deref_pbuc1 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK
    ...
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [34] bram_heap_data_get_offset::$8 = (unsigned int)bram_heap_data_get_offset::s -- vwum1=_word_vbum2 
    lda s
    sta bram_heap_data_get_offset__8
    lda #0
    sta bram_heap_data_get_offset__8+1
    // [35] bram_heap_data_get_offset::$6 = bram_heap_data_get_offset::$8 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [36] bram_heap_data_get_offset::bram_heap_map#0 = bram_heap_index + bram_heap_data_get_offset::$6 -- pssz1=pssc1_plus_vwum2 
    ...
    // [37] bram_heap_data_get_offset::$10 = (unsigned int)((char *)bram_heap_data_get_offset::bram_heap_map#0)[bram_heap_data_get_offset::index] -- vwum1=_word_pbuz2_derefidx_vbum3 
    ldy index
    lda (bram_heap_map),y
    sta bram_heap_data_get_offset__10
    lda #0
    sta bram_heap_data_get_offset__10+1
    // [38] bram_heap_data_get_offset::$3 = bram_heap_data_get_offset::$10 << 5 -- vwum1=vwum1_rol_5 
    ...
    // [39] bram_heap_data_get_offset::bram_ptr#0 = bram_heap_data_get_offset::$3 | $a000 -- vwuz1=vwum2_bor_vwuc1 
...
bram_heap_free: {
    ...
    // return BRAM;
    // [44] bram_heap_free::bram_bank#0 = BRAM -- vbum1=vbuz2 
    lda.z BRAM
    sta bram_bank
    // bram_heap_free::@5
    // bank_set_bram(bram_heap_segment.bram_bank)
    // [45] bram_heap_free::bank_set_bram1_bank#0 = *((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK) -- vbuaa=_deref_pbuc1 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK
    ...
    // [47] bram_heap_get_size_packed::s#0 = bram_heap_free::s -- vbuaa=vbum1 
    lda s
    // [48] bram_heap_get_size_packed::index#0 = bram_heap_free::free_index -- vbuxx=vbum1 
    ldx free_index
    ...
    jsr bram_heap_get_size_packed
    // bram_heap_size_packed_t free_size = bram_heap_get_size_packed(s, free_index)
    // [50] bram_heap_get_size_packed::return#0 = bram_heap_get_size_packed::return#12 -- vwum1=vwum2 
    ...
    // [52] bram_heap_get_data_packed::s#0 = bram_heap_free::s -- vbuaa=vbum1 
    lda s
    // [53] bram_heap_get_data_packed::index#0 = bram_heap_free::free_index -- vbuxx=vbum1 
    ldx free_index
    ...
    // [57] bram_heap_heap_remove::s#0 = bram_heap_free::s -- vbum1=vbum2 
    lda s
    sta bram_heap_heap_remove.s
    // [58] bram_heap_heap_remove::heap_index#0 = bram_heap_free::free_index -- vbum1=vbum2 
    lda free_index
    ...
    // [60] bram_heap_free_insert::s#0 = bram_heap_free::s -- vbum1=vbum2 
    lda s
    sta bram_heap_free_insert.s
    // [61] bram_heap_free_insert::free_index#0 = bram_heap_free::free_index -- vbum1=vbum2 
    lda free_index
    sta bram_heap_free_insert.free_index
    // [62] bram_heap_free_insert::data#0 = bram_heap_free::free_offset#0 -- vwum1=vwum2 
    lda free_offset
    sta bram_heap_free_insert.data
    lda free_offset+1
    sta bram_heap_free_insert.data+1
    // [63] bram_heap_free_insert::size#0 = bram_heap_free::free_size#0 -- vwum1=vwum2 
    lda free_size
    ...
    // [65] bram_heap_can_coalesce_left::s#0 = bram_heap_free::s -- vbum1=vbum2 
    lda s
    sta bram_heap_can_coalesce_left.s
    // [66] bram_heap_can_coalesce_left::heap_index#0 = bram_heap_free::free_index -- vbum1=vbum2 
    lda free_index
    sta bram_heap_can_coalesce_left.heap_index
    // [67] call bram_heap_can_coalesce_left
    jsr bram_heap_can_coalesce_left
    // [68] bram_heap_can_coalesce_left::return#0 = bram_heap_can_coalesce_left::return#3 -- vbuaa=vbum1 
    ...
    // [71] bram_heap_coalesce::s#0 = bram_heap_free::s -- vbum1=vbum2 
    lda s
    sta bram_heap_coalesce.s
    // [72] bram_heap_coalesce::left_index#0 = bram_heap_free::free_left_index#0 -- vbum1=vbuxx 
    stx bram_heap_coalesce.left_index
    // [73] bram_heap_coalesce::right_index#0 = bram_heap_free::free_index -- vbum1=vbum2 
    lda free_index
    ...
    // bram_heap_coalesce(s, free_left_index, free_index)
    // [75] bram_heap_coalesce::return#0 = bram_heap_coalesce::right_index#10 -- vbuaa=vbum1 
    ...
    // [77] bram_heap_free::free_index = bram_heap_free::$13 -- vbum1=vbuaa 
    sta free_index
    // bram_heap_free::@1
  __b1:
    // bram_heap_index_t free_right_index = heap_can_coalesce_right(s, free_index)
    // [78] heap_can_coalesce_right::s#0 = bram_heap_free::s -- vbum1=vbum2 
    lda s
    sta heap_can_coalesce_right.s
    // [79] heap_can_coalesce_right::heap_index#0 = bram_heap_free::free_index -- vbum1=vbum2 
    lda free_index
    sta heap_can_coalesce_right.heap_index
    // [80] call heap_can_coalesce_right
    jsr heap_can_coalesce_right
    // [81] heap_can_coalesce_right::return#0 = heap_can_coalesce_right::return#3 -- vbuaa=vbum1 
    ...
    // [84] bram_heap_coalesce::s#1 = bram_heap_free::s -- vbum1=vbum2 
    lda s
    sta bram_heap_coalesce.s
    // [85] bram_heap_coalesce::left_index#1 = bram_heap_free::free_index -- vbum1=vbum2 
    lda free_index
    sta bram_heap_coalesce.left_index
    // [86] bram_heap_coalesce::right_index#1 = bram_heap_free::free_right_index#0 -- vbum1=vbuxx 
    ...
    jsr bram_heap_coalesce
    // bram_heap_coalesce(s, free_index, free_right_index)
    // [88] bram_heap_coalesce::return#1 = bram_heap_coalesce::right_index#10 -- vbuaa=vbum1 
    lda bram_heap_coalesce.right_index
    // bram_heap_free::@14
    // [89] bram_heap_free::$14 = bram_heap_coalesce::return#1
    // free_index = bram_heap_coalesce(s, free_index, free_right_index)
    // [90] bram_heap_free::free_index = bram_heap_free::$14 -- vbum1=vbuaa 
    sta free_index
    // bram_heap_free::@2
  __b2:
    // bram_heap_segment.freeSize[s] += free_size
    // [91] bram_heap_free::$15 = bram_heap_free::s << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [92] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE)[bram_heap_free::$15] = ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE)[bram_heap_free::$15] + bram_heap_free::free_size#0 -- pwuc1_derefidx_vbuaa=pwuc1_derefidx_vbuaa_plus_vwum1 
    tay
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE,y
    clc
    adc free_size
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE,y
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE+1,y
    adc free_size+1
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE+1,y
    // bram_heap_segment.heapSize[s] -= free_size
    // [93] bram_heap_free::$16 = bram_heap_free::s << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [94] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE)[bram_heap_free::$16] = ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE)[bram_heap_free::$16] - bram_heap_free::free_size#0 -- pwuc1_derefidx_vbuaa=pwuc1_derefidx_vbuaa_minus_vwum1 
    tay
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE,y
    sec
    sbc free_size
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE,y
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE+1,y
    sbc free_size+1
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE+1,y
    // bram_heap_free::bank_set_bram2
    // BRAM = bank
    // [95] BRAM = bram_heap_free::bram_bank#0 -- vbuz1=vbum2 
    lda bram_bank
    sta.z BRAM
  ...
  .segment DataBramHeap
    ...
    free_index: .byte 0
    bram_bank: .byte 0
    .label free_size = bram_heap_get_size_packed.return
    .label free_offset = bram_heap_get_data_packed.return
}
.segment CodeBramHeap
  // bram_heap_alloc
/**
...
bram_heap_alloc: {
    ...
    // return BRAM;
    // [98] bram_heap_alloc::bank_set_bram2_bank#0 = BRAM -- vbum1=vbuz2 
    lda.z BRAM
    sta bank_set_bram2_bank
    // bram_heap_alloc::@3
    // bank_set_bram(bram_heap_segment.bram_bank)
    // [99] bram_heap_alloc::bank_set_bram1_bank#0 = *((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK) -- vbuaa=_deref_pbuc1 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK
    ...
    // [105] bram_heap_find_best_fit::s#0 = bram_heap_alloc::s -- vbum1=vbum2 
    lda s
    sta bram_heap_find_best_fit.s
    // [106] bram_heap_find_best_fit::requested_size#0 = bram_heap_alloc::packed_size#0 -- vwum1=vwum2 
    lda packed_size
  ...
  __b2:
    ...
    // BRAM = bank
    // [112] BRAM = bram_heap_alloc::bank_set_bram2_bank#0 -- vbuz1=vbum2 
    lda bank_set_bram2_bank
    sta.z BRAM
    // bram_heap_alloc::@5
    // return heap_index;
    // [113] bram_heap_alloc::return = bram_heap_alloc::heap_index#4 -- vbum1=vbuxx 
    stx return
  ...
  __b1:
    ...
    // [115] bram_heap_allocate::s#0 = bram_heap_alloc::s -- vbum1=vbum2 
    lda s
    sta bram_heap_allocate.s
    // [116] bram_heap_allocate::free_index#0 = bram_heap_alloc::free_index#0 -- vbum1=vbuxx 
    stx bram_heap_allocate.free_index
    // [117] bram_heap_allocate::required_size#0 = bram_heap_alloc::packed_size#0 -- vwum1=vwum2 
    lda packed_size
    ...
    // [121] bram_heap_alloc::$7 = bram_heap_alloc::s << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [122] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE)[bram_heap_alloc::$7] = ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE)[bram_heap_alloc::$7] - bram_heap_alloc::packed_size#0 -- pwuc1_derefidx_vbuaa=pwuc1_derefidx_vbuaa_minus_vwum1 
    tay
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE,y
    sec
    sbc packed_size
    ...
    // [123] bram_heap_alloc::$8 = bram_heap_alloc::s << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [124] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE)[bram_heap_alloc::$8] = ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE)[bram_heap_alloc::$8] + bram_heap_alloc::packed_size#0 -- pwuc1_derefidx_vbuaa=pwuc1_derefidx_vbuaa_plus_vwum1 
    tay
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPSIZE,y
    clc
    adc packed_size
  ...
  .segment DataBramHeap
    s: .byte 0
    .label size = bram_heap_get_size.size_packed
    .label return = bram_heap_can_coalesce_left.return
    .label packed_size = bram_heap_alloc_size_get.return
  .segment Data
 ...
 * @return void 
 */
// __mem() char bram_heap_segment_init(__mem() char s, __mem() char bram_bank_floor, __zp($22) char *bram_ptr_floor, __mem() char bram_bank_ceil, __zp($24) char *bram_ptr_ceil)
bram_heap_segment_init: {
    .label bram_ptr_floor = $22
    ...
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_PTR_FLOOR,y
    lda.z bram_ptr_floor+1
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_PTR_FLOOR+1,y
    // bram_heap_segment.bram_bank_ceil[s] = bram_bank_ceil
    // [129] ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK_CEIL)[bram_heap_segment_init::s] = bram_heap_segment_init::bram_bank_ceil -- pbuc1_derefidx_vbum1=vbum2 
    lda bram_bank_ceil
    ldy s
    ...
    tay
    lda.z bram_ptr_ceil
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_PTR_CEIL,y
    lda.z bram_ptr_ceil+1
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_PTR_CEIL+1,y
    // bram_heap_data_pack(bram_bank_floor, bram_ptr_floor)
    // [132] bram_heap_data_pack::bram_bank#0 = bram_heap_segment_init::bram_bank_floor -- vbuxx=vbum1 
    ldx bram_bank_floor
    ...
    // [137] bram_heap_segment_init::$15 = bram_heap_segment_init::s << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [138] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR)[bram_heap_segment_init::$15] = bram_heap_segment_init::$0 -- pwuc1_derefidx_vbuaa=vwum1 
    tay
    lda bram_heap_segment_init__0
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR,y
    lda bram_heap_segment_init__0+1
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR+1,y
    // bram_heap_data_pack(bram_bank_ceil, bram_ptr_ceil)
    // [139] bram_heap_data_pack::bram_bank#1 = bram_heap_segment_init::bram_bank_ceil -- vbuxx=vbum1 
    ldx bram_bank_ceil
    ...
    // [144] bram_heap_segment_init::$16 = bram_heap_segment_init::s << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [145] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_CEIL)[bram_heap_segment_init::$16] = bram_heap_segment_init::$1 -- pwuc1_derefidx_vbuaa=vwum1 
    tay
    lda bram_heap_segment_init__1
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_CEIL,y
    lda bram_heap_segment_init__1+1
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_CEIL+1,y
    ...
    lda s
    asl
    // [149] bram_heap_segment_init::free_size#0 = ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_CEIL)[bram_heap_segment_init::$18] -- vwum1=pwuc1_derefidx_vbuaa 
    tay
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_CEIL,y
    sta free_size
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_CEIL+1,y
    sta free_size+1
    // free_size -= bram_heap_segment.floor[s]
    // [150] bram_heap_segment_init::$19 = bram_heap_segment_init::s << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [151] bram_heap_segment_init::free_size#1 = bram_heap_segment_init::free_size#0 - ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR)[bram_heap_segment_init::$19] -- vwum1=vwum1_minus_pwuc1_derefidx_vbuaa 
    tay
    lda free_size
    sec
    sbc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR,y
    sta free_size
    lda free_size+1
    sbc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR+1,y
    sta free_size+1
    ...
    // [159] ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST)[bram_heap_segment_init::s] = $ff -- pbuc1_derefidx_vbum1=vbuc2 
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST,y
    // bram_heap_segment.free_list[s] = BRAM_HEAP_NULL
    // [160] ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST)[bram_heap_segment_init::s] = $ff -- pbuc1_derefidx_vbum1=vbuc2 
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST,y
    // bram_heap_segment_init::bank_get_bram1
    // return BRAM;
    // [161] bram_heap_segment_init::bank_old#0 = BRAM -- vbum1=vbuz2 
    lda.z BRAM
    sta bank_old
    // bram_heap_segment_init::@1
    // bank_set_bram(bram_heap_segment.bram_bank)
    // [162] bram_heap_segment_init::bank_set_bram1_bank#0 = *((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK) -- vbuaa=_deref_pbuc1 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK
    ...
    // [164] bram_heap_index_add::s#0 = bram_heap_segment_init::s -- vbuxx=vbum1 
    ldx s
    ...
    // bram_heap_index_t free_index = bram_heap_index_add(s)
    // [166] bram_heap_index_add::return#0 = bram_heap_index_add::return#1 -- vbuaa=vbum1 
    ...
    // [168] bram_heap_list_insert_at::s#0 = bram_heap_segment_init::s -- vbum1=vbum2 
    lda s
    sta bram_heap_list_insert_at.s
    // [169] bram_heap_list_insert_at::list#0 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST)[bram_heap_segment_init::s] -- vbum1=pbuc1_derefidx_vbum2 
    ldy s
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST,y
    sta bram_heap_list_insert_at.list
    // [170] bram_heap_list_insert_at::index#0 = bram_heap_segment_init::free_index#0 -- vbum1=vbuxx 
    stx bram_heap_list_insert_at.index
    // [171] bram_heap_list_insert_at::at#0 = bram_heap_segment_init::free_index#0 -- vbum1=vbuxx 
    stx bram_heap_list_insert_at.at
    ...
    // bram_heap_list_insert_at(s, bram_heap_segment.free_list[s], free_index, free_index)
    // [173] bram_heap_list_insert_at::return#0 = bram_heap_list_insert_at::list#11 -- vbuaa=vbum1 
    lda bram_heap_list_insert_at.list
    // bram_heap_segment_init::@7
    // free_index = bram_heap_list_insert_at(s, bram_heap_segment.free_list[s], free_index, free_index)
    // [174] bram_heap_segment_init::free_index#1 = bram_heap_list_insert_at::return#0 -- vbum1=vbuaa 
    sta free_index
    // bram_heap_set_data_packed(s, free_index, bram_heap_segment.floor[s])
    // [175] bram_heap_segment_init::$23 = bram_heap_segment_init::s << 1 -- vbuyy=vbum1_rol_1 
    lda s
    asl
    tay
    // [176] bram_heap_set_data_packed::s#0 = bram_heap_segment_init::s -- vbuxx=vbum1 
    ldx s
    // [177] bram_heap_set_data_packed::index#0 = bram_heap_segment_init::free_index#1 -- vbum1=vbum2 
    lda free_index
    sta bram_heap_set_data_packed.index
    // [178] bram_heap_set_data_packed::data_packed#0 = ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR)[bram_heap_segment_init::$23] -- vwum1=pwuc1_derefidx_vbuyy 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR,y
    sta bram_heap_set_data_packed.data_packed
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FLOOR+1,y
    ...
    // [184] bram_heap_set_free::s#0 = bram_heap_segment_init::s -- vbuaa=vbum1 
    lda s
    // [185] bram_heap_set_free::index#0 = bram_heap_segment_init::free_index#1 -- vbuxx=vbum1 
    ldx free_index
    ...
    // [187] bram_heap_set_next::s#0 = bram_heap_segment_init::s -- vbuyy=vbum1 
    ldy s
    ...
    // [191] bram_heap_set_prev::s#0 = bram_heap_segment_init::s -- vbuyy=vbum1 
    ldy s
    ...
    // [195] bram_heap_segment_init::$25 = bram_heap_segment_init::s << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [196] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT)[bram_heap_segment_init::$25] = ++ ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT)[bram_heap_segment_init::$25] -- pwuc1_derefidx_vbuaa=_inc_pwuc1_derefidx_vbuaa 
    tax
    inc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT,x
    bne !+
    inc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT+1,x
  !:
    // bram_heap_segment.free_list[s] = free_index
    // [197] ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST)[bram_heap_segment_init::s] = bram_heap_segment_init::free_index#1 -- pbuc1_derefidx_vbum1=vbum2 
    lda free_index
    ldy s
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST,y
    // bram_heap_segment.freeSize[s] = free_size
    // [198] bram_heap_segment_init::$26 = bram_heap_segment_init::s << 1 -- vbuaa=vbum1_rol_1 
    tya
    asl
    // [199] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE)[bram_heap_segment_init::$26] = bram_heap_segment_init::free_size#1 -- pwuc1_derefidx_vbuaa=vwum1 
    tay
    lda free_size
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREESIZE,y
    lda free_size+1
  ...
  .segment DataBramHeap
    .label s = return
    .label bram_bank_floor = bram_heap_can_coalesce_left.return
    .label bram_bank_ceil = bram_heap_coalesce.s
    return: .byte 0
    .label bram_heap_segment_init__0 = bram_heap_find_best_fit.best_size
    .label bram_heap_segment_init__1 = bram_heap_find_best_fit.best_size
    free_size: .word 0
    bank_old: .byte 0
    free_index: .byte 0
}
...
bram_heap_bram_bank_init: {
    ...
    // [205] *((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK) = bram_heap_bram_bank_init::bram_bank -- _deref_pbuc1=vbum1 
    lda bram_bank
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK
    ...
    // bank_set_bram(bram_heap_segment.bram_bank)
    // [208] bram_heap_bram_bank_init::bank_set_bram1_bank#0 = *((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK) -- vbuaa=_deref_pbuc1 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_BRAM_BANK
    ...
    rts
  .segment DataBramHeap
    .label bram_bank = bram_heap_can_coalesce_left.return
}
.segment CodeBramHeap
  // bram_heap_get_size_packed
// __mem() unsigned int bram_heap_get_size_packed(__register(A) char s, __register(X) char index)
bram_heap_get_size_packed: {
    .label bram_heap_get_size_packed__3 = $24
    .label bram_heap_get_size_packed__4 = $22
    .label bram_heap_map = $22
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [215] bram_heap_get_size_packed::$5 = (unsigned int)bram_heap_get_size_packed::s#8 -- vwum1=_word_vbuaa 
    sta bram_heap_get_size_packed__5
    lda #0
    sta bram_heap_get_size_packed__5+1
    // [216] bram_heap_get_size_packed::$2 = bram_heap_get_size_packed::$5 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [217] bram_heap_get_size_packed::bram_heap_map#0 = bram_heap_index + bram_heap_get_size_packed::$2 -- pssz1=pssc1_plus_vwum2 
    ...
    // [218] bram_heap_get_size_packed::$3 = (char *)bram_heap_get_size_packed::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1 -- pbuz1=pbuz2_plus_vwuc1 
    lda.z bram_heap_map
    clc
    ...
    // hi &= 0x7F
    // [220] bram_heap_get_size_packed::hi#1 = bram_heap_get_size_packed::hi#0 & $7f -- vbum1=vbuaa_band_vbuc1 
    and #$7f
    sta hi
    // unsigned char lo = bram_heap_map->size0[index]
    // [221] bram_heap_get_size_packed::$4 = (char *)bram_heap_get_size_packed::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE0 -- pbuz1=pbuz1_plus_vwuc1 
    // Ignore free flag!
    ...
    // MAKEWORD(hi, lo)
    // [223] bram_heap_get_size_packed::return#12 = bram_heap_get_size_packed::hi#1 w= bram_heap_get_size_packed::lo#0 -- vwum1=vbum2_word_vbuaa 
    ldy hi
    sty return_1+1
    sta return_1
  ...
  .segment DataBramHeap
    ...
    return: .word 0
    .label return_1 = bram_heap_find_best_fit.best_size_1
    .label hi = bram_heap_set_size_packed.index
    return_2: .word 0
    return_3: .word 0
}
.segment CodeBramHeap
  // bram_heap_get_data_packed
// __mem() unsigned int bram_heap_get_data_packed(__register(A) char s, __register(X) char index)
bram_heap_get_data_packed: {
    .label bram_heap_get_data_packed__3 = $22
    .label bram_heap_map = $24
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [226] bram_heap_get_data_packed::$5 = (unsigned int)bram_heap_get_data_packed::s#8 -- vwum1=_word_vbuaa 
    sta bram_heap_get_data_packed__5
    lda #0
    sta bram_heap_get_data_packed__5+1
    // [227] bram_heap_get_data_packed::$2 = bram_heap_get_data_packed::$5 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [228] bram_heap_get_data_packed::bram_heap_map#0 = bram_heap_index + bram_heap_get_data_packed::$2 -- pssz1=pssc1_plus_vwum2 
    ...
    // [229] bram_heap_get_data_packed::$3 = (char *)bram_heap_get_data_packed::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_DATA1 -- pbuz1=pbuz2_plus_vwuc1 
    lda.z bram_heap_map
    clc
    adc #<OFFSET_STRUCT_BRAM_HEAP_MAP_T_DATA1
    ...
    // [230] bram_heap_get_data_packed::hi#0 = bram_heap_get_data_packed::$3[bram_heap_get_data_packed::index#8] -- vbum1=pbuz2_derefidx_vbuxx 
    txa
    tay
    ...
    lda (bram_heap_map),y
    // MAKEWORD(hi, lo)
    // [232] bram_heap_get_data_packed::return#1 = bram_heap_get_data_packed::hi#0 w= bram_heap_get_data_packed::lo#0 -- vwum1=vbum2_word_vbuaa 
    ldy hi
    sty return+1
    sta return
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_get_data_packed__2 = bram_heap_find_best_fit.best_size
    .label bram_heap_get_data_packed__5 = bram_heap_find_best_fit.best_size
    return: .word 0
    .label hi = bram_heap_set_next.index
    return_1: .word 0
    return_2: .word 0
    .label return_3 = bram_heap_free_insert.size
    .label return_4 = bram_heap_segment_init.free_size
    .label return_5 = bram_heap_find_best_fit.best_size
    return_6: .word 0
}
.segment CodeBramHeap
...
bram_heap_heap_remove: {
    ...
    // [234] bram_heap_heap_remove::$3 = bram_heap_heap_remove::s#0 << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [235] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT)[bram_heap_heap_remove::$3] = -- ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT)[bram_heap_heap_remove::$3] -- pwuc1_derefidx_vbuaa=_dec_pwuc1_derefidx_vbuaa 
    tax
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT,x
    bne !+
    dec bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT+1,x
  !:
    dec bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT,x
    // bram_heap_list_remove(s, bram_heap_segment.heap_list[s], heap_index)
    // [236] bram_heap_list_remove::s#0 = bram_heap_heap_remove::s#0 -- vbum1=vbum2 
    lda s
    sta bram_heap_list_remove.s
    // [237] bram_heap_list_remove::list#2 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAP_LIST)[bram_heap_heap_remove::s#0] -- vbum1=pbuc1_derefidx_vbum2 
    ldy s
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAP_LIST,y
    ...
    // bram_heap_list_remove(s, bram_heap_segment.heap_list[s], heap_index)
    // [240] bram_heap_list_remove::return#4 = bram_heap_list_remove::return#1 -- vbuaa=vbum1 
    ...
    // [242] ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAP_LIST)[bram_heap_heap_remove::s#0] = bram_heap_heap_remove::$1 -- pbuc1_derefidx_vbum1=vbuaa 
    ldy s
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAP_LIST,y
  ...
  .segment DataBramHeap
    s: .byte 0
    .label heap_index = bram_heap_list_remove.index
}
.segment CodeBramHeap
...
bram_heap_free_insert: {
    ...
    // [244] bram_heap_list_insert_at::s#2 = bram_heap_free_insert::s#0 -- vbum1=vbum2 
    lda s
    sta bram_heap_list_insert_at.s
    // [245] bram_heap_list_insert_at::list#3 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST)[bram_heap_free_insert::s#0] -- vbum1=pbuc1_derefidx_vbum2 
    ldy s
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST,y
    sta bram_heap_list_insert_at.list
    // [246] bram_heap_list_insert_at::index#2 = bram_heap_free_insert::free_index#0 -- vbum1=vbum2 
    lda free_index
    sta bram_heap_list_insert_at.index
    // [247] bram_heap_list_insert_at::at#3 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST)[bram_heap_free_insert::s#0] -- vbum1=pbuc1_derefidx_vbum2 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST,y
    ...
    jsr bram_heap_list_insert_at
    // bram_heap_list_insert_at(s, bram_heap_segment.free_list[s], free_index, bram_heap_segment.free_list[s])
    // [249] bram_heap_list_insert_at::return#4 = bram_heap_list_insert_at::list#11 -- vbuaa=vbum1 
    lda bram_heap_list_insert_at.list
    ...
    // [251] ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST)[bram_heap_free_insert::s#0] = bram_heap_free_insert::$0 -- pbuc1_derefidx_vbum1=vbuaa 
    ldy s
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST,y
    // bram_heap_set_data_packed(s, free_index, data)
    // [252] bram_heap_set_data_packed::s#1 = bram_heap_free_insert::s#0 -- vbuxx=vbum1 
    ldx s
    // [253] bram_heap_set_data_packed::index#1 = bram_heap_free_insert::free_index#0 -- vbum1=vbum2 
    lda free_index
    sta bram_heap_set_data_packed.index
    ...
    // [256] bram_heap_set_size_packed::s#2 = bram_heap_free_insert::s#0 -- vbuxx=vbum1 
    ldx s
    // [257] bram_heap_set_size_packed::index#2 = bram_heap_free_insert::free_index#0 -- vbum1=vbum2 
    lda free_index
    sta bram_heap_set_size_packed.index
    // [258] bram_heap_set_size_packed::size_packed#2 = bram_heap_free_insert::size#0 -- vwum1=vwum2 
    lda size
    sta bram_heap_set_size_packed.size_packed
    lda size+1
    sta bram_heap_set_size_packed.size_packed+1
    ...
    // bram_heap_set_free(s, free_index)
    // [260] bram_heap_set_free::s#1 = bram_heap_free_insert::s#0 -- vbuaa=vbum1 
    lda s
    // [261] bram_heap_set_free::index#1 = bram_heap_free_insert::free_index#0 -- vbuxx=vbum1 
    ldx free_index
    ...
    // bram_heap_segment.freeCount[s]++;
    // [263] bram_heap_free_insert::$6 = bram_heap_free_insert::s#0 << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [264] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT)[bram_heap_free_insert::$6] = ++ ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT)[bram_heap_free_insert::$6] -- pwuc1_derefidx_vbuaa=_inc_pwuc1_derefidx_vbuaa 
    tax
    inc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT,x
    bne !+
    inc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT+1,x
  ...
  .segment DataBramHeap
    s: .byte 0
    free_index: .byte 0
    .label data = bram_heap_find_best_fit.best_size
    size: .word 0
}
.segment CodeBramHeap
...
bram_heap_can_coalesce_left: {
    ...
    // [266] bram_heap_get_data_packed::s#3 = bram_heap_can_coalesce_left::s#0 -- vbuaa=vbum1 
    lda s
    // [267] bram_heap_get_data_packed::index#3 = bram_heap_can_coalesce_left::heap_index#0 -- vbuxx=vbum1 
    ldx heap_index
    ...
    jsr bram_heap_get_data_packed
    // bram_heap_data_packed_t heap_offset = bram_heap_get_data_packed(s, heap_index)
    // [269] bram_heap_get_data_packed::return#14 = bram_heap_get_data_packed::return#1 -- vwum1=vwum2 
    ...
    // [271] bram_heap_get_left::s#2 = bram_heap_can_coalesce_left::s#0 -- vbuaa=vbum1 
    lda s
    // [272] bram_heap_get_left::index#2 = bram_heap_can_coalesce_left::heap_index#0 -- vbuxx=vbum1 
    ldx heap_index
    ...
    // [275] bram_heap_can_coalesce_left::left_index#0 = bram_heap_get_left::return#4 -- vbum1=vbuaa 
    sta left_index
    // bram_heap_data_packed_t left_offset = bram_heap_get_data_packed(s, left_index)
    // [276] bram_heap_get_data_packed::s#4 = bram_heap_can_coalesce_left::s#0 -- vbuaa=vbum1 
    lda s
    // [277] bram_heap_get_data_packed::index#4 = bram_heap_can_coalesce_left::left_index#0 -- vbuxx=vbum1 
    ldx left_index
    ...
    // [281] bram_heap_is_free::s#0 = bram_heap_can_coalesce_left::s#0 -- vbuaa=vbum1 
    lda s
    // [282] bram_heap_is_free::index#0 = bram_heap_can_coalesce_left::left_index#0 -- vbuxx=vbum1 
    ldx left_index
  ...
  __b2:
    // [289] phi bram_heap_can_coalesce_left::return#3 = $ff [phi:bram_heap_can_coalesce_left::@5/bram_heap_can_coalesce_left::@6->bram_heap_can_coalesce_left::@return#0] -- vbum1=vbuc1 
    lda #$ff
    sta return
    rts
  ...
  __b6:
    // if(left_free && (left_offset < heap_offset))
    // [287] if(bram_heap_can_coalesce_left::left_offset#0<bram_heap_can_coalesce_left::heap_offset#0) goto bram_heap_can_coalesce_left::@1 -- vwum1_lt_vwum2_then_la1 
    lda left_offset+1
    cmp heap_offset+1
    bcc __b1
    bne !+
  ...
  __b1:
    ...
    rts
  .segment DataBramHeap
    .label s = bram_heap_list_insert_at.s
    .label heap_index = bram_heap_list_insert_at.list
    .label heap_offset = bram_heap_free_insert.size
    .label left_index = return
    .label left_offset = bram_heap_get_data_packed.return
    return: .byte 0
}
.segment CodeBramHeap
  // bram_heap_coalesce
...
bram_heap_coalesce: {
    ...
    // [292] bram_heap_get_size_packed::s#6 = bram_heap_coalesce::s#10 -- vbuaa=vbum1 
    lda s
    // [293] bram_heap_get_size_packed::index#6 = bram_heap_coalesce::right_index#10 -- vbuxx=vbum1 
    ldx right_index
    ...
    jsr bram_heap_get_size_packed
    // bram_heap_size_packed_t right_size = bram_heap_get_size_packed(s, right_index)
    // [295] bram_heap_get_size_packed::return#16 = bram_heap_get_size_packed::return#12 -- vwum1=vwum2 
    lda bram_heap_get_size_packed.return_1
    sta bram_heap_get_size_packed.return_2
    lda bram_heap_get_size_packed.return_1+1
    sta bram_heap_get_size_packed.return_2+1
    ...
    // [297] bram_heap_get_size_packed::s#7 = bram_heap_coalesce::s#10 -- vbuaa=vbum1 
    lda s
    // [298] bram_heap_get_size_packed::index#7 = bram_heap_coalesce::left_index#10 -- vbuxx=vbum1 
    ldx left_index
    ...
    jsr bram_heap_get_size_packed
    // bram_heap_size_packed_t left_size = bram_heap_get_size_packed(s, left_index)
    // [300] bram_heap_get_size_packed::return#17 = bram_heap_get_size_packed::return#12 -- vwum1=vwum2 
    lda bram_heap_get_size_packed.return_1
    ...
    // bram_heap_data_packed_t left_offset = bram_heap_get_data_packed(s, left_index)
    // [302] bram_heap_get_data_packed::s#7 = bram_heap_coalesce::s#10 -- vbuaa=vbum1 
    lda s
    // [303] bram_heap_get_data_packed::index#7 = bram_heap_coalesce::left_index#10 -- vbuxx=vbum1 
    ldx left_index
    ...
    jsr bram_heap_get_data_packed
    // bram_heap_data_packed_t left_offset = bram_heap_get_data_packed(s, left_index)
    // [305] bram_heap_get_data_packed::return#18 = bram_heap_get_data_packed::return#1 -- vwum1=vwum2 
    lda bram_heap_get_data_packed.return
    ...
    // [307] bram_heap_get_left::s#3 = bram_heap_coalesce::s#10 -- vbuaa=vbum1 
    lda s
    // [308] bram_heap_get_left::index#3 = bram_heap_coalesce::left_index#10 -- vbuxx=vbum1 
    ldx left_index
    ...
    // [311] bram_heap_coalesce::free_left#0 = bram_heap_get_left::return#10 -- vbum1=vbuaa 
    sta free_left
    // bram_heap_index_t free_right = bram_heap_get_right(s, right_index)
    // [312] bram_heap_get_right::s#2 = bram_heap_coalesce::s#10 -- vbuaa=vbum1 
    lda s
    // [313] bram_heap_get_right::index#2 = bram_heap_coalesce::right_index#10 -- vbuxx=vbum1 
    ldx right_index
    ...
    // [316] bram_heap_coalesce::free_right#0 = bram_heap_get_right::return#4 -- vbum1=vbuaa 
    sta free_right
    // bram_heap_free_remove(s, left_index)
    // [317] bram_heap_free_remove::s#1 = bram_heap_coalesce::s#10 -- vbum1=vbum2 
    lda s
    sta bram_heap_free_remove.s
    // [318] bram_heap_free_remove::free_index#1 = bram_heap_coalesce::left_index#10 -- vbum1=vbum2 
    lda left_index
  ...
  // We detach the left index from the free list and add it to the idle list.
    ...
    // [320] bram_heap_idle_insert::s#0 = bram_heap_coalesce::s#10 -- vbum1=vbum2 
    lda s
    sta bram_heap_idle_insert.s
    // [321] bram_heap_idle_insert::idle_index#0 = bram_heap_coalesce::left_index#10 -- vbum1=vbum2 
    lda left_index
    ...
    // [323] bram_heap_set_left::s#3 = bram_heap_coalesce::s#10 -- vbuyy=vbum1 
    ldy s
    // [324] bram_heap_set_left::index#3 = bram_heap_coalesce::right_index#10 -- vbum1=vbum2 
    lda right_index
    sta bram_heap_set_left.index
    // [325] bram_heap_set_left::left#3 = bram_heap_coalesce::free_left#0 -- vbuxx=vbum1 
    ldx free_left
    ...
    // [327] bram_heap_set_right::s#3 = bram_heap_coalesce::s#10 -- vbuyy=vbum1 
    ldy s
    // [328] bram_heap_set_right::index#3 = bram_heap_coalesce::right_index#10 -- vbum1=vbum2 
    lda right_index
    sta bram_heap_set_right.index
    // [329] bram_heap_set_right::right#3 = bram_heap_coalesce::free_right#0 -- vbuxx=vbum1 
    ldx free_right
    ...
    // [331] bram_heap_set_left::s#4 = bram_heap_coalesce::s#10 -- vbuyy=vbum1 
    ldy s
    // [332] bram_heap_set_left::index#4 = bram_heap_coalesce::free_right#0 -- vbum1=vbum2 
    lda free_right
    sta bram_heap_set_left.index
    // [333] bram_heap_set_left::left#4 = bram_heap_coalesce::right_index#10 -- vbuxx=vbum1 
    ldx right_index
    ...
    // [335] bram_heap_set_right::s#4 = bram_heap_coalesce::s#10 -- vbuyy=vbum1 
    ldy s
    // [336] bram_heap_set_right::index#4 = bram_heap_coalesce::free_left#0 -- vbum1=vbum2 
    lda free_left
    sta bram_heap_set_right.index
    // [337] bram_heap_set_right::right#4 = bram_heap_coalesce::right_index#10 -- vbuxx=vbum1 
    ldx right_index
    ...
    // [339] bram_heap_set_left::s#5 = bram_heap_coalesce::s#10 -- vbuyy=vbum1 
    ldy s
    // [340] bram_heap_set_left::index#5 = bram_heap_coalesce::left_index#10 -- vbum1=vbum2 
    lda left_index
    sta bram_heap_set_left.index
    ...
    // [342] bram_heap_set_right::s#5 = bram_heap_coalesce::s#10 -- vbuyy=vbum1 
    ldy s
    // [343] bram_heap_set_right::index#5 = bram_heap_coalesce::left_index#10 -- vbum1=vbum2 
    lda left_index
    sta bram_heap_set_right.index
    ...
    // [345] bram_heap_set_size_packed::size_packed#5 = bram_heap_coalesce::left_size#0 + bram_heap_coalesce::right_size#0 -- vwum1=vwum2_plus_vwum3 
    lda left_size
    clc
    adc right_size
    sta bram_heap_set_size_packed.size_packed
    ...
    adc right_size+1
    sta bram_heap_set_size_packed.size_packed+1
    // [346] bram_heap_set_size_packed::s#5 = bram_heap_coalesce::s#10 -- vbuxx=vbum1 
    ldx s
    // [347] bram_heap_set_size_packed::index#5 = bram_heap_coalesce::right_index#10 -- vbum1=vbum2 
    lda right_index
    sta bram_heap_set_size_packed.index
    ...
    // [349] bram_heap_set_data_packed::s#6 = bram_heap_coalesce::s#10 -- vbuxx=vbum1 
    ldx s
    // [350] bram_heap_set_data_packed::index#6 = bram_heap_coalesce::right_index#10 -- vbum1=vbum2 
    lda right_index
    sta bram_heap_set_data_packed.index
    // [351] bram_heap_set_data_packed::data_packed#6 = bram_heap_coalesce::left_offset#0 -- vwum1=vwum2 
    lda left_offset
    sta bram_heap_set_data_packed.data_packed
    lda left_offset+1
    sta bram_heap_set_data_packed.data_packed+1
    ...
    // [353] bram_heap_set_free::s#3 = bram_heap_coalesce::s#10 -- vbuaa=vbum1 
    lda s
    // [354] bram_heap_set_free::index#3 = bram_heap_coalesce::left_index#10 -- vbuxx=vbum1 
    ldx left_index
    ...
    // [356] bram_heap_set_free::s#4 = bram_heap_coalesce::s#10 -- vbuaa=vbum1 
    lda s
    // [357] bram_heap_set_free::index#4 = bram_heap_coalesce::right_index#10 -- vbuxx=vbum1 
    ldx right_index
  ...
  .segment DataBramHeap
    ...
    left_index: .byte 0
    right_index: .byte 0
    .label right_size = bram_heap_get_size_packed.return_2
    .label left_size = bram_heap_get_size_packed.return_3
    .label left_offset = bram_heap_get_data_packed.return_6
    free_left: .byte 0
    free_right: .byte 0
}
.segment CodeBramHeap
...
heap_can_coalesce_right: {
    // bram_heap_data_packed_t heap_offset = bram_heap_get_data_packed(s, heap_index)
    // [360] bram_heap_get_data_packed::s#5 = heap_can_coalesce_right::s#0 -- vbuaa=vbum1 
    lda s
    // [361] bram_heap_get_data_packed::index#5 = heap_can_coalesce_right::heap_index#0 -- vbuxx=vbum1 
    ldx heap_index
    ...
    jsr bram_heap_get_data_packed
    // bram_heap_data_packed_t heap_offset = bram_heap_get_data_packed(s, heap_index)
    // [363] bram_heap_get_data_packed::return#16 = bram_heap_get_data_packed::return#1 -- vwum1=vwum2 
    lda bram_heap_get_data_packed.return
    ...
    // [365] bram_heap_get_right::s#1 = heap_can_coalesce_right::s#0 -- vbuaa=vbum1 
    lda s
    // [366] bram_heap_get_right::index#1 = heap_can_coalesce_right::heap_index#0 -- vbuxx=vbum1 
    ldx heap_index
    ...
    // [369] heap_can_coalesce_right::right_index#0 = bram_heap_get_right::return#3 -- vbum1=vbuaa 
    sta right_index
    // bram_heap_data_packed_t right_offset = bram_heap_get_data_packed(s, right_index)
    // [370] bram_heap_get_data_packed::s#6 = heap_can_coalesce_right::s#0 -- vbuaa=vbum1 
    lda s
    // [371] bram_heap_get_data_packed::index#6 = heap_can_coalesce_right::right_index#0 -- vbuxx=vbum1 
    ldx right_index
    ...
    jsr bram_heap_get_data_packed
    // bram_heap_data_packed_t right_offset = bram_heap_get_data_packed(s, right_index)
    // [373] bram_heap_get_data_packed::return#17 = bram_heap_get_data_packed::return#1 -- vwum1=vwum2 
    lda bram_heap_get_data_packed.return
    ...
    // [375] bram_heap_is_free::s#1 = heap_can_coalesce_right::s#0 -- vbuaa=vbum1 
    lda s
    // [376] bram_heap_is_free::index#1 = heap_can_coalesce_right::right_index#0 -- vbuxx=vbum1 
    ldx right_index
  ...
  __b2:
    // [383] phi heap_can_coalesce_right::return#3 = $ff [phi:heap_can_coalesce_right::@5/heap_can_coalesce_right::@6->heap_can_coalesce_right::@return#0] -- vbum1=vbuc1 
    lda #$ff
    sta return
    rts
  ...
  __b6:
    // if(right_free && (heap_offset < right_offset))
    // [381] if(heap_can_coalesce_right::heap_offset#0<heap_can_coalesce_right::right_offset#0) goto heap_can_coalesce_right::@1 -- vwum1_lt_vwum2_then_la1 
    lda heap_offset+1
    cmp right_offset+1
    bcc __b1
    bne !+
  ...
  __b1:
    ...
    rts
  .segment DataBramHeap
    .label s = bram_heap_list_insert_at.first
    .label heap_index = bram_heap_set_size_packed.index
    .label heap_offset = bram_heap_segment_init.free_size
    .label right_index = return
    .label right_offset = bram_heap_find_best_fit.best_size
...
bram_heap_alloc_size_get: {
    ...
    // [385] bram_heap_size_pack::size#0 = bram_heap_alloc_size_get::size#0 - 1 -- vdum1=vdum1_minus_1 
    sec
    lda bram_heap_size_pack.size
    sbc #1
    sta bram_heap_size_pack.size
    lda bram_heap_size_pack.size+1
    sbc #0
    sta bram_heap_size_pack.size+1
    lda bram_heap_size_pack.size+2
    sbc #0
    sta bram_heap_size_pack.size+2
    lda bram_heap_size_pack.size+3
    sbc #0
    ...
    // [389] bram_heap_alloc_size_get::return#1 = bram_heap_alloc_size_get::$1 + 1 -- vwum1=vwum1_plus_1 
    inc return
    bne !+
    inc return+1
  !:
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_alloc_size_get__1 = return
    .label size = bram_heap_get_size.size_packed
    return: .word 0
}
.segment CodeBramHeap
...
bram_heap_find_best_fit: {
    ...
    // [391] bram_heap_find_best_fit::free_index#0 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST)[bram_heap_find_best_fit::s#0] -- vbum1=pbuc1_derefidx_vbum2 
    ldy s
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST,y
    sta free_index
    // if(free_index == BRAM_HEAP_NULL)
    // [392] if(bram_heap_find_best_fit::free_index#0!=$ff) goto bram_heap_find_best_fit::@1 -- vbum1_neq_vbuc1_then_la1 
    lda #$ff
    cmp free_index
    bne __b1
  ...
  __b5:
    // [393] phi bram_heap_find_best_fit::return#2 = $ff [phi:bram_heap_find_best_fit/bram_heap_find_best_fit::@2->bram_heap_find_best_fit::@return#0] -- vbum1=vbuc1 
    lda #$ff
    sta return
  ...
  __b1:
    ...
    // [395] bram_heap_find_best_fit::free_end#0 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST)[bram_heap_find_best_fit::s#0] -- vbum1=pbuc1_derefidx_vbum2 
    ldy s
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREE_LIST,y
    sta free_end
    ...
    // [396] phi bram_heap_find_best_fit::best_index#6 = $ff [phi:bram_heap_find_best_fit::@1->bram_heap_find_best_fit::@3#0] -- vbum1=vbuc1 
    lda #$ff
    sta best_index
    // [396] phi bram_heap_find_best_fit::best_size#2 = $ffff [phi:bram_heap_find_best_fit::@1->bram_heap_find_best_fit::@3#1] -- vwum1=vwuc1 
    lda #<$ffff
    sta best_size
    lda #>$ffff
    sta best_size+1
  ...
  __b3:
    // bram_heap_size_packed_t free_size = bram_heap_get_size_packed(s, free_index)
    // [397] bram_heap_get_size_packed::s#5 = bram_heap_find_best_fit::s#0 -- vbuaa=vbum1 
    lda s
    // [398] bram_heap_get_size_packed::index#5 = bram_heap_find_best_fit::free_index#2 -- vbuxx=vbum1 
    ldx free_index
  ...
  // O(n) search.
    ...
    // [402] if(bram_heap_find_best_fit::free_size#0<bram_heap_find_best_fit::requested_size#0) goto bram_heap_find_best_fit::@11 -- vwum1_lt_vwum2_then_la1 
    lda free_size+1
  ...
  !:
    ...
    // [403] if(bram_heap_find_best_fit::free_size#0>=bram_heap_find_best_fit::best_size#2) goto bram_heap_find_best_fit::@4 -- vwum1_ge_vwum2_then_la1 
    lda best_size+1
    cmp free_size+1
    bne !+
    lda best_size
  ...
  !:
    ...
    // [404] bram_heap_find_best_fit::best_index#9 = bram_heap_find_best_fit::free_index#2 -- vbum1=vbum2 
    lda free_index
    sta best_index
  ...
  __b4:
    ...
    // [410] bram_heap_find_best_fit::free_index#1 = bram_heap_get_next::return#10 -- vbum1=vbuaa 
    sta free_index
    // while(free_index != free_end)
    // [411] if(bram_heap_find_best_fit::free_index#1!=bram_heap_find_best_fit::free_end#0) goto bram_heap_find_best_fit::@10 -- vbum1_neq_vbum2_then_la1 
    cmp free_end
    bne __b10
    // bram_heap_find_best_fit::@6
    // if(requested_size <= best_size)
    // [412] if(bram_heap_find_best_fit::requested_size#0>bram_heap_find_best_fit::best_size#3) goto bram_heap_find_best_fit::@2 -- vwum1_gt_vwum2_then_la1 
    lda best_size_1+1
    cmp requested_size+1
    bcc __b5
    bne !+
  ...
  __b10:
    // [414] bram_heap_find_best_fit::best_size#7 = bram_heap_find_best_fit::best_size#3 -- vwum1=vwum2 
    lda best_size_1
    sta best_size
    lda best_size_1+1
    sta best_size+1
  ...
  .segment DataBramHeap
    .label s = bram_heap_list_insert_at.s
    .label requested_size = bram_heap_free_insert.size
    .label free_index = bram_heap_can_coalesce_left.return
    .label free_end = bram_heap_set_next.index
    .label return = heap_can_coalesce_right.return
    .label free_size = best_size_1
    best_size: .word 0
    best_size_1: .word 0
    .label best_index = heap_can_coalesce_right.return
}
.segment CodeBramHeap
  // bram_heap_allocate
/**
...
bram_heap_allocate: {
    // bram_heap_size_packed_t free_size = bram_heap_get_size_packed(s, free_index)
    // [416] bram_heap_get_size_packed::s#4 = bram_heap_allocate::s#0 -- vbuaa=vbum1 
    lda s
    // [417] bram_heap_get_size_packed::index#4 = bram_heap_allocate::free_index#0 -- vbuxx=vbum1 
    ldx free_index
    ...
    // [421] if(bram_heap_allocate::free_size#0>bram_heap_allocate::required_size#0) goto bram_heap_allocate::@1 -- vwum1_gt_vwum2_then_la1 
    lda required_size+1
    cmp free_size+1
    bcc __b1
    bne !+
  ...
  !:
    ...
    // if(free_size == required_size)
    // [422] if(bram_heap_allocate::free_size#0==bram_heap_allocate::required_size#0) goto bram_heap_allocate::@3 -- vwum1_eq_vwum2_then_la1 
    lda free_size
    cmp required_size
    bne !+
    lda free_size+1
  ...
  __b3:
    ...
    // [425] bram_heap_replace_free_with_heap::s#0 = bram_heap_allocate::s#0 -- vbum1=vbum2 
    lda s
    sta bram_heap_replace_free_with_heap.s
    // [426] bram_heap_replace_free_with_heap::return#2 = bram_heap_allocate::free_index#0 -- vbum1=vbum2 
    lda free_index
    sta bram_heap_replace_free_with_heap.return
    // [427] bram_heap_replace_free_with_heap::required_size#0 = bram_heap_allocate::required_size#0 -- vwum1=vwum2 
    lda required_size
    ...
    // [429] bram_heap_allocate::return#2 = bram_heap_replace_free_with_heap::return#2 -- vbuaa=vbum1 
  ...
  __b1:
    ...
    // [430] bram_heap_split_free_and_allocate::s#0 = bram_heap_allocate::s#0 -- vbum1=vbum2 
    lda s
    sta bram_heap_split_free_and_allocate.s
    // [431] bram_heap_split_free_and_allocate::free_index#0 = bram_heap_allocate::free_index#0 -- vbum1=vbum2 
    lda free_index
    sta bram_heap_split_free_and_allocate.free_index
    // [432] bram_heap_split_free_and_allocate::required_size#0 = bram_heap_allocate::required_size#0 -- vwum1=vwum2 
    lda required_size
    ...
    // [434] bram_heap_split_free_and_allocate::return#2 = bram_heap_split_free_and_allocate::heap_index#0 -- vbuaa=vbum1 
    ...
    rts
  .segment DataBramHeap
    .label s = bram_heap_list_insert_at.list
    .label free_index = bram_heap_list_insert_at.first
    .label required_size = bram_heap_get_data_packed.return
    .label free_size = bram_heap_find_best_fit.best_size_1
}
.segment CodeBramHeap
  // bram_heap_data_pack
// __mem() unsigned int bram_heap_data_pack(__register(X) char bram_bank, __zp($22) char *bram_ptr)
bram_heap_data_pack: {
    .label bram_ptr = $22
    ...
    // [439] bram_heap_data_pack::$2 = bram_heap_data_pack::$1 >> 5 -- vwum1=vwum1_ror_5 
    ...
    // [440] bram_heap_data_pack::return#2 = bram_heap_data_pack::$0 | bram_heap_data_pack::$2 -- vwum1=vwum1_bor_vwum2 
    lda return
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_data_pack__0 = bram_heap_find_best_fit.best_size
    .label bram_heap_data_pack__1 = bram_heap_find_best_fit.best_size_1
    .label bram_heap_data_pack__2 = bram_heap_find_best_fit.best_size_1
...
bram_heap_index_add: {
    ...
    // [443] bram_heap_index_add::index#0 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST)[bram_heap_index_add::s#2] -- vbum1=pbuc1_derefidx_vbuxx 
    // TODO: Search idle list.
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST,x
    sta index
    // if(index != BRAM_HEAP_NULL)
    // [444] if(bram_heap_index_add::index#0!=$ff) goto bram_heap_index_add::@1 -- vbum1_neq_vbuc1_then_la1 
    lda #$ff
    cmp index
    bne __b1
    // bram_heap_index_add::@3
    // index = bram_heap_segment.index_position[s]
    // [445] bram_heap_index_add::index#1 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_INDEX_POSITION)[bram_heap_index_add::s#2] -- vbum1=pbuc1_derefidx_vbuxx 
    // The current header gets the current heap position handle.
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_INDEX_POSITION,x
    sta index
    // bram_heap_segment.index_position[s] + 1
    // [446] bram_heap_index_add::$1 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_INDEX_POSITION)[bram_heap_index_add::s#2] + 1 -- vbuaa=pbuc1_derefidx_vbuxx_plus_1 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_INDEX_POSITION,x
    inc
    // bram_heap_segment.index_position[s] = bram_heap_segment.index_position[s] + 1
    // [447] ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_INDEX_POSITION)[bram_heap_index_add::s#2] = bram_heap_index_add::$1 -- pbuc1_derefidx_vbuxx=vbuaa 
    // We adjust to the next index position.
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_INDEX_POSITION,x
  ...
  __b1:
    ...
    // [450] heap_idle_remove::s#0 = bram_heap_index_add::s#2 -- vbum1=vbuxx 
    stx heap_idle_remove.s
    // [451] heap_idle_remove::idle_index#0 = bram_heap_index_add::index#0 -- vbum1=vbum2 
    lda index
    ...
    rts
  .segment DataBramHeap
    .label index = bram_heap_can_coalesce_left.return
    .label return = bram_heap_can_coalesce_left.return
}
.segment CodeBramHeap
...
*/
// __register(A) char bram_heap_list_insert_at(__mem() char s, __mem() char list, __mem() char index, __mem() char at)
bram_heap_list_insert_at: {
    // if(list == BRAM_HEAP_NULL)
    // [454] if(bram_heap_list_insert_at::list#5!=$ff) goto bram_heap_list_insert_at::@1 -- vbum1_neq_vbuc1_then_la1 
    lda #$ff
    cmp list
    bne __b1
    // bram_heap_list_insert_at::@3
    // bram_heap_set_prev(s, index, index)
    // [455] bram_heap_set_prev::s#3 = bram_heap_list_insert_at::s#10 -- vbuyy=vbum1 
    ldy s
    ...
    // [459] bram_heap_set_next::s#3 = bram_heap_list_insert_at::s#10 -- vbuyy=vbum1 
    ldy s
    ...
    // [463] bram_heap_list_insert_at::list#21 = bram_heap_list_insert_at::index#10 -- vbum1=vbum2 
    lda index
    sta list
  ...
  __b1:
    ...
    // [465] if(bram_heap_list_insert_at::at#10!=$ff) goto bram_heap_list_insert_at::@2 -- vbum1_neq_vbuc1_then_la1 
    lda #$ff
    cmp at
    bne __b2
    // bram_heap_list_insert_at::@4
    // [466] bram_heap_list_insert_at::first#5 = bram_heap_list_insert_at::list#11 -- vbum1=vbum2 
    lda list
    sta first
  ...
  __b2:
    ...
    // [472] bram_heap_list_insert_at::last#0 = bram_heap_get_prev::return#3 -- vbum1=vbuaa 
    sta last
    // bram_heap_set_prev(s, index, last)
    // [473] bram_heap_set_prev::s#4 = bram_heap_list_insert_at::s#10 -- vbuyy=vbum1 
    ldy s
  ...
  // Add index to list at last position.
    ...
    // [481] bram_heap_set_next::s#5 = bram_heap_list_insert_at::s#10 -- vbuyy=vbum1 
    ldy s
    ...
    // [485] bram_heap_set_prev::s#5 = bram_heap_list_insert_at::s#10 -- vbuyy=vbum1 
    ldy s
  ...
  .segment DataBramHeap
    s: .byte 0
    list: .byte 0
    .label index = heap_can_coalesce_right.return
    .label at = first
    .label last = bram_heap_set_next.index
    first: .byte 0
}
.segment CodeBramHeap
  // bram_heap_set_data_packed
// void bram_heap_set_data_packed(__register(X) char s, __mem() char index, __mem() unsigned int data_packed)
bram_heap_set_data_packed: {
    .label bram_heap_set_data_packed__4 = $22
    .label bram_heap_map = $24
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [491] bram_heap_set_data_packed::$6 = (unsigned int)bram_heap_set_data_packed::s#7 -- vwum1=_word_vbuxx 
    txa
    sta bram_heap_set_data_packed__6
    lda #0
    sta bram_heap_set_data_packed__6+1
    // [492] bram_heap_set_data_packed::$3 = bram_heap_set_data_packed::$6 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [493] bram_heap_set_data_packed::bram_heap_map#0 = bram_heap_index + bram_heap_set_data_packed::$3 -- pssz1=pssc1_plus_vwum2 
    ...
    sta.z bram_heap_map+1
    // BYTE1(data_packed)
    // [494] bram_heap_set_data_packed::$1 = byte1  bram_heap_set_data_packed::data_packed#7 -- vbuxx=_byte1_vwum1 
    ldx data_packed+1
    // bram_heap_map->data1[index] = BYTE1(data_packed)
    // [495] bram_heap_set_data_packed::$4 = (char *)bram_heap_set_data_packed::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_DATA1 -- pbuz1=pbuz2_plus_vwuc1 
    lda.z bram_heap_map
    clc
    adc #<OFFSET_STRUCT_BRAM_HEAP_MAP_T_DATA1
    ...
    // [496] bram_heap_set_data_packed::$4[bram_heap_set_data_packed::index#7] = bram_heap_set_data_packed::$1 -- pbuz1_derefidx_vbum2=vbuxx 
    ldy index
    txa
    sta (bram_heap_set_data_packed__4),y
    // BYTE0(data_packed)
    // [497] bram_heap_set_data_packed::$2 = byte0  bram_heap_set_data_packed::data_packed#7 -- vbuaa=_byte0_vwum1 
    lda data_packed
    // bram_heap_map->data0[index] = BYTE0(data_packed)
    // [498] ((char *)bram_heap_set_data_packed::bram_heap_map#0)[bram_heap_set_data_packed::index#7] = bram_heap_set_data_packed::$2 -- pbuz1_derefidx_vbum2=vbuaa 
    sta (bram_heap_map),y
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_set_data_packed__3 = bram_heap_find_best_fit.best_size_1
    .label bram_heap_set_data_packed__6 = bram_heap_find_best_fit.best_size_1
    .label index = bram_heap_can_coalesce_left.return
    .label data_packed = bram_heap_find_best_fit.best_size
}
.segment CodeBramHeap
...
bram_heap_set_size_packed: {
    ...
    // [502] bram_heap_set_size_packed::$4 = bram_heap_set_size_packed::$7 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [503] bram_heap_set_size_packed::bram_heap_map#0 = bram_heap_index + bram_heap_set_size_packed::$4 -- pssz1=pssc1_plus_vwum2 
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_set_size_packed__4 = bram_heap_find_best_fit.best_size
    .label bram_heap_set_size_packed__7 = bram_heap_find_best_fit.best_size
    index: .byte 0
...
bram_heap_set_free: {
    .label bram_heap_set_free__2 = $24
    .label bram_heap_set_free__3 = $22
    .label bram_heap_map = $22
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [513] bram_heap_set_free::$4 = (unsigned int)bram_heap_set_free::s#5 -- vwum1=_word_vbuaa 
    sta bram_heap_set_free__4
    lda #0
    sta bram_heap_set_free__4+1
    // [514] bram_heap_set_free::$1 = bram_heap_set_free::$4 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [515] bram_heap_set_free::bram_heap_map#0 = bram_heap_index + bram_heap_set_free::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [516] bram_heap_set_free::$2 = (char *)bram_heap_set_free::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1 -- pbuz1=pbuz2_plus_vwuc1 
    lda.z bram_heap_map
    clc
    adc #<OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1
    ...
    // [517] bram_heap_set_free::$3 = (char *)bram_heap_set_free::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1 -- pbuz1=pbuz1_plus_vwuc1 
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_set_free__1 = bram_heap_find_best_fit.best_size
    .label bram_heap_set_free__4 = bram_heap_find_best_fit.best_size
}
.segment CodeBramHeap
  // bram_heap_set_next
/*inline*/
...
bram_heap_set_next: {
    .label bram_heap_set_next__2 = $24
    .label bram_heap_map = $24
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [521] bram_heap_set_next::$3 = (unsigned int)bram_heap_set_next::s#6 -- vwum1=_word_vbuyy 
    tya
    sta bram_heap_set_next__3
    lda #0
    sta bram_heap_set_next__3+1
    // [522] bram_heap_set_next::$1 = bram_heap_set_next::$3 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [523] bram_heap_set_next::bram_heap_map#0 = bram_heap_index + bram_heap_set_next::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [524] bram_heap_set_next::$2 = (char *)bram_heap_set_next::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_NEXT -- pbuz1=pbuz1_plus_vwuc1 
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_set_next__1 = bram_heap_set_next__3
...
bram_heap_set_prev: {
    .label bram_heap_set_prev__2 = $24
    .label bram_heap_map = $24
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [528] bram_heap_set_prev::$3 = (unsigned int)bram_heap_set_prev::s#6 -- vwum1=_word_vbuyy 
    tya
    sta bram_heap_set_prev__3
    lda #0
    sta bram_heap_set_prev__3+1
    // [529] bram_heap_set_prev::$1 = bram_heap_set_prev::$3 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [530] bram_heap_set_prev::bram_heap_map#0 = bram_heap_index + bram_heap_set_prev::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [531] bram_heap_set_prev::$2 = (char *)bram_heap_set_prev::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_PREV -- pbuz1=pbuz1_plus_vwuc1 
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_set_prev__1 = bram_heap_set_next.bram_heap_set_next__3
    .label bram_heap_set_prev__3 = bram_heap_set_next.bram_heap_set_next__3
    index: .byte 0
}
.segment Code
  // memset
...
bram_heap_list_remove: {
  ...
  __b1:
    ...
    ldy s
    // [551] bram_heap_set_next::index#2 = bram_heap_list_remove::index#10 -- vbum1=vbum2 
    lda index
    sta bram_heap_set_next.index
  ...
  // We initialize the start of the list to null.
    ...
    // [553] bram_heap_set_prev::s#2 = bram_heap_list_remove::s#10 -- vbuyy=vbum1 
    ldy s
    // [554] bram_heap_set_prev::index#2 = bram_heap_list_remove::index#10 -- vbum1=vbum2 
    lda index
    sta bram_heap_set_prev.index
  ...
  __b2:
    ...
    // [565] bram_heap_list_remove::prev#0 = bram_heap_get_prev::return#0 -- vbum1=vbuaa 
    sta prev
    // bram_heap_set_next(s, prev, next)
    // [566] bram_heap_set_next::s#1 = bram_heap_list_remove::s#10 -- vbuyy=vbum1 
    ldy s
...
bram_heap_get_left: {
    .label bram_heap_get_left__2 = $22
    .label bram_heap_map = $22
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [582] bram_heap_get_left::$3 = (unsigned int)bram_heap_get_left::s#4 -- vwum1=_word_vbuaa 
    sta bram_heap_get_left__3
    lda #0
    sta bram_heap_get_left__3+1
    // [583] bram_heap_get_left::$1 = bram_heap_get_left::$3 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [584] bram_heap_get_left::bram_heap_map#0 = bram_heap_index + bram_heap_get_left::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [585] bram_heap_get_left::$2 = (char *)bram_heap_get_left::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_LEFT -- pbuz1=pbuz1_plus_vwuc1 
    lda.z bram_heap_get_left__2
    clc
    adc #<OFFSET_STRUCT_BRAM_HEAP_MAP_T_LEFT
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_get_left__1 = bram_heap_find_best_fit.best_size
    .label bram_heap_get_left__3 = bram_heap_find_best_fit.best_size
}
.segment CodeBramHeap
  // bram_heap_is_free
// __register(A) bool bram_heap_is_free(__register(A) char s, __register(X) char index)
bram_heap_is_free: {
    .label bram_heap_is_free__4 = $22
    .label bram_heap_map = $22
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [589] bram_heap_is_free::$5 = (unsigned int)bram_heap_is_free::s#2 -- vwum1=_word_vbuaa 
    sta bram_heap_is_free__5
    lda #0
    sta bram_heap_is_free__5+1
    // [590] bram_heap_is_free::$3 = bram_heap_is_free::$5 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [591] bram_heap_is_free::bram_heap_map#0 = bram_heap_index + bram_heap_is_free::$3 -- pssz1=pssc1_plus_vwum2 
    ...
    sta.z bram_heap_map+1
    // bram_heap_map->size1[index] & 0x80
    // [592] bram_heap_is_free::$4 = (char *)bram_heap_is_free::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1 -- pbuz1=pbuz1_plus_vwuc1 
...
bram_heap_get_right: {
    .label bram_heap_get_right__2 = $22
    .label bram_heap_map = $22
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [597] bram_heap_get_right::$3 = (unsigned int)bram_heap_get_right::s#3 -- vwum1=_word_vbuaa 
    sta bram_heap_get_right__3
    lda #0
    sta bram_heap_get_right__3+1
    // [598] bram_heap_get_right::$1 = bram_heap_get_right::$3 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [599] bram_heap_get_right::bram_heap_map#0 = bram_heap_index + bram_heap_get_right::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [600] bram_heap_get_right::$2 = (char *)bram_heap_get_right::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_RIGHT -- pbuz1=pbuz1_plus_vwuc1 
    lda.z bram_heap_get_right__2
    clc
    adc #<OFFSET_STRUCT_BRAM_HEAP_MAP_T_RIGHT
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_get_right__1 = bram_heap_find_best_fit.best_size
    .label bram_heap_get_right__3 = bram_heap_find_best_fit.best_size
}
.segment CodeBramHeap
...
bram_heap_free_remove: {
    // bram_heap_segment.freeCount[s]--;
    // [604] bram_heap_free_remove::$4 = bram_heap_free_remove::s#2 << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [605] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT)[bram_heap_free_remove::$4] = -- ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT)[bram_heap_free_remove::$4] -- pwuc1_derefidx_vbuaa=_dec_pwuc1_derefidx_vbuaa 
    tax
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT,x
    bne !+
    dec bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT+1,x
  !:
    dec bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_FREECOUNT,x
    ...
    // [613] bram_heap_clear_free::s#0 = bram_heap_free_remove::s#2 -- vbuaa=vbum1 
    tya
    // [614] bram_heap_clear_free::index#0 = bram_heap_free_remove::free_index#2 -- vbuxx=vbum1 
    ldx free_index
...
bram_heap_idle_insert: {
    ...
    // [617] bram_heap_list_insert_at::s#3 = bram_heap_idle_insert::s#0 -- vbum1=vbum2 
    lda s
    sta bram_heap_list_insert_at.s
    // [618] bram_heap_list_insert_at::list#4 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST)[bram_heap_idle_insert::s#0] -- vbum1=pbuc1_derefidx_vbum2 
    ldy s
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST,y
    sta bram_heap_list_insert_at.list
    // [619] bram_heap_list_insert_at::index#3 = bram_heap_idle_insert::idle_index#0 -- vbum1=vbum2 
    lda idle_index
    sta bram_heap_list_insert_at.index
    // [620] bram_heap_list_insert_at::at#4 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST)[bram_heap_idle_insert::s#0] -- vbum1=pbuc1_derefidx_vbum2 
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST,y
    sta bram_heap_list_insert_at.at
    ...
    jsr bram_heap_list_insert_at
    // bram_heap_list_insert_at(s, bram_heap_segment.idle_list[s], idle_index, bram_heap_segment.idle_list[s])
    // [622] bram_heap_list_insert_at::return#10 = bram_heap_list_insert_at::list#11 -- vbuaa=vbum1 
    lda bram_heap_list_insert_at.list
    ...
    // [624] ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST)[bram_heap_idle_insert::s#0] = bram_heap_idle_insert::$0 -- pbuc1_derefidx_vbum1=vbuaa 
    ldy s
    sta bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLE_LIST,y
    // bram_heap_set_data_packed(s, idle_index, 0)
    // [625] bram_heap_set_data_packed::s#2 = bram_heap_idle_insert::s#0 -- vbuxx=vbum1 
    ldx s
    // [626] bram_heap_set_data_packed::index#2 = bram_heap_idle_insert::idle_index#0 -- vbum1=vbum2 
    lda idle_index
    sta bram_heap_set_data_packed.index
    ...
    // [490] phi bram_heap_set_data_packed::data_packed#7 = 0 [phi:bram_heap_idle_insert::@1->bram_heap_set_data_packed#1] -- vwum1=vbuc1 
    lda #<0
    sta bram_heap_set_data_packed.data_packed
    sta bram_heap_set_data_packed.data_packed+1
    ...
    // [628] bram_heap_set_size_packed::s#3 = bram_heap_idle_insert::s#0 -- vbuxx=vbum1 
    ldx s
    // [629] bram_heap_set_size_packed::index#3 = bram_heap_idle_insert::idle_index#0 -- vbum1=vbum2 
    lda idle_index
    sta bram_heap_set_size_packed.index
    ...
    // [500] phi bram_heap_set_size_packed::size_packed#6 = 0 [phi:bram_heap_idle_insert::@2->bram_heap_set_size_packed#1] -- vwum1=vbuc1 
    lda #<0
    sta bram_heap_set_size_packed.size_packed
    sta bram_heap_set_size_packed.size_packed+1
    ...
    // [631] bram_heap_idle_insert::$5 = bram_heap_idle_insert::s#0 << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [632] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT)[bram_heap_idle_insert::$5] = ++ ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT)[bram_heap_idle_insert::$5] -- pwuc1_derefidx_vbuaa=_inc_pwuc1_derefidx_vbuaa 
    tax
    inc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT,x
    bne !+
    inc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT+1,x
  !:
...
.segment CodeBramHeap
  // bram_heap_set_left
/*inline*/
// void bram_heap_set_left(__register(Y) char s, __mem() char index, __register(X) char left)
bram_heap_set_left: {
    .label bram_heap_set_left__2 = $22
    .label bram_heap_map = $22
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [635] bram_heap_set_left::$3 = (unsigned int)bram_heap_set_left::s#6 -- vwum1=_word_vbuyy 
    tya
    sta bram_heap_set_left__3
    lda #0
    sta bram_heap_set_left__3+1
    // [636] bram_heap_set_left::$1 = bram_heap_set_left::$3 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [637] bram_heap_set_left::bram_heap_map#0 = bram_heap_index + bram_heap_set_left::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [638] bram_heap_set_left::$2 = (char *)bram_heap_set_left::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_LEFT -- pbuz1=pbuz1_plus_vwuc1 
    ...
    // [639] bram_heap_set_left::$2[bram_heap_set_left::index#6] = bram_heap_set_left::left#6 -- pbuz1_derefidx_vbum2=vbuxx 
    ldy index
    txa
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_set_left__1 = bram_heap_find_best_fit.best_size
    .label bram_heap_set_left__3 = bram_heap_find_best_fit.best_size
    .label index = bram_heap_can_coalesce_left.return
}
.segment CodeBramHeap
  // bram_heap_set_right
/*inline*/
// void bram_heap_set_right(__register(Y) char s, __mem() char index, __register(X) char right)
bram_heap_set_right: {
    .label bram_heap_set_right__2 = $22
    .label bram_heap_map = $22
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [642] bram_heap_set_right::$3 = (unsigned int)bram_heap_set_right::s#6 -- vwum1=_word_vbuyy 
    tya
    sta bram_heap_set_right__3
    lda #0
    sta bram_heap_set_right__3+1
    // [643] bram_heap_set_right::$1 = bram_heap_set_right::$3 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [644] bram_heap_set_right::bram_heap_map#0 = bram_heap_index + bram_heap_set_right::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [645] bram_heap_set_right::$2 = (char *)bram_heap_set_right::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_RIGHT -- pbuz1=pbuz1_plus_vwuc1 
    ...
    // [646] bram_heap_set_right::$2[bram_heap_set_right::index#6] = bram_heap_set_right::right#6 -- pbuz1_derefidx_vbum2=vbuxx 
    ldy index
    txa
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_set_right__1 = bram_heap_find_best_fit.best_size
    .label bram_heap_set_right__3 = bram_heap_find_best_fit.best_size
    .label index = bram_heap_can_coalesce_left.return
}
.segment CodeBramHeap
  // bram_heap_size_pack
...
bram_heap_size_pack: {
    // size >> 5
    // [648] bram_heap_size_pack::$0 = bram_heap_size_pack::size#0 >> 5 -- vdum1=vdum1_ror_5 
    ...
    // [649] bram_heap_size_pack::return#0 = (unsigned int)bram_heap_size_pack::$0 -- vwum1=_word_vdum2 
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_size_pack__0 = bram_heap_get_size.size_packed
    .label return = bram_heap_alloc_size_get.return
    .label size = bram_heap_get_size.size_packed
}
.segment CodeBramHeap
  // bram_heap_get_next
...
bram_heap_get_next: {
    ...
    // [653] bram_heap_get_next::$1 = bram_heap_get_next::$3 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [654] bram_heap_get_next::bram_heap_map#0 = bram_heap_index + bram_heap_get_next::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [655] bram_heap_get_next::$2 = (char *)bram_heap_get_next::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_NEXT -- pbuz1=pbuz1_plus_vwuc1 
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_get_next__1 = bram_heap_find_best_fit.best_size
    .label bram_heap_get_next__3 = bram_heap_find_best_fit.best_size
}
.segment CodeBramHeap
...
bram_heap_replace_free_with_heap: {
    // bram_heap_size_packed_t free_size = bram_heap_get_size_packed(s, free_index)
    // [658] bram_heap_get_size_packed::s#2 = bram_heap_replace_free_with_heap::s#0 -- vbuaa=vbum1 
    lda s
    // [659] bram_heap_get_size_packed::index#2 = bram_heap_replace_free_with_heap::return#2 -- vbuxx=vbum1 
    ldx return
    ...
    // [661] bram_heap_get_data_packed::s#1 = bram_heap_replace_free_with_heap::s#0 -- vbuaa=vbum1 
    lda s
    // [662] bram_heap_get_data_packed::index#1 = bram_heap_replace_free_with_heap::return#2 -- vbuxx=vbum1 
    ldx return
    ...
    jsr bram_heap_get_data_packed
    // bram_heap_data_packed_t free_data = bram_heap_get_data_packed(s, free_index)
    // [664] bram_heap_get_data_packed::return#12 = bram_heap_get_data_packed::return#1 -- vwum1=vwum2 
    lda bram_heap_get_data_packed.return
    sta bram_heap_get_data_packed.return_1
    lda bram_heap_get_data_packed.return+1
    sta bram_heap_get_data_packed.return_1+1
    ...
    // [666] bram_heap_get_left::s#0 = bram_heap_replace_free_with_heap::s#0 -- vbuaa=vbum1 
    lda s
    // [667] bram_heap_get_left::index#0 = bram_heap_replace_free_with_heap::return#2 -- vbuxx=vbum1 
    ldx return
    ...
    // [670] bram_heap_replace_free_with_heap::free_left#0 = bram_heap_get_left::return#2 -- vbum1=vbuaa 
    sta free_left
    // bram_heap_index_t free_right = bram_heap_get_right(s, free_index)
    // [671] bram_heap_get_right::s#0 = bram_heap_replace_free_with_heap::s#0 -- vbuaa=vbum1 
    lda s
    // [672] bram_heap_get_right::index#0 = bram_heap_replace_free_with_heap::return#2 -- vbuxx=vbum1 
    ldx return
    ...
    // [675] bram_heap_replace_free_with_heap::free_right#0 = bram_heap_get_right::return#2 -- vbum1=vbuaa 
    sta free_right
    // bram_heap_free_remove(s, free_index)
    // [676] bram_heap_free_remove::s#0 = bram_heap_replace_free_with_heap::s#0 -- vbum1=vbum2 
    lda s
    sta bram_heap_free_remove.s
    // [677] bram_heap_free_remove::free_index#0 = bram_heap_replace_free_with_heap::return#2 -- vbum1=vbum2 
    lda return
    sta bram_heap_free_remove.free_index
    ...
    // [679] bram_heap_heap_insert_at::s#0 = bram_heap_replace_free_with_heap::s#0 -- vbum1=vbum2 
    lda s
    sta bram_heap_heap_insert_at.s
    // [680] bram_heap_heap_insert_at::heap_index#0 = bram_heap_replace_free_with_heap::return#2 -- vbum1=vbum2 
    lda return
    sta bram_heap_heap_insert_at.heap_index
    // [681] bram_heap_heap_insert_at::size#0 = bram_heap_replace_free_with_heap::required_size#0 -- vwum1=vwum2 
    lda required_size
    ...
    // [683] bram_heap_set_data_packed::s#3 = bram_heap_replace_free_with_heap::s#0 -- vbuxx=vbum1 
    ldx s
    // [684] bram_heap_set_data_packed::index#3 = bram_heap_replace_free_with_heap::return#2 -- vbum1=vbum2 
    lda return
    sta bram_heap_set_data_packed.index
    // [685] bram_heap_set_data_packed::data_packed#3 = bram_heap_replace_free_with_heap::free_data#0 -- vwum1=vwum2 
    lda free_data
    sta bram_heap_set_data_packed.data_packed
    lda free_data+1
    sta bram_heap_set_data_packed.data_packed+1
    ...
    // [687] bram_heap_set_left::s#0 = bram_heap_replace_free_with_heap::s#0 -- vbuyy=vbum1 
    ldy s
    // [688] bram_heap_set_left::index#0 = bram_heap_replace_free_with_heap::return#2 -- vbum1=vbum2 
    lda return
    sta bram_heap_set_left.index
    // [689] bram_heap_set_left::left#0 = bram_heap_replace_free_with_heap::free_left#0 -- vbuxx=vbum1 
    ldx free_left
    ...
    // [691] bram_heap_set_right::s#0 = bram_heap_replace_free_with_heap::s#0 -- vbuyy=vbum1 
    ldy s
    // [692] bram_heap_set_right::index#0 = bram_heap_replace_free_with_heap::return#2 -- vbum1=vbum2 
    lda return
    sta bram_heap_set_right.index
    // [693] bram_heap_set_right::right#0 = bram_heap_replace_free_with_heap::free_right#0 -- vbuxx=vbum1 
    ldx free_right
    ...
    rts
  .segment DataBramHeap
    .label free_data = bram_heap_get_data_packed.return_1
    free_left: .byte 0
    free_right: .byte 0
    s: .byte 0
...
bram_heap_split_free_and_allocate: {
    // bram_heap_size_packed_t free_size = bram_heap_get_size_packed(s, free_index)
    // [696] bram_heap_get_size_packed::s#3 = bram_heap_split_free_and_allocate::s#0 -- vbuaa=vbum1 
    lda s
    // [697] bram_heap_get_size_packed::index#3 = bram_heap_split_free_and_allocate::free_index#0 -- vbuxx=vbum1 
    ldx free_index
  ...
  // The free block is reduced in size with the required size.
    ...
    // bram_heap_data_packed_t free_data = bram_heap_get_data_packed(s, free_index)
    // [701] bram_heap_get_data_packed::s#2 = bram_heap_split_free_and_allocate::s#0 -- vbuaa=vbum1 
    lda s
    // [702] bram_heap_get_data_packed::index#2 = bram_heap_split_free_and_allocate::free_index#0 -- vbuxx=vbum1 
    ldx free_index
    ...
    jsr bram_heap_get_data_packed
    // bram_heap_data_packed_t free_data = bram_heap_get_data_packed(s, free_index)
    // [704] bram_heap_get_data_packed::return#13 = bram_heap_get_data_packed::return#1 -- vwum1=vwum2 
    lda bram_heap_get_data_packed.return
    ...
    // [706] bram_heap_set_size_packed::size_packed#4 = bram_heap_split_free_and_allocate::free_size#0 - bram_heap_split_free_and_allocate::required_size#0 -- vwum1=vwum1_minus_vwum2 
    lda bram_heap_set_size_packed.size_packed
    sec
    sbc required_size
    sta bram_heap_set_size_packed.size_packed
    ...
    // [710] bram_heap_set_data_packed::data_packed#4 = bram_heap_split_free_and_allocate::free_data#0 + bram_heap_split_free_and_allocate::required_size#0 -- vwum1=vwum2_plus_vwum3 
    lda free_data
    clc
    adc required_size
    sta bram_heap_set_data_packed.data_packed
    ...
    adc required_size+1
    sta bram_heap_set_data_packed.data_packed+1
    // [711] bram_heap_set_data_packed::s#4 = bram_heap_split_free_and_allocate::s#0 -- vbuxx=vbum1 
    ldx s
    // [712] bram_heap_set_data_packed::index#4 = bram_heap_split_free_and_allocate::free_index#0 -- vbum1=vbum2 
    lda free_index
    sta bram_heap_set_data_packed.index
    ...
    // [714] bram_heap_index_add::s#1 = bram_heap_split_free_and_allocate::s#0 -- vbuxx=vbum1 
    ldx s
  ...
  // The data is the offset in vram.
    ...
    jsr bram_heap_index_add
    // bram_heap_index_t heap_index = bram_heap_index_add(s)
    // [716] bram_heap_index_add::return#3 = bram_heap_index_add::return#1 -- vbuaa=vbum1 
    lda bram_heap_index_add.return
    // bram_heap_split_free_and_allocate::@5
    // [717] bram_heap_split_free_and_allocate::heap_index#0 = bram_heap_index_add::return#3 -- vbum1=vbuaa 
    sta heap_index
    // bram_heap_set_data_packed(s, heap_index, free_data)
    // [718] bram_heap_set_data_packed::s#5 = bram_heap_split_free_and_allocate::s#0 -- vbuxx=vbum1 
    ldx s
    // [719] bram_heap_set_data_packed::index#5 = bram_heap_split_free_and_allocate::heap_index#0 -- vbum1=vbum2 
    sta bram_heap_set_data_packed.index
    // [720] bram_heap_set_data_packed::data_packed#5 = bram_heap_split_free_and_allocate::free_data#0 -- vwum1=vwum2 
    lda free_data
    sta bram_heap_set_data_packed.data_packed
    lda free_data+1
    sta bram_heap_set_data_packed.data_packed+1
    ...
    // bram_heap_heap_insert_at(s, heap_index, BRAM_HEAP_NULL, required_size)
    // [722] bram_heap_heap_insert_at::s#1 = bram_heap_split_free_and_allocate::s#0 -- vbum1=vbum2 
    lda s
    sta bram_heap_heap_insert_at.s
    // [723] bram_heap_heap_insert_at::heap_index#1 = bram_heap_split_free_and_allocate::heap_index#0 -- vbum1=vbum2 
    lda heap_index
    sta bram_heap_heap_insert_at.heap_index
    // [724] bram_heap_heap_insert_at::size#1 = bram_heap_split_free_and_allocate::required_size#0 -- vwum1=vwum2 
    lda required_size
    sta bram_heap_heap_insert_at.size
    lda required_size+1
    sta bram_heap_heap_insert_at.size+1
    ...
    // [726] bram_heap_get_left::s#1 = bram_heap_split_free_and_allocate::s#0 -- vbuaa=vbum1 
    lda s
    // [727] bram_heap_get_left::index#1 = bram_heap_split_free_and_allocate::free_index#0 -- vbuxx=vbum1 
    ldx free_index
    ...
    // [730] bram_heap_split_free_and_allocate::heap_left#0 = bram_heap_get_left::return#3 -- vbum1=vbuaa 
    sta heap_left
    // bram_heap_set_left(s, heap_index, heap_left)
    // [731] bram_heap_set_left::s#1 = bram_heap_split_free_and_allocate::s#0 -- vbuyy=vbum1 
    ldy s
    // [732] bram_heap_set_left::index#1 = bram_heap_split_free_and_allocate::heap_index#0 -- vbum1=vbum2 
    lda heap_index
    sta bram_heap_set_left.index
    // [733] bram_heap_set_left::left#1 = bram_heap_split_free_and_allocate::heap_left#0 -- vbuxx=vbum1 
    ldx heap_left
    ...
    // [735] bram_heap_set_right::s#1 = bram_heap_split_free_and_allocate::s#0 -- vbuyy=vbum1 
    ldy s
    // [736] bram_heap_set_right::index#1 = bram_heap_split_free_and_allocate::heap_index#0 -- vbum1=vbum2 
    lda heap_index
    sta bram_heap_set_right.index
    // [737] bram_heap_set_right::right#1 = bram_heap_split_free_and_allocate::free_index#0 -- vbuxx=vbum1 
    ldx free_index
  ...
  // printf("\nright = %03x", heap_right);
    ...
    // [739] bram_heap_set_right::s#2 = bram_heap_split_free_and_allocate::s#0 -- vbuyy=vbum1 
    ldy s
    // [740] bram_heap_set_right::index#2 = bram_heap_split_free_and_allocate::heap_left#0 -- vbum1=vbum2 
    lda heap_left
    sta bram_heap_set_right.index
    // [741] bram_heap_set_right::right#2 = bram_heap_split_free_and_allocate::heap_index#0 -- vbuxx=vbum1 
    ldx heap_index
    ...
    // [743] bram_heap_set_left::s#2 = bram_heap_split_free_and_allocate::s#0 -- vbuyy=vbum1 
    ldy s
    // [744] bram_heap_set_left::index#2 = bram_heap_split_free_and_allocate::free_index#0 -- vbum1=vbum2 
    lda free_index
    sta bram_heap_set_left.index
    // [745] bram_heap_set_left::left#2 = bram_heap_split_free_and_allocate::heap_index#0 -- vbuxx=vbum1 
    ldx heap_index
    ...
    // [747] bram_heap_set_free::s#2 = bram_heap_split_free_and_allocate::s#0 -- vbuaa=vbum1 
    lda s
    // [748] bram_heap_set_free::index#2 = bram_heap_split_free_and_allocate::free_index#0 -- vbuxx=vbum1 
    ldx free_index
    ...
    // [750] bram_heap_clear_free::s#1 = bram_heap_split_free_and_allocate::s#0 -- vbuaa=vbum1 
    lda s
    // [751] bram_heap_clear_free::index#1 = bram_heap_split_free_and_allocate::heap_left#0 -- vbuxx=vbum1 
    ldx heap_left
  ...
  .segment DataBramHeap
    .label free_size = bram_heap_find_best_fit.best_size_1
    .label free_data = bram_heap_get_data_packed.return_2
    heap_index: .byte 0
    .label heap_left = heap_can_coalesce_right.return
    s: .byte 0
    free_index: .byte 0
    required_size: .word 0
}
...
heap_idle_remove: {
    // bram_heap_segment.idleCount[s]--;
    // [754] heap_idle_remove::$3 = heap_idle_remove::s#0 << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [755] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT)[heap_idle_remove::$3] = -- ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT)[heap_idle_remove::$3] -- pwuc1_derefidx_vbuaa=_dec_pwuc1_derefidx_vbuaa 
    tax
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT,x
    bne !+
    dec bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT+1,x
  !:
    dec bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_IDLECOUNT,x
  ...
  .segment DataBramHeap
    s: .byte 0
    .label idle_index = bram_heap_list_remove.index
}
.segment CodeBramHeap
  // bram_heap_get_prev
/*inline*/
...
bram_heap_get_prev: {
    ...
    // [766] bram_heap_get_prev::$1 = bram_heap_get_prev::$3 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [767] bram_heap_get_prev::bram_heap_map#0 = bram_heap_index + bram_heap_get_prev::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [768] bram_heap_get_prev::$2 = (char *)bram_heap_get_prev::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_PREV -- pbuz1=pbuz1_plus_vwuc1 
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_get_prev__1 = bram_heap_set_next.bram_heap_set_next__3
    .label bram_heap_get_prev__3 = bram_heap_set_next.bram_heap_set_next__3
}
.segment CodeBramHeap
  // bram_heap_clear_free
// void bram_heap_clear_free(__register(A) char s, __register(X) char index)
bram_heap_clear_free: {
    .label bram_heap_clear_free__2 = $24
    .label bram_heap_clear_free__3 = $22
    .label bram_heap_map = $22
    // bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s]
    // [772] bram_heap_clear_free::$4 = (unsigned int)bram_heap_clear_free::s#2 -- vwum1=_word_vbuaa 
    sta bram_heap_clear_free__4
    lda #0
    sta bram_heap_clear_free__4+1
    // [773] bram_heap_clear_free::$1 = bram_heap_clear_free::$4 << $b -- vwum1=vwum1_rol_vbuc1 
    ldy #$b
    cpy #0
    beq !e+
  !:
    ...
    bne !-
  !e:
    // [774] bram_heap_clear_free::bram_heap_map#0 = bram_heap_index + bram_heap_clear_free::$1 -- pssz1=pssc1_plus_vwum2 
    ...
    // [775] bram_heap_clear_free::$2 = (char *)bram_heap_clear_free::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1 -- pbuz1=pbuz2_plus_vwuc1 
    lda.z bram_heap_map
    clc
    adc #<OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1
    ...
    // [776] bram_heap_clear_free::$3 = (char *)bram_heap_clear_free::bram_heap_map#0 + OFFSET_STRUCT_BRAM_HEAP_MAP_T_SIZE1 -- pbuz1=pbuz1_plus_vwuc1 
    ...
    rts
  .segment DataBramHeap
    .label bram_heap_clear_free__1 = bram_heap_find_best_fit.best_size
    .label bram_heap_clear_free__4 = bram_heap_find_best_fit.best_size
}
.segment CodeBramHeap
...
bram_heap_heap_insert_at: {
    ...
    // [780] bram_heap_list_insert_at::s#1 = bram_heap_heap_insert_at::s#2 -- vbum1=vbum2 
    lda s
    sta bram_heap_list_insert_at.s
    // [781] bram_heap_list_insert_at::list#1 = ((char *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAP_LIST)[bram_heap_heap_insert_at::s#2] -- vbum1=pbuc1_derefidx_vbum2 
    ldy s
    lda bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAP_LIST,y
    sta bram_heap_list_insert_at.list
    // [782] bram_heap_list_insert_at::index#1 = bram_heap_heap_insert_at::heap_index#2 -- vbum1=vbum2 
    lda heap_index
    sta bram_heap_list_insert_at.index
    ...
    // [453] phi bram_heap_list_insert_at::at#10 = $ff [phi:bram_heap_heap_insert_at->bram_heap_list_insert_at#2] -- vbum1=vbuc1 
    lda #$ff
    sta bram_heap_list_insert_at.at
    ...
    jsr bram_heap_list_insert_at
    // bram_heap_list_insert_at(s, bram_heap_segment.heap_list[s], heap_index, at)
    // [784] bram_heap_list_insert_at::return#1 = bram_heap_list_insert_at::list#11 -- vbuaa=vbum1 
    lda bram_heap_list_insert_at.list
    ...
    // bram_heap_segment.heapCount[s]++;
    // [791] bram_heap_heap_insert_at::$4 = bram_heap_heap_insert_at::s#2 << 1 -- vbuaa=vbum1_rol_1 
    lda s
    asl
    // [792] ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT)[bram_heap_heap_insert_at::$4] = ++ ((unsigned int *)&bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT)[bram_heap_heap_insert_at::$4] -- pwuc1_derefidx_vbuaa=_inc_pwuc1_derefidx_vbuaa 
    tax
    inc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT,x
    bne !+
    inc bram_heap_segment+OFFSET_STRUCT_BRAM_HEAP_SEGMENT_T_HEAPCOUNT+1,x
  !:
...
.segment DataBramHeap
  bram_heap_segment: .fill lib_bramheap.SIZEOF_STRUCT_BRAM_HEAP_SEGMENT_T, 0
} // namespace

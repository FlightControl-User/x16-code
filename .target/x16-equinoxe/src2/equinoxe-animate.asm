...
.segment CodeEngineAnimate
  // animate_tower
// void animate_tower(__zp($2b) char a)
animate_tower: {
    .label a = $2b
    .label animate_tower__0 = $29
    // case 0:
 ...
 */
// void animate_player(__zp($28) char a, __zp($29) int x, __zp($2e) int px)
animate_player: {
    .label a = $28
    .label x = $29
    .label px = $2e
 ...
 */
// void animate_logic(__zp($22) char a)
animate_logic: {
    .label a = $22
    // if (!animate.wait[a])
 ...
 */
// __zp($22) char animate_get_image(__zp($2c) char a)
animate_get_image: {
    .label a = $2c
    .label return = $22
 ...
 */
// __zp($22) char animate_get_transition(__zp($2d) char a)
animate_get_transition: {
    .label a = $2d
    .label return = $22
  ...
  // animate_is_waiting
// __zp($22) char animate_is_waiting(__zp($25) char a)
animate_is_waiting: {
    .label a = $25
    .label return = $22
 ...
 */
// __zp($22) char animate_del(__zp($25) char a)
animate_del: {
    .label a = $25
    .label return = $22
    // animate.locked[a] = 0
 ...
 */
// __zp($25) char animate_add(__zp($25) char count, __zp($2d) char state, __zp($2c) char loop, __zp($22) char speed, __zp($28) signed char direction, __zp($2b) char reverse)
animate_add: {
    .label count = $25
    .label state = $2d
    .label loop = $2c

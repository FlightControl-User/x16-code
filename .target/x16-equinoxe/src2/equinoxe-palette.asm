...
.segment CodeEnginePalette
  // palette_free_vram
// void palette_free_vram(__zp($22) unsigned int bram_index)
palette_free_vram: {
    .label bram_index = $22
    .label palette_free_vram__0 = $24
    .label palette_free_vram__1 = $22
    // unsigned char vram_index = palette.bram.vram_index[bram_index]
    // [4] palette_free_vram::$0 = (char *)(struct palette_bram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_BRAM + palette_free_vram::bram_index -- pbuz1=pbuc1_plus_vwuz2 
    lda.z bram_index
    clc
    ...
    // [7] palette_free_vram::$1 = (char *)(struct palette_bram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_BRAM + palette_free_vram::bram_index -- pbuz1=pbuc1_plus_vwuz1 
  ...
  // palette_unuse_vram
// void palette_unuse_vram(__zp($22) unsigned int bram_index)
palette_unuse_vram: {
    .label bram_index = $22
    .label palette_unuse_vram__1 = $24
    // unsigned char vram_index = palette.bram.vram_index[bram_index]
    // [10] palette_unuse_vram::$1 = (char *)(struct palette_bram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_BRAM + palette_unuse_vram::bram_index -- pbuz1=pbuc1_plus_vwuz2 
    lda.z bram_index
    clc
    adc #<palette+OFFSET_STRUCT_PALETTE_T_BRAM
  ...
  // palette_use_vram
// __zp($26) char palette_use_vram(__zp($28) char palette_index)
palette_use_vram: {
    .label palette_index = $28
    .label return = $26
    .label vram_index = $26
    .label memcpy_vram_bram_fast1_doffset_vram = $24
    .label memcpy_vram_bram_fast1_sptr_bram = $22
    // unsigned char vram_index = palette.bram.vram_index[palette_index]
    // [14] palette_use_vram::vram_index#0 = ((char *)(struct palette_bram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_BRAM)[palette_use_vram::palette_index] -- vbuz1=pbuc1_derefidx_vbuz2 
    ldy.z palette_index
    ...
    // [21] if(0==((char *)(struct palette_vram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_VRAM)[palette_use_vram::vram_index#1]) goto palette_use_vram::@5 -- 0_eq_pbuc1_derefidx_vbuz1_then_la1 
    tay
    ...
    // [22] ((char *)(struct palette_bram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_BRAM)[((char *)(struct palette_vram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_VRAM)[palette_use_vram::vram_index#1]] = 0 -- pbuc1_derefidx_(pbuc2_derefidx_vbuz1)=vbuc3 
    lda #0
  ...
  __b5:
    ...
    // [23] ((char *)(struct palette_vram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_VRAM)[palette_use_vram::vram_index#1] = palette_use_vram::palette_index -- pbuc1_derefidx_vbuz1=vbuz2 
    lda.z palette_index
    ldy.z vram_index
    ...
    lda.z vram_index
    asl
    // [28] palette_use_vram::memcpy_vram_bram_fast1_doffset_vram#0 = ((unsigned int *)(struct palette_vram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_VRAM+OFFSET_STRUCT_PALETTE_VRAM_INDEX_S_OFFSET)[palette_use_vram::$8] -- vwuz1=pwuc1_derefidx_vbuaa 
    tay
  ...
  memcpy_vram_bram_fast1___b1:
    ...
    // [45] ((char *)(struct palette_bram_index_s *)&palette+OFFSET_STRUCT_PALETTE_T_BRAM)[palette_use_vram::palette_index] = palette_use_vram::vram_index#1 -- pbuc1_derefidx_vbuz1=vbuz2 
    lda.z vram_index
    ldy.z palette_index
  ...
  // palette_alloc_bram
// __zp($26) char palette_alloc_bram()
palette_alloc_bram: {
    .label return = $26
  ...
  __b1:
    ...
    // return palette.pool;
    // [53] palette_alloc_bram::return = *((char *)&palette+OFFSET_STRUCT_PALETTE_T_POOL) -- vbuz1=_deref_pbuc1 
    tya
    sta.z return
 ...
 */
// __zp($22) struct palette_16_s * palette_ptr_bram(__zp($27) char palette_index)
palette_ptr_bram: {
    .label palette_index = $27
    .label return = $22
    .label palette_ptr_bram__0 = $22
    .label palette_ptr_bram__1 = $22
    .label palette_ptr_bram__2 = $22
    ...
    asl.z palette_ptr_bram__1
    rol.z palette_ptr_bram__1+1
    // [60] palette_ptr_bram::$0 = (struct palette_16_s *)&palette_bram + palette_ptr_bram::$1 -- pssz1=pssc1_plus_vwuz1 
  ...
  // palette_init
// void palette_init(__zp($27) char bram_bank)
palette_init: {
    .label bram_bank = $27
    .label palette_init__2 = $24
    .label palette_init__4 = $24
    .label palette_init__5 = $24

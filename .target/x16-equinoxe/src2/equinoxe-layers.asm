...
vera_petscii_layer1: {
    ...
    // [66] phi vera_layer1_mode_tile::tileheight#10 = VERA_TILEBASE_HEIGHT_8 [phi:vera_petscii_layer1->vera_layer1_mode_tile#0] -- vbuz1=vbuc1 
    lda #VERA_TILEBASE_HEIGHT_8
    sta.z vera_layer1_mode_tile.tileheight
    // [66] phi vera_layer1_mode_tile::tilewidth#10 = VERA_TILEBASE_WIDTH_8 [phi:vera_petscii_layer1->vera_layer1_mode_tile#1] -- vbuz1=vbuc1 
    lda #VERA_TILEBASE_WIDTH_8
    sta.z vera_layer1_mode_tile.tilewidth
    // [66] phi vera_layer1_mode_tile::tilebase_offset#10 = $f000 [phi:vera_petscii_layer1->vera_layer1_mode_tile#2] -- vwuz1=vwuc1 
    lda #<$f000
    sta.z vera_layer1_mode_tile.tilebase_offset
    lda #>$f000
    sta.z vera_layer1_mode_tile.tilebase_offset+1
    // [66] phi vera_layer1_mode_tile::tilebase_bank#10 = 1 [phi:vera_petscii_layer1->vera_layer1_mode_tile#3] -- vbuz1=vbuc1 
    lda #1
    sta.z vera_layer1_mode_tile.tilebase_bank
    // [66] phi vera_layer1_mode_tile::mapbase_offset#3 = $d000 [phi:vera_petscii_layer1->vera_layer1_mode_tile#4] -- vwuz1=vwuc1 
    lda #<$d000
    sta.z vera_layer1_mode_tile.mapbase_offset
    lda #>$d000
    sta.z vera_layer1_mode_tile.mapbase_offset+1
    // [66] phi vera_layer1_mode_tile::mapheight#3 = VERA_LAYER_HEIGHT_32 [phi:vera_petscii_layer1->vera_layer1_mode_tile#5] -- vbuz1=vbuc1 
    lda #VERA_LAYER_HEIGHT_32
    sta.z vera_layer1_mode_tile.mapheight
    // [66] phi vera_layer1_mode_tile::mapwidth#3 = VERA_LAYER_WIDTH_64 [phi:vera_petscii_layer1->vera_layer1_mode_tile#6] -- vbuyy=vbuc1 
    ldy #VERA_LAYER_WIDTH_64
    // [66] phi vera_layer1_mode_tile::vera_layer1_set_color_depth1_bpp#0 = VERA_LAYER_COLOR_DEPTH_1BPP [phi:vera_petscii_layer1->vera_layer1_mode_tile#7] -- vbuxx=vbuc1 
...
vera_floor_layer1: {
    ...
    // [66] phi vera_layer1_mode_tile::tileheight#10 = VERA_TILEBASE_HEIGHT_16 [phi:vera_floor_layer1->vera_layer1_mode_tile#0] -- vbuz1=vbuc1 
    lda #VERA_TILEBASE_HEIGHT_16
    sta.z vera_layer1_mode_tile.tileheight
    // [66] phi vera_layer1_mode_tile::tilewidth#10 = VERA_TILEBASE_WIDTH_16 [phi:vera_floor_layer1->vera_layer1_mode_tile#1] -- vbuz1=vbuc1 
    lda #VERA_TILEBASE_WIDTH_16
    sta.z vera_layer1_mode_tile.tilewidth
    // [66] phi vera_layer1_mode_tile::tilebase_offset#10 = 0 [phi:vera_floor_layer1->vera_layer1_mode_tile#2] -- vwuz1=vwuc1 
    lda #<0
    sta.z vera_layer1_mode_tile.tilebase_offset
    sta.z vera_layer1_mode_tile.tilebase_offset+1
    // [66] phi vera_layer1_mode_tile::tilebase_bank#10 = 0 [phi:vera_floor_layer1->vera_layer1_mode_tile#3] -- vbuz1=vbuc1 
    sta.z vera_layer1_mode_tile.tilebase_bank
    // [66] phi vera_layer1_mode_tile::mapbase_offset#3 = $d000 [phi:vera_floor_layer1->vera_layer1_mode_tile#4] -- vwuz1=vwuc1 
    lda #<$d000
    sta.z vera_layer1_mode_tile.mapbase_offset
    lda #>$d000
    sta.z vera_layer1_mode_tile.mapbase_offset+1
    // [66] phi vera_layer1_mode_tile::mapheight#3 = VERA_LAYER_HEIGHT_32 [phi:vera_floor_layer1->vera_layer1_mode_tile#5] -- vbuz1=vbuc1 
    lda #VERA_LAYER_HEIGHT_32
    sta.z vera_layer1_mode_tile.mapheight
    // [66] phi vera_layer1_mode_tile::mapwidth#3 = VERA_LAYER_WIDTH_64 [phi:vera_floor_layer1->vera_layer1_mode_tile#6] -- vbuyy=vbuc1 
    ldy #VERA_LAYER_WIDTH_64
    // [66] phi vera_layer1_mode_tile::vera_layer1_set_color_depth1_bpp#0 = VERA_LAYER_COLOR_DEPTH_4BPP [phi:vera_floor_layer1->vera_layer1_mode_tile#7] -- vbuxx=vbuc1 
...
vera_petscii_init: {
    .label cx16_k_screen_set_charset1_charset = 8
    .label cx16_k_screen_set_charset1_offset = 3
    // cx16_k_screen_set_charset(3, (char *)0)
    // [36] vera_petscii_init::cx16_k_screen_set_charset1_charset = 3 -- vbuz1=vbuc1 
    lda #3
    ...
    // [66] phi vera_layer1_mode_tile::tileheight#10 = VERA_TILEBASE_HEIGHT_8 [phi:vera_petscii_init::@1->vera_layer1_mode_tile#0] -- vbuz1=vbuc1 
    lda #VERA_TILEBASE_HEIGHT_8
    sta.z vera_layer1_mode_tile.tileheight
    // [66] phi vera_layer1_mode_tile::tilewidth#10 = VERA_TILEBASE_WIDTH_8 [phi:vera_petscii_init::@1->vera_layer1_mode_tile#1] -- vbuz1=vbuc1 
    lda #VERA_TILEBASE_WIDTH_8
    sta.z vera_layer1_mode_tile.tilewidth
    // [66] phi vera_layer1_mode_tile::tilebase_offset#10 = $f000 [phi:vera_petscii_init::@1->vera_layer1_mode_tile#2] -- vwuz1=vwuc1 
    lda #<$f000
    sta.z vera_layer1_mode_tile.tilebase_offset
    lda #>$f000
    sta.z vera_layer1_mode_tile.tilebase_offset+1
    // [66] phi vera_layer1_mode_tile::tilebase_bank#10 = 1 [phi:vera_petscii_init::@1->vera_layer1_mode_tile#3] -- vbuz1=vbuc1 
    lda #1
    sta.z vera_layer1_mode_tile.tilebase_bank
    // [66] phi vera_layer1_mode_tile::mapbase_offset#3 = $b000 [phi:vera_petscii_init::@1->vera_layer1_mode_tile#4] -- vwuz1=vwuc1 
    lda #<$b000
    sta.z vera_layer1_mode_tile.mapbase_offset
    lda #>$b000
    sta.z vera_layer1_mode_tile.mapbase_offset+1
    // [66] phi vera_layer1_mode_tile::mapheight#3 = VERA_LAYER_HEIGHT_64 [phi:vera_petscii_init::@1->vera_layer1_mode_tile#5] -- vbuz1=vbuc1 
    lda #VERA_LAYER_HEIGHT_64
    sta.z vera_layer1_mode_tile.mapheight
    // [66] phi vera_layer1_mode_tile::mapwidth#3 = VERA_LAYER_WIDTH_128 [phi:vera_petscii_init::@1->vera_layer1_mode_tile#6] -- vbuyy=vbuc1 
    ldy #VERA_LAYER_WIDTH_128
    // [66] phi vera_layer1_mode_tile::vera_layer1_set_color_depth1_bpp#0 = VERA_LAYER_COLOR_DEPTH_1BPP [phi:vera_petscii_init::@1->vera_layer1_mode_tile#7] -- vbuxx=vbuc1 
    ldx #VERA_LAYER_COLOR_DEPTH_1BPP
    jsr vera_layer1_mode_tile
...
vera_layer1_hide: {
  ...
  // vera_layer1_mode_tile
// void vera_layer1_mode_tile(char mapbase_bank, __zp(6) unsigned int mapbase_offset, __zp(2) char tilebase_bank, __zp(9) unsigned int tilebase_offset, __register(Y) char mapwidth, __zp(5) char mapheight, __zp($b) char tilewidth, __zp($c) char tileheight, char bpp)
vera_layer1_mode_tile: {
    .label vera_layer1_set_tilebase1_vera_layer1_mode_tile__0 = 2
    .label mapheight = 5
    .label mapbase_offset = 6
    .label tilebase_bank = 2
    .label tilebase_offset = 9
    .label tilewidth = $b
    .label tileheight = $c
    ...
    // [72] *VERA_L1_CONFIG = *VERA_L1_CONFIG | vera_layer1_mode_tile::mapheight#3 -- _deref_pbuc1=_deref_pbuc1_bor_vbuz1 
    ora.z mapheight
    sta VERA_L1_CONFIG
    // vera_layer1_mode_tile::vera_layer1_set_mapbase1
    // BYTE1(mapbase_offset)
    // [73] vera_layer1_mode_tile::vera_layer1_set_mapbase1_$1 = byte1  vera_layer1_mode_tile::mapbase_offset#3 -- vbuaa=_byte1_vwuz1 
    lda.z mapbase_offset+1
    // BYTE1(mapbase_offset)>>1
    // [74] vera_layer1_mode_tile::vera_layer1_set_mapbase1_$2 = vera_layer1_mode_tile::vera_layer1_set_mapbase1_$1 >> 1 -- vbuaa=vbuaa_ror_1 
    lsr
    // (mapbase_bank<<7) | (BYTE1(mapbase_offset)>>1)
    // [75] vera_layer1_mode_tile::vera_layer1_set_mapbase1_$3 = 1<<7 | vera_layer1_mode_tile::vera_layer1_set_mapbase1_$2 -- vbuaa=vbuc1_bor_vbuaa 
    ora #1<<7
    // *VERA_L1_MAPBASE = (mapbase_bank<<7) | (BYTE1(mapbase_offset)>>1)
    // [76] *VERA_L1_MAPBASE = vera_layer1_mode_tile::vera_layer1_set_mapbase1_$3 -- _deref_pbuc1=vbuaa 
    sta VERA_L1_MAPBASE
    ...
    // tilebase_bank << 7
    // [78] vera_layer1_mode_tile::vera_layer1_set_tilebase1_$0 = vera_layer1_mode_tile::tilebase_bank#10 << 7 -- vbuz1=vbuz1_rol_7 
    lda.z vera_layer1_set_tilebase1_vera_layer1_mode_tile__0
    asl
    asl
    asl
    asl
    ...
    asl
    asl
    sta.z vera_layer1_set_tilebase1_vera_layer1_mode_tile__0
    // BYTE1(tilebase_offset)
    // [79] vera_layer1_mode_tile::vera_layer1_set_tilebase1_$1 = byte1  vera_layer1_mode_tile::tilebase_offset#10 -- vbuaa=_byte1_vwuz1 
    lda.z tilebase_offset+1
    // BYTE1(tilebase_offset)>>1
    // [80] vera_layer1_mode_tile::vera_layer1_set_tilebase1_$2 = vera_layer1_mode_tile::vera_layer1_set_tilebase1_$1 >> 1 -- vbuaa=vbuaa_ror_1 
    lsr
    // (tilebase_bank << 7) | BYTE1(tilebase_offset)>>1
    // [81] vera_layer1_mode_tile::vera_layer1_set_tilebase1_$3 = vera_layer1_mode_tile::vera_layer1_set_tilebase1_$0 | vera_layer1_mode_tile::vera_layer1_set_tilebase1_$2 -- vbuaa=vbuz1_bor_vbuaa 
    ora.z vera_layer1_set_tilebase1_vera_layer1_mode_tile__0
    // *VERA_L1_TILEBASE |= ((tilebase_bank << 7) | BYTE1(tilebase_offset)>>1)
    // [82] *VERA_L1_TILEBASE = *VERA_L1_TILEBASE | vera_layer1_mode_tile::vera_layer1_set_tilebase1_$3 -- _deref_pbuc1=_deref_pbuc1_bor_vbuaa 
    ...
    // [84] *VERA_L1_TILEBASE = *VERA_L1_TILEBASE | vera_layer1_mode_tile::tilewidth#10 -- _deref_pbuc1=_deref_pbuc1_bor_vbuz1 
    ora.z tilewidth
    sta VERA_L1_TILEBASE
    ...
    // [86] *VERA_L1_TILEBASE = *VERA_L1_TILEBASE | vera_layer1_mode_tile::tileheight#10 -- _deref_pbuc1=_deref_pbuc1_bor_vbuz1 
    ora.z tileheight
    sta VERA_L1_TILEBASE

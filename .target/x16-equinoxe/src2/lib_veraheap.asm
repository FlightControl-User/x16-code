 ...
 */
// __zp($4b) bool vera_heap_has_free(__zp($63) char s, __zp($4c) unsigned int size_requested)
vera_heap_has_free: {
    .label s = $63
    .label size_requested = $4c
    .label return = $4b
    .label packed_size = $36
  ...
  // vera_heap_set_image
// void vera_heap_set_image(__zp($4e) char s, __zp($62) char index, __zp($64) unsigned int image)
vera_heap_set_image: {
    .label s = $4e
    .label index = $62
    .label image = $64
    ...
    // [22] ((char *)&vera_heap_index+OFFSET_STRUCT_VERA_HEAP_MAP_T_IMAGE1)[vera_heap_set_image::index] = vera_heap_set_image::$0 -- pbuc1_derefidx_vbuz1=vbuaa 
    ldy.z index
  ...
  // vera_heap_get_image
// __zp($28) unsigned int vera_heap_get_image(__zp($68) char s, __zp($5c) char index)
vera_heap_get_image: {
    .label s = $68
    .label index = $5c
    .label return = $28
    .label vera_heap_get_image__0 = $28
    // MAKEWORD(vera_heap_index.image1[index], vera_heap_index.image0[index])
    // [26] vera_heap_get_image::$0 = ((char *)&vera_heap_index+OFFSET_STRUCT_VERA_HEAP_MAP_T_IMAGE1)[vera_heap_get_image::index] w= ((char *)&vera_heap_index)[vera_heap_get_image::index] -- vwuz1=pbuc1_derefidx_vbuz2_word_pbuc2_derefidx_vbuz2 
    ldy.z index
...
// __zp($2c) char vera_heap_data_get_bank(__zp($56) char s, __zp($5b) char index)
vera_heap_data_get_bank: {
    .label s = $56
    .label index = $5b
    .label return = $2c
    ...
    // [33] vera_heap_data_get_bank::vram_bank#0 = ((char *)&vera_heap_index+OFFSET_STRUCT_VERA_HEAP_MAP_T_DATA1)[vera_heap_data_get_bank::index] >> 5 -- vbuxx=pbuc1_derefidx_vbuz1_ror_5 
    ldx.z index
...
// __zp($3c) unsigned int vera_heap_data_get_offset(__zp($27) char s, __zp($61) char index)
vera_heap_data_get_offset: {
    .label s = $27
    .label index = $61
    .label return = $3c
    .label vera_heap_data_get_offset__5 = $3c
    .label vram_offset = $3c
 ...
 * @return heap_handle 
 */
// void vera_heap_free(__zp($67) char s, __zp($61) char free_index)
vera_heap_free: {
    .label s = $67
    .label free_index = $61
    .label free_size = $50
    .label free_offset = $3c
    .label free_size_coalesced = $36
    .label free_bank_coalesced = $2c
    .label free_offset_coalesced = $3c
    ...
    // [75] vera_heap_coalesce::left_index#0 = vera_heap_free::free_left_index#0 -- vbuz1=vbuxx 
    stx.z vera_heap_coalesce.left_index
  ...
  __b1:
    ...
    // [81] vera_heap_can_coalesce_right::heap_index#0 = vera_heap_free::free_index -- vbuz1=vbuz2 
    lda.z free_index
    sta.z vera_heap_can_coalesce_right.heap_index
    // [82] call vera_heap_can_coalesce_right
    jsr vera_heap_can_coalesce_right
    // [83] vera_heap_can_coalesce_right::return#0 = vera_heap_can_coalesce_right::return#3 -- vbuaa=vbuz1 
    lda.z vera_heap_can_coalesce_right.return
    // vera_heap_free::@12
  ...
  __b2:
    ...
    lda.z free_index
    sta.z lib_veraheap.vera_heap_data_get_bank.index
    ...
    // [105] memset_vram::dbank_vram#0 = vera_heap_free::free_bank_coalesced#0 -- vbuyy=vbuz1 
    ldy.z free_bank_coalesced
    ...
    lda.z s
    asl
    // [112] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREESIZE)[vera_heap_free::$19] = ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREESIZE)[vera_heap_free::$19] + vera_heap_free::free_size#0 -- pwuc1_derefidx_vbuaa=pwuc1_derefidx_vbuaa_plus_vwuz1 
    tay
    ...
    lda.z s
    asl
    // [114] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAPSIZE)[vera_heap_free::$20] = ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAPSIZE)[vera_heap_free::$20] - vera_heap_free::free_size#0 -- pwuc1_derefidx_vbuaa=pwuc1_derefidx_vbuaa_minus_vwuz1 
    tay
 ...
 */
// __zp($24) char vera_heap_alloc(__zp($66) char s, __zp($3e) unsigned long size)
vera_heap_alloc: {
    .label s = $66
    .label size = $3e
    .label return = $24
    .label packed_size = $5d
  ...
  __b1:
    ...
    lda.z s
    asl
    // [142] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREESIZE)[vera_heap_alloc::$7] = ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREESIZE)[vera_heap_alloc::$7] - vera_heap_alloc::packed_size#0 -- pwuc1_derefidx_vbuaa=pwuc1_derefidx_vbuaa_minus_vwuz1 
    tay
    lda vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREESIZE,y
    sec
    sbc.z packed_size
    ...
    lda.z s
    asl
    // [144] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAPSIZE)[vera_heap_alloc::$8] = ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAPSIZE)[vera_heap_alloc::$8] + vera_heap_alloc::packed_size#0 -- pwuc1_derefidx_vbuaa=pwuc1_derefidx_vbuaa_plus_vwuz1 
    tay
    lda vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAPSIZE,y
    clc
    adc.z packed_size
 ...
 * @return void 
 */
// __zp($4e) char vera_heap_segment_init(__zp($4e) char s, __zp($60) char vram_bank_floor, __zp($36) unsigned int vram_offset_floor, __zp($61) char vram_bank_ceil, __zp($5d) unsigned int vram_offset_ceil)
vera_heap_segment_init: {
    .label s = $4e
    .label vram_bank_floor = $60
    .label vram_offset_floor = $36
    .label vram_bank_ceil = $61
    .label vram_offset_ceil = $5d
    .label return = $4e
    .label vera_heap_segment_init__0 = $36
    .label vera_heap_segment_init__1 = $36
    .label free_size = $48
    .label bank_old = $68
    .label free_index = $5c
    // vera_heap_segment.vram_bank_floor[s] = vram_bank_floor
    // [145] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_VRAM_BANK_FLOOR)[vera_heap_segment_init::s] = vera_heap_segment_init::vram_bank_floor -- pbuc1_derefidx_vbuz1=vbuz2 
    ...
    tya
    asl
    // [147] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_VRAM_OFFSET_FLOOR)[vera_heap_segment_init::$14] = vera_heap_segment_init::vram_offset_floor -- pwuc1_derefidx_vbuaa=vwuz1 
    tay
    ...
    // [148] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_VRAM_BANK_CEIL)[vera_heap_segment_init::s] = vera_heap_segment_init::vram_bank_ceil -- pbuc1_derefidx_vbuz1=vbuz2 
    ...
    tya
    asl
    // [150] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_VRAM_OFFSET_CEIL)[vera_heap_segment_init::$15] = vera_heap_segment_init::vram_offset_ceil -- pwuc1_derefidx_vbuaa=vwuz1 
    tay
    ...
    lda.z s
    asl
    // [157] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FLOOR)[vera_heap_segment_init::$16] = vera_heap_segment_init::$0 -- pwuc1_derefidx_vbuaa=vwuz1 
    tay
    ...
    lda.z s
    asl
    // [164] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_CEIL)[vera_heap_segment_init::$17] = vera_heap_segment_init::$1 -- pwuc1_derefidx_vbuaa=vwuz1 
    tay
    ...
    lda.z s
    asl
    // [168] vera_heap_segment_init::free_size#0 = ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_CEIL)[vera_heap_segment_init::$19] -- vwuz1=pwuc1_derefidx_vbuaa 
    tay
    ...
    lda.z s
    asl
    // [170] vera_heap_segment_init::free_size#1 = vera_heap_segment_init::free_size#0 - ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FLOOR)[vera_heap_segment_init::$20] -- vwuz1=vwuz1_minus_pwuc1_derefidx_vbuaa 
    tay
    lda.z free_size
    sec
    ...
    // [177] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAP_LIST)[vera_heap_segment_init::s] = $ff -- pbuc1_derefidx_vbuz1=vbuc2 
    lda #$ff
    ldy.z s
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAP_LIST,y
    // vera_heap_segment.idle_list[s] = VERAHEAP_NULL
    // [178] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST)[vera_heap_segment_init::s] = $ff -- pbuc1_derefidx_vbuz1=vbuc2 
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST,y
    // vera_heap_segment.free_list[s] = VERAHEAP_NULL
    // [179] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_segment_init::s] = $ff -- pbuc1_derefidx_vbuz1=vbuc2 
    ...
    // [187] vera_heap_list_insert_at::list#0 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_segment_init::s] -- vbuz1=pbuc1_derefidx_vbuz2 
    ldy.z s
    ...
    ldx.z free_index
    // [195] vera_heap_set_data_packed::data_packed#0 = ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FLOOR)[vera_heap_segment_init::$24] -- vwuz1=pwuc1_derefidx_vbuaa 
    tay
    ...
    // [198] vera_heap_set_size_packed::size_packed#0 = ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_CEIL)[vera_heap_segment_init::$25] - ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FLOOR)[vera_heap_segment_init::$25] -- vwuz1=pwuc1_derefidx_vbuaa_minus_pwuc2_derefidx_vbuaa 
    tay
    lda vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_CEIL,y
    sec
    sbc vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FLOOR,y
  ...
  !:
    ...
    // [211] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_segment_init::s] = vera_heap_segment_init::free_index#1 -- pbuc1_derefidx_vbuz1=vbuz2 
    lda.z free_index
    ldy.z s
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST,y
    // vera_heap_segment.freeSize[s] = free_size
    ...
    tya
    asl
    // [213] ((unsigned int *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREESIZE)[vera_heap_segment_init::$28] = vera_heap_segment_init::free_size#1 -- pwuc1_derefidx_vbuaa=vwuz1 
    tay
    lda.z free_size
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREESIZE,y
    lda.z free_size+1
...
// void vera_heap_bram_bank_init(__zp($5f) char bram_bank)
vera_heap_bram_bank_init: {
    .label bram_bank = $5f
 ...
 */
/* inline */
// __zp($36) unsigned int vera_heap_alloc_size_get(__zp($3e) unsigned long size)
vera_heap_alloc_size_get: {
    .label vera_heap_alloc_size_get__1 = $36
    .label size = $3e
    .label return = $5d
    .label return_1 = $36
 ...
 * Best-fit algorithm.
 */
// __zp($27) char vera_heap_find_best_fit(__register(X) char s, __zp($36) unsigned int requested_size)
vera_heap_find_best_fit: {
    .label requested_size = $36
    .label free_end = $31
    .label return = $27
    .label free_size = $28
    .label best_size = $2d
    .label best_size_1 = $28
    .label best_index = $27
  ...
  __b1:
    ...
    // [234] vera_heap_find_best_fit::free_end#0 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_find_best_fit::s#2] -- vbuz1=pbuc1_derefidx_vbuxx 
...
// __zp($44) unsigned int vera_heap_get_data_packed(char s, __register(X) char index)
vera_heap_get_data_packed: {
    .label return = $3c
    .label return_1 = $4c
    .label return_2 = $3a
    ...
    // [254] vera_heap_get_data_packed::return#1 = ((char *)&vera_heap_index+OFFSET_STRUCT_VERA_HEAP_MAP_T_DATA1)[vera_heap_get_data_packed::index#9] w= ((char *)&vera_heap_index+OFFSET_STRUCT_VERA_HEAP_MAP_T_DATA0)[vera_heap_get_data_packed::index#9] -- vwuz1=pbuc1_derefidx_vbuxx_word_pbuc2_derefidx_vbuxx 
    lda vera_heap_index+OFFSET_STRUCT_VERA_HEAP_MAP_T_DATA1,x
    sta.z return+1
...
// __zp($28) unsigned int vera_heap_get_size_packed(char s, __register(X) char index)
vera_heap_get_size_packed: {
    .label return = $50
    .label return_1 = $28
    ...
    // [258] vera_heap_get_size_packed::return#12 = vera_heap_get_size_packed::$0 w= ((char *)&vera_heap_index+OFFSET_STRUCT_VERA_HEAP_MAP_T_SIZE0)[vera_heap_get_size_packed::index#8] -- vwuz1=vbuaa_word_pbuc1_derefidx_vbuxx 
    sta.z return_1+1
...
// void vera_heap_heap_remove(__zp($46) char s, __zp($24) char heap_index)
vera_heap_heap_remove: {
    .label s = $46
    .label heap_index = $24
  ...
  !:
    ...
    // [262] vera_heap_list_remove::list#2 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAP_LIST)[vera_heap_heap_remove::s#0] -- vbuyy=pbuc1_derefidx_vbuz1 
    ldx.z s
    ...
    // [267] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAP_LIST)[vera_heap_heap_remove::s#0] = vera_heap_heap_remove::$1 -- pbuc1_derefidx_vbuz1=vbuaa 
    ldy.z s
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAP_LIST,y
...
// char vera_heap_free_insert(__zp($5f) char s, __zp($60) char free_index, __zp($2d) unsigned int data, __zp($36) unsigned int size)
vera_heap_free_insert: {
    .label s = $5f
    .label free_index = $60
    .label data = $2d
    ...
    // [269] vera_heap_list_insert_at::list#3 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_free_insert::s#0] -- vbuz1=pbuc1_derefidx_vbuz2 
    ldy.z s
    lda vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST,y
    sta.z vera_heap_list_insert_at.list
    ...
    // [271] vera_heap_list_insert_at::at#3 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_free_insert::s#0] -- vbuz1=pbuc1_derefidx_vbuz2 
    lda vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST,y
    ...
    // [275] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_free_insert::s#0] = vera_heap_free_insert::$0 -- pbuc1_derefidx_vbuz1=vbuaa 
    ldy.z s
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST,y
 ...
 */
// __register(Y) char vera_heap_can_coalesce_left(char s, __zp($2a) char heap_index)
vera_heap_can_coalesce_left: {
    .label heap_index = $2a
    .label heap_offset = $48
    .label left_offset = $3c
 ...
 */
// __register(A) char vera_heap_coalesce(__zp($4b) char s, __zp($5b) char left_index, __zp($56) char right_index)
vera_heap_coalesce: {
    .label s = $4b
    .label left_index = $5b
    .label right_index = $56
    .label right_size = $32
    .label left_size = $64
    .label left_offset = $4c
    .label free_left = $62
    .label free_right = $63
 ...
 */
// __zp($27) char vera_heap_can_coalesce_right(char s, __zp($26) char heap_index)
vera_heap_can_coalesce_right: {
    .label heap_index = $26
    .label heap_offset = $2d
    .label right_index = $27
    .label right_offset = $44
    // A free_index is not found, we cannot coalesce.
    .label return = $27
    // vera_heap_data_packed_t heap_offset = vera_heap_get_data_packed(s, heap_index)
    // [362] vera_heap_get_data_packed::index#6 = vera_heap_can_coalesce_right::heap_index#0 -- vbuxx=vbuz1 
    ldx.z heap_index
    ...
    // [366] vera_heap_get_right::index#1 = vera_heap_can_coalesce_right::heap_index#0 -- vbuxx=vbuz1 
    ldx.z heap_index
    ...
    // [369] vera_heap_can_coalesce_right::right_index#0 = vera_heap_get_right::return#3 -- vbuz1=vbuaa 
    sta.z right_index
    // vera_heap_data_packed_t right_offset = vera_heap_get_data_packed(s, right_index)
    // [370] vera_heap_get_data_packed::index#7 = vera_heap_can_coalesce_right::right_index#0 -- vbuxx=vbuz1 
    tax
    ...
    // [374] vera_heap_is_free::index#1 = vera_heap_can_coalesce_right::right_index#0 -- vbuxx=vbuz1 
    ldx.z right_index
  ...
  __b2:
    // [381] phi vera_heap_can_coalesce_right::return#3 = $ff [phi:vera_heap_can_coalesce_right::@5/vera_heap_can_coalesce_right::@6->vera_heap_can_coalesce_right::@return#0] -- vbuz1=vbuc1 
    lda #$ff
    sta.z return
    rts
  ...
  __b6:
    // if(right_free && (heap_offset < right_offset))
    // [379] if(vera_heap_can_coalesce_right::heap_offset#0<vera_heap_can_coalesce_right::right_offset#0) goto vera_heap_can_coalesce_right::@1 -- vwuz1_lt_vwuz2_then_la1 
    lda.z heap_offset+1
...
// __zp($36) unsigned int vera_heap_get_size_int(char s, __register(X) char index)
vera_heap_get_size_int: {
    .label return = $36
    .label size = $36
 ...
 */
// void memset_vram(__register(Y) char dbank_vram, __zp($34) unsigned int doffset_vram, __register(X) char data, __zp($59) unsigned int num)
memset_vram: {
    .label i = $34
    .label doffset_vram = $34
    .label num = $59
 ...
 */
// __register(A) char vera_heap_allocate(__zp($2f) char s, __zp($30) char free_index, __zp($3c) unsigned int required_size)
vera_heap_allocate: {
    .label s = $2f
    .label free_index = $30
    .label required_size = $3c
    .label free_size = $28
    // vera_heap_size_packed_t free_size = vera_heap_get_size_packed(s, free_index)
  ...
  // vera_heap_data_pack
// __zp($36) unsigned int vera_heap_data_pack(__register(X) char vram_bank, __zp($36) unsigned int vram_offset)
vera_heap_data_pack: {
    .label vera_heap_data_pack__1 = $50
    .label vera_heap_data_pack__2 = $36
    .label vram_offset = $36
    .label return = $36
    // vram_bank<<5
...
vera_heap_index_add: {
    ...
    // [432] vera_heap_index_add::index#0 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST)[vera_heap_index_add::s#2] -- vbuz1=pbuc1_derefidx_vbuxx 
    ...
    // [434] vera_heap_index_add::index#1 = *((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_INDEX_POSITION) -- vbuz1=_deref_pbuc1 
  ...
  __b1:
    ...
    // [438] vera_heap_idle_remove::s#0 = vera_heap_index_add::s#2 -- vbuz1=vbuxx 
    stx.z vera_heap_idle_remove.s
    // [439] vera_heap_idle_remove::idle_index#0 = vera_heap_index_add::index#0 -- vbuz1=vbuz2 
    lda.z index
    sta.z vera_heap_idle_remove.idle_index
...
*/
// __register(A) char vera_heap_list_insert_at(char s, __zp($26) char list, __zp($2a) char index, __zp($27) char at)
vera_heap_list_insert_at: {
    .label list = $26
    .label index = $2a
    .label at = $27
...
// void vera_heap_set_data_packed(char s, __register(X) char index, __zp($2d) unsigned int data_packed)
vera_heap_set_data_packed: {
    .label data_packed = $2d
    // BYTE1(data_packed)
...
// void vera_heap_set_size_packed(char s, __register(X) char index, __zp($28) unsigned int size_packed)
vera_heap_set_size_packed: {
...
vera_heap_set_prev: {
  ...
  // vera_heap_size_pack
// __zp($36) unsigned int vera_heap_size_pack(__zp($3e) unsigned long size)
vera_heap_size_pack: {
    .label vera_heap_size_pack__3 = $32
    .label vera_heap_size_pack__4 = $32
    .label vera_heap_size_pack__6 = $36
    .label return = $36
    .label size = $3e
    // BYTE2(size)
...
*/
// __register(A) char vera_heap_list_remove(char s, __register(Y) char list, __zp($24) char index)
vera_heap_list_remove: {
    .label vera_heap_list_remove__2 = $22
    .label next = $25
    .label prev = $23
    .label index = $24
    // if(list == VERAHEAP_NULL)
...
// void vera_heap_free_remove(__zp($2f) char s, __zp($30) char free_index)
vera_heap_free_remove: {
    .label s = $2f
    .label free_index = $30
    // vera_heap_segment.freeCount[s]--;
  ...
  !:
    ...
    // [551] vera_heap_list_remove::list#3 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_free_remove::s#2] -- vbuyy=pbuc1_derefidx_vbuz1 
    ldx.z s
    ldy vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST,x
    ...
    // [556] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST)[vera_heap_free_remove::s#2] = vera_heap_free_remove::$1 -- pbuc1_derefidx_vbuz1=vbuaa 
    ldy.z s
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_FREE_LIST,y
...
// char vera_heap_idle_insert(__zp($42) char s, __zp($43) char idle_index)
vera_heap_idle_insert: {
    .label s = $42
    .label idle_index = $43
    // vera_heap_list_insert_at(s, vera_heap_segment.idle_list[s], idle_index, vera_heap_segment.idle_list[s])
    // [560] vera_heap_list_insert_at::list#4 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST)[vera_heap_idle_insert::s#0] -- vbuz1=pbuc1_derefidx_vbuz2 
    ldy.z s
    ...
    lda.z idle_index
    sta.z vera_heap_list_insert_at.index
    // [562] vera_heap_list_insert_at::at#4 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST)[vera_heap_idle_insert::s#0] -- vbuz1=pbuc1_derefidx_vbuz2 
    lda vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST,y
    sta.z vera_heap_list_insert_at.at
    ...
    // [566] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST)[vera_heap_idle_insert::s#0] = vera_heap_idle_insert::$0 -- pbuc1_derefidx_vbuz1=vbuaa 
    ldy.z s
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST,y
 ...
 */
// __zp($47) char vera_heap_replace_free_with_heap(__zp($57) char s, char free_index, __zp($44) unsigned int required_size)
vera_heap_replace_free_with_heap: {
    .label free_data = $3a
    .label free_left = $55
    .label free_right = $52
    .label s = $57
    .label required_size = $44
    .label return = $47
    // vera_heap_size_packed_t free_size = vera_heap_get_size_packed(s, free_index)
 ...
 */
// __register(A) char vera_heap_split_free_and_allocate(__zp($58) char s, __zp($4f) char free_index, __zp($53) unsigned int required_size)
vera_heap_split_free_and_allocate: {
    .label free_size = $28
    .label free_data = $38
    .label heap_index = $4a
...
// void vera_heap_idle_remove(__zp($2b) char s, __zp($24) char idle_index)
vera_heap_idle_remove: {
    .label s = $2b
    .label idle_index = $24
    // vera_heap_segment.idleCount[s]--;
    // [657] vera_heap_idle_remove::$3 = vera_heap_idle_remove::s#0 << 1 -- vbuaa=vbuz1_rol_1 
    lda.z s
    asl
  ...
  !:
    ...
    // [659] vera_heap_list_remove::list#4 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST)[vera_heap_idle_remove::s#0] -- vbuyy=pbuc1_derefidx_vbuz1 
    ldx.z s
    ...
    // [664] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST)[vera_heap_idle_remove::s#0] = vera_heap_idle_remove::$1 -- pbuc1_derefidx_vbuz1=vbuaa 
    ldy.z s
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_IDLE_LIST,y
...
// char vera_heap_heap_insert_at(__zp($31) char s, __zp($22) char heap_index, char at, __zp($28) unsigned int size)
vera_heap_heap_insert_at: {
    .label s = $31
    .label heap_index = $22
    .label size = $28
    // vera_heap_list_insert_at(s, vera_heap_segment.heap_list[s], heap_index, at)
    // [673] vera_heap_list_insert_at::list#1 = ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAP_LIST)[vera_heap_heap_insert_at::s#2] -- vbuz1=pbuc1_derefidx_vbuz2 
    ldy.z s
    ...
    // [678] ((char *)&vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAP_LIST)[vera_heap_heap_insert_at::s#2] = vera_heap_heap_insert_at::$0 -- pbuc1_derefidx_vbuz1=vbuaa 
    ldy.z s
    sta vera_heap_segment+OFFSET_STRUCT_VERA_HEAP_SEGMENT_T_HEAP_LIST,y

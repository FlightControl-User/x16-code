...
#endif
bram_heap_map_t  bram_heap_index[BRAM_HEAP_SEGMENTS]; // The heap index is located in BRAM.
...
bram_ptr_t bram_heap_data_get_offset(bram_heap_segment_index_t s, bram_heap_index_t index)
{
    ...
    bank_set_bram(bram_heap_segment.bram_bank);
    bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s];
    bram_ptr_t bram_ptr = (bram_ptr_t)(((unsigned int)bram_heap_map->data0[index] << 5) | 0xA000);
...
{
    bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s];
    bram_heap_map->data1[index] = bram_bank;
    bram_heap_map->data0[index] = BYTE0((unsigned int)bram_ptr>>5);
}
...
bram_heap_size_packed_t bram_heap_get_size_packed(bram_heap_segment_index_t s, bram_heap_index_t index)
{
    ...
    return MAKEWORD(hi, lo); // Ignore free flag!
}
...
{
    bram_heap_map_t* bram_heap_map = &bram_heap_index[(unsigned int)s];
    bram_heap_map->data1[index] = (BYTE2(size)>>5 & 0x11111000) | BYTE1(size)>>5;
    bram_heap_map->data0[index] = (BYTE1(size)>>5 & 0x11111000) | BYTE0(size)>>5;
}
...
void bram_heap_set_size_packed(bram_heap_segment_index_t s, bram_heap_index_t index, bram_heap_size_packed_t size_packed)
{
    ...
    bram_heap_map->size1[index] = BYTE1(size_packed) & 0x7F; // Ignore free flag.
...
void bram_heap_dump_stats(bram_heap_segment_index_t s)
{
    ...
    bram_heap_index_t heap = bram_heap_segment.heap_list[s];

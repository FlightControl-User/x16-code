...
void DrawFighters()
{
    ...
    while(fighter_handle) {
        ...
        sprite_position(fighter->sprite_offset, (int)(fighter->x >> 4-32), (int)(fighter->y >> 4-32));
        ...
        if(engine_handle) {
            ...
            sprite_position(engine->sprite_offset, (int)(engine->x >> 4-32), (int)(engine->y >> 4-32));
        }
